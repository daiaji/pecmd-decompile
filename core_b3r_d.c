...
extern void      FUN_14005d558(void *param_1, HWND param_2);
...
extern void      FUN_1400675b8(int64_t *src, WCHAR **dst, short delim);
extern void      FUN_140003a20(void *script, WCHAR **str, int mode);
...
extern LPWSTR    FUN_14005fc90(LPWSTR dst, uint32_t *guid, int mode);
...
extern uint64_t  FUN_140069bd8(int64_t a, uint8_t b, uint32_t c, void *d,
                               void *e, DWORD f, int g, void *h);
extern uint32_t  FUN_140065efc(LPCWSTR p, HANDLE h);
...
uint64_t PECMD_ApplyWindowFlags(HWND param_1, short *param_2)
{
    ...
    if (sVar1 == 0x40) {
        ...
        FUN_1400e5900((int64_t)param_1, (uint32_t)local_res18,
                      local_res20 & 0xffffffffull);
    } else {
        FUN_1400e5960(param_1, (uint32_t)local_res18, local_res20 & 0xffffffffull);
    }
    return 0;
}
...
ushort *PECMD_ParseQuotedArg(longlong *param_1, longlong *param_2, longlong *param_3)
{
    ...
    if (*puVar3 == 0x22) {
        ...
        *param_2 = (longlong)puVar3;
        FUN_1400f429c((WCHAR **)param_2, 0x22);
...
LAB_140083b8f:
    if ((*(char *)((longlong)param_1 + 0xda) == '\0') &&
        ...
        FUN_14007bda8((void *)param_1, (WCHAR *)*param_2, (WCHAR **)param_3, 0, 1);
    } else {
        FUN_14007a224((void *)param_1, (WCHAR *)*param_2, (WCHAR **)param_3, 0, 1);
    }
    *param_2 = *param_3;
    return puVar5;
}
                       ...
                       longlong *param_4)
{
    ...
    FUN_1400702b0(&local_560, (const WCHAR *)g_szEmpty);
    FUN_1400702b0(&local_578, (const WCHAR *)g_szEmpty);
    FUN_1400702b0(&local_570, (const WCHAR *)g_szEmpty);
    local_598[0] = 0;
    cVar23 = '\0';
    bVar3 = false;
    puVar19 = local_res10;
    ...
    plVar9 = FUN_14007f6e4((WCHAR **)&local_558, &local_res10, 0x2c, 1);
    FUN_1400675b8(plVar9, &local_590, 0);
    FUN_140003a20((void *)param_1, &local_590, 0);
    puVar19 = local_res10;
    ...
    FUN_14005b154(&local_res10);
    plVar9 = FUN_14007f6e4((WCHAR **)&local_558, &local_res10, 0x2c, 1);
    FUN_1400675b8(plVar9, &local_560, 0);
    ...
    if (*psVar10 == 0x2c) {
        local_res10 = puVar19 + 1;
        plVar9 = FUN_14007f6e4((WCHAR **)&local_558, &local_res10, 0x2c, 1);
        FUN_1400675b8(plVar9, &local_578, 0);
        puVar19 = local_res10;
    }
    ...
    if (*psVar10 == 0x2c) {
        local_res10 = puVar19 + 1;
        plVar9 = FUN_14007f6e4((WCHAR **)&local_558, &local_res10, 0x2c, 1);
        FUN_1400675b8(plVar9, &local_570, 0);
        puVar19 = local_res10;
    }
    psVar10 = (short *)FUN_140063060(puVar19);
    uVar25 = 0;
    ...
    if (local_5a8 != (WCHAR *)0x0) {
        local_5a0 = (WCHAR *)0x0;
        if (pWVar11 == (LPWSTR)0x0) {
            FUN_14007034c(&local_5a0, local_590);
            FUN_14006375c(&local_5a0, WSTR(".flg"));
            pWVar11 = local_5a0;
...
LAB_14008822a:
        ...
        if (WVar24 != L'\0') {
            ...
            if (pWVar14 == (LPWSTR)0x0) {
                FUN_14006375c(&local_5a0, local_570);
                ...
                FUN_14007034c(&local_5a0, local_570);
                FUN_14006375c(&local_5a0, WSTR("|"));
                WVar2 = *local_5a0;
                pWVar15 = local_5a0;
...
LAB_140088096:
            if (((((local_4d8 >> 9 & 1) == 0) && (!bVar26)) && (bVar3)) && (WVar24 != L'\0')) {
                ...
                if (pWVar14 == (LPWSTR)0x0) {
                    FUN_14006375c(&local_5b0, WSTR("."));
                    FUN_14006375c(&local_5b0, local_570);
                }
                FUN_14005b104((void *)&local_5a8);
            }
            FUN_14005b104((void *)&local_5a0);
            goto LAB_14008822a;
        }
        ...
        if (*piVar16 == 1) {
            if ((local_4d8 >> 9 & 1) == 0) {
                FUN_14007034c(&local_5b0, (LPCWSTR)local_508);
                ...
                if (*(WCHAR *)local_5a8 == L'\0') {
                    ...
                    do {
                        ...
                        FUN_14006375c(&local_5b0, (const WCHAR *)pBVar21);
                        WVar2 = *(WCHAR *)pBVar17;
                        pBVar4 = pBVar17;
                ...
                if (*(WCHAR *)pBVar21 == L'\0') {
                    ...
                    do {
                        ...
                        FUN_14006375c(&local_5b0, (const WCHAR *)pBVar17);
                        pWVar11 = local_5b0;
...
LAB_14008822f:
        if (param_4 == (longlong *)0x0) {
            FUN_1400702b0(&local_588, local_5b0);
...
LAB_14008829d:
    FUN_14005b104((void *)&local_570);
    FUN_14005b104((void *)&local_578);
    FUN_14005b104((void *)&local_560);
    FUN_14005b104((void *)&local_590);
    FUN_14005b104((void *)&local_558);
    FUN_14005b104((void *)&local_568);
    return 0;
}
...
LAB_14008aeda:
            if (-1 < (int)uVar13) {
                ...
                if (hObject != (HANDLE)0x0) {
                    ...
                    local_res10[0] = 0;
                    puVar6 = FUN_14005feac(hObject, local_2d8, local_res10);
                    puVar15 = local_2d8;
                    ...
                    if (iVar16 == 0) {
                        ...
                        FUN_14005fc90((LPWSTR)&local_278,
                    ...
                    uVar5 = FUN_140069bd8((int64_t)(uintptr_t)(puVar15 + 6),
                                          (uint8_t)(iVar16 == 1),
                                          local_res10[0], (void *)&local_308,
                                          (void *)&local_2e8, DVar4, iVar16,
                                          (void *)&local_2f8);
                    FUN_140065efc((LPCWSTR)0x0, hObject);
                    ...
                    if (local_2e0 != 0) {
                        ...
                        local_res10[0] = 0;
                        lVar8 = FUN_140078514(hObject, (int *)local_res10,
                                              (longlong *)&local_308);
                        wsprintfW(local_1c8, WSTR(" %I64d %u %I64d"),
                                  lVar8, local_res10[0]);
                    }
                    FUN_1400e6d68(local_c8, (uint64_t)local_2a8);
                    FUN_1400e6d68(local_148,
                    ...
                    uVar10 = wsprintfW((LPWSTR)*param_1, pwVar9,
                                       (int)uVar12, local_c8);
                    if (uVar3 != 0) {
                        FUN_14006375c((WCHAR **)param_1, local_2b8);
                    }
                    if (local_res18 != 0) {
                        FUN_14006375c((WCHAR **)param_1, local_2d0);
                    }
                    if (local_res20 != 0) {
                        FUN_14006375c((WCHAR **)param_1, local_2c0);
                    }
                    if (local_300 != 0) {
                        FUN_14006375c((WCHAR **)param_1, local_2c8);
                    }
                    if (-1 < (char)uVar5) {
                        FUN_14006375c((WCHAR **)param_1, WSTR(" D"));
                    }
        ...
        if (hObject == (HANDLE)0x0) {
            ...
            FUN_14006375c((WCHAR **)param_1, pWVar2);
