...
LONG RegQueryInfoKeyW(HKEY, LPWSTR, DWORD *, DWORD *, DWORD *, DWORD *, DWORD *, DWORD *, DWORD *,
...
HFONT CreateFontW(int, int, int, int, int, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD, DWORD,
                  LPCWSTR);
...
BOOL StretchDIBits(HDC, int, int, int, int, int, int, int, int, const void *, const BITMAPINFO *,
                   uint32_t, DWORD);
...
BOOL CreateProcessAsUserW(HANDLE, LPCWSTR, LPWSTR, LPSECURITY_ATTRIBUTES, LPSECURITY_ATTRIBUTES,
