...
extern int64_t   FUN_14007bda8(int64_t *ctx, WCHAR *src, WCHAR **out, int mode, uint8_t flag);
...
extern void      FUN_14006a740(int64_t *pp, int64_t *out);          /* parse int */
...
extern int       FUN_14005f96c(HANDLE h, int sz);             /* 扇区大小 */
...
longlong PECMD_SubCommand(longlong *param_1, WCHAR *param_2, longlong *param_3)
{
    ...
    uVar11 = 0;
    while ((WVar1 != L'\0' &&
            ((local_res10 = param_2, (ushort)WVar1 < 9 || (0xd < (ushort)WVar1)) &&
             (WVar1 != L' ')))) {
        param_2 = param_2 + 1;
        local_res10 = param_2;
        WVar1 = *param_2;
    ...
    cVar2 = FUN_1400660ac("-sub", (void *)&local_res10, 4);
    WVar1 = *local_res10;
    if (WVar1 == L'*') {
    ...
    if (cVar2 == '\0') {
        ...
        uVar8 = FUN_14005c788("=:", local_98, 2);
        if ((char)uVar8 == '\0') {
            if (WVar1 != L'*') {
        ...
        if ((*(char *)((char *)param_1 + 0xda) == '\0') &&
            ...
            FUN_14007bda8(param_1, pWVar10, (WCHAR **)&local_80, 0, 1);
        }
        else {
            FUN_14007a224(param_1, pWVar10, (WCHAR **)&local_80, 0, 1);
        }
        local_58 = local_80;
        local_res20 = local_98;
        FUN_1400f429c(&local_res20, 0x3a);
        if (*local_res20 != L'\0') {
            *local_res20 = L'\0';
    ...
    if (*local_res10 == 0x2c) {
        ...
        if (*local_res10 == 0x2c) {
            ...
            if (*local_res10 == 0x2c) {
                ...
                if (*local_res10 == 0x2c) {
                    local_res10 = local_res10 + 1;
                    puVar5 = FUN_14007f6e4((WCHAR **)&local_50, &local_res10, 0x2c, 1);
        ...
        FUN_1400aaa4c(param_3, (longlong)param_1, &local_80, local_88, local_84,
                      local_res18[0], (int)(intptr_t)local_res8, local_78, &local_68, uVar11);
 ...
 */
ULONGLONG PECMD_ForCommand(longlong *param_1, WCHAR *param_2, longlong *param_3,
                        longlong *param_4, uint64_t param_5)
{
    WCHAR WVar31;
    char cVar35;
    WCHAR *local_res10;
    ...
    for (;;) {
        ...
        if (FUN_14005c788("NL:", (local_res10 + 1), 3) == 0) {
        ...
        if (FUN_14005c788("delims:", (local_res10 + 1), 7) == 0) {
        ...
        if ((FUN_1400660ac("*", &local_res10, -1) != 0) ||
            (FUN_1400660ac("-", &local_res10, -1) != 0)) {
            uVar34 = (uVar34 & 0xfffffffd) | 1;
            continue;
        }
        if ((PECMD_MatchPrefixAdvance("v", (int64_t *)&local_res10, 1)) ||
            (FUN_1400660ac("**", &local_res10, 2) != 0)) {
            uVar34 = (uVar34 & ~8U) | 5;
            continue;
        }
        ...
        if (FUN_1400660ac("*bf", &local_res10, 3) != 0) {
            uVar32 = 1;
            continue;
        }
        if (FUN_1400660ac("*ab", &local_res10, 3) != 0) {
            local_420 = 1;
            continue;
        }
        if (FUN_1400660ac("*qu", &local_res10, 3) != 0) {
            local_480 = 1;
            continue;
        }
        if (FUN_1400660ac("*qu~", &local_res10, 4) != 0) {
            local_480 = 2;
            continue;
        }
        if (FUN_1400660ac("*off", &local_res10, 4) != 0) {
            local_430 = 1;
            continue;
        }
        if (FUN_1400660ac("/s", &local_res10, 2) != 0) {
            local_4a8 = 0x10;
            uVar22 = 0x10;
            break;   /* /s 模式进入主体 */
        }
        if (FUN_14005c788("/s:", local_res10, 3) == 0) {
            local_res10 = local_res10 + 3;
            local_4a8 = 0x10;
            uVar22 = 0x10;
            continue;
        }
        if (FUN_1400660ac("/O:N", &local_res10, 4) != 0) {
            uVar26 = 0x20;
            continue;
        }
        if (FUN_1400660ac("/O:-N", &local_res10, 5) != 0) {
            uVar26 = 0x60;
            continue;
        }
        if (FUN_1400660ac("*cur", &local_res10, 4) != 0) {
            local_460 = 1;
            continue;
        }
        if (FUN_14005c788("/size*:", local_res10, 7) == 0) {
            int64_t *p = (int64_t *)&local_res10;
            local_res10 = local_res10 + 1;
            FUN_14006a740(p, &local_378);
            continue;
        }
        if (FUN_14005c788("/size:", local_res10, 6) == 0) {
            local_res10 = local_res10 + 6;
            FUN_14006a740((int64_t *)&local_res10, &local_378);
            continue;
        }
        /* 其他未知选项/普通串: 结束选项扫描 */
        break;
     ...
     * FOR 循环/分区枚举; 化简为单次 SetVar 语义, TODO(verify)) */
    {
        ...
        FUN_14007bf44(param_1, (LPCWSTR)pOut, &local_3d0, 0, 1);
        if ((uVar34 & 1) == 0) {
            ...
            wsprintfW(local_118, WSTR("\\\\.\\PhysicalDrive%d"), (ulonglong)uVar22);
            {
                ...
                if (hObject == (HANDLE)0) {
                    ...
                    if (puVar11 == (ulonglong *)0) {
                        ...
                        uint local_264 = FUN_14005f96c(hObject, 0x200);
                        ...
                        if ((int)puVar11[0] == 1) {
                            PECMD_ReadDiskSectorScan((ulonglong *)&hObject, (ulonglong *)((char *)local_250 + 0x81cb0),
                        ...
                        {
                            uint index = 0;
                            (void)index; (void)local_220; (void)local_258; (void)uVar17;
                        }
                        if (hObject != (HANDLE)0xffffffffffffffff) {
                            CloseHandle(hObject);
                        }
