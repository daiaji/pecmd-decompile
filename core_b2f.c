...
extern BOOL ChangeServiceConfigW(SC_HANDLE, DWORD, DWORD, DWORD, LPCWSTR, LPCWSTR,
                                 DWORD *, LPCWSTR, LPCWSTR, LPCWSTR, LPCWSTR);
extern BOOL ChangeServiceConfig2W(SC_HANDLE, DWORD, const void *);
extern SC_HANDLE CreateServiceW(SC_HANDLE, LPCWSTR, LPCWSTR, DWORD, DWORD, DWORD,
...
extern uint64_t FUN_14001a0f4(LPCWSTR s);
...
extern void FUN_1400198f8(SC_HANDLE, int);
extern void PECMD_VarSetUInt(void *s, uint64_t v, LPCWSTR k);
extern void FUN_14001e19c(LPCWSTR path);
...
extern uint64_t FUN_14001f164(LPCWSTR a, LPCWSTR b);
...
extern int FUN_14001f0f4(LPCWSTR, int64_t *);
...
extern uint64_t FUN_140009844(HWND);
...
#define VT_CALL(obj, off, type) \
    ((type)((void **)*(void ***)(obj))[(off) / sizeof(void *)])
...
uint64_t PECMD_ServiceControl(int64_t *script, LPCWSTR name)
{
    ...
    local_240 = 0;
    local_250 = 0;
    local_228 = (SC_HANDLE)((SC_HANDLE (*)(LPCWSTR, LPCWSTR, DWORD))g_pOpenSCManagerW)(
        NULL, NULL, 0xf003f);
    DVar7 = 0;
                        ...
                        if (cVar5 == '\0') {
                            ...
                            if (cVar5 == '\0') {
                                ...
                                if (cVar5 == '\0') {
                                    ...
                                    DVar7 = 0;
                                    if (cVar5 == '\0') {
                                        cVar5 = FUN_1400660AC("-disabled", (int64_t *)&local_res10, 9);
                                        DVar7 = 0;
                                        if (cVar5 == '\0') {
                                            cVar5 = FUN_1400660AC("-delayed-auto", (int64_t *)&local_res10, 0xd);
                                            DVar7 = 0;
                                            if (cVar5 == '\0') {
                                                cVar5 = FUN_1400660AC("-start", (int64_t *)&local_res10, 6);
                                                DVar7 = 0;
                                                if (cVar5 == '\0') {
                                                    cVar5 = FUN_1400660AC("-stop", (int64_t *)&local_res10, 5);
                                                    DVar7 = 0;
                                                    if (cVar5 == '\0') {
                                                        cVar5 = FUN_1400660AC("-stop-", (int64_t *)&local_res10, 6);
                                                        DVar7 = 0;
                                                        if (cVar5 == '\0') {
                                                            WVar1 = *local_res10;
                                                            while ((WVar1 != L'\0' &&
...
label_020ac6:
                        ...
                        local_res18 = (local_res18 & 0xffffffff00000000ULL) |
                                      (uint64_t)local_264;
                        BVar8 = ChangeServiceConfigW(hService, (DWORD)-1, local_268,
                                                     (DWORD)-1, NULL, NULL, NULL, NULL,
                                                     NULL, NULL, NULL);
                        if (BVar8 == 0) {
                            DVar7 = GetLastError();
...
label_020b13:
                        iVar9 = ((BOOL (*)(SC_HANDLE, DWORD, void *))g_pControlService)(
                            hService, 1, local_1d8);
                    }
                    ...
                    iVar6 = ((BOOL (*)(SC_HANDLE, int, void *, DWORD, DWORD *))g_pQueryServiceStatusEx)(
...
label_020ae4:
            ...
            hService = CreateServiceW(local_228,
                                      (LPCWSTR)(uintptr_t)local_238,
                                      (LPCWSTR)(uintptr_t)local_248,
                                      0xf01ff, local_268, local_264, local_res20[0],
                                      (LPCWSTR)(uintptr_t)local_218,
                                      (LPCWSTR)(uintptr_t)local_210,
                                      lpdwTagId, pWVar10,
                                      (LPCWSTR)(sVar2 != 0 ? (uintptr_t)(int16_t *)(uintptr_t)local_260 : 0),
                                      (LPCWSTR)(uintptr_t)local_240);
            FUN_14005B104((WCHAR **)&local_240);
            FUN_14005B104((WCHAR **)&local_260);
            FUN_14005B104((WCHAR **)&local_258);
            FUN_14005B104((WCHAR **)&local_210);
            FUN_14005B104((WCHAR **)&local_218);
            FUN_14005B104((WCHAR **)&local_248);
            puVar11 = &local_238;
        }
        FUN_14005B104((WCHAR **)puVar11);
    }
...
int64_t FUN_140021A4C(int64_t *script, LPCWSTR text)
{
    ...
    if (pWVar11 == NULL) {
        FUN_14005B104(&local_290);
        FUN_14005B104(&local_2a0);
        FUN_14005B104(&local_268);
        FUN_14005B104(&local_2b0);
        FUN_14005B104(&local_278);
        FUN_14005B104(&local_270);
        FUN_14005B104(&local_298);
        FUN_14005B104(&local_260);
        FUN_14005B104(&local_280);
        FUN_14005B104(&local_2d0);
        return 3;
    }
    ...
    if (WVar17 == *local_res10) {
        do {
            ...
            if (cVar5 == '\0') {
                ...
                if (cVar5 == '\0') {
                    while ((WVar1 = *local_res10, WVar1 != L'\0' &&
...
label_021e1f:
    ...
    if (*local_2a0 != L'\0') {
        local_288 = local_2a0;
        local_2b8 &= 0xffffffff00000000ULL;
        uVar13 = PECMD_ParseHotkeyCode((int64_t *)&local_288, (uint32_t *)&local_2b8,
                               script, '\0');
    ...
    if ((iVar8 == 0) && (local_2c8 != NULL)) {
        ...
        if (iVar8 == 0) {
            ...
            if (((char)local_res18 == '\0') && (iVar10 >= 0)) {
                iVar8 = VT_CALL(local_2c8, 0x78, int (*)(int64_t *, int))(
                    local_2c8, iVar10);
            }
            local_res10 = FUN_14001BE14((WCHAR *)local_res10);
            ...
            if ((char)local_res18 == '\0') {
                VT_CALL(local_2c8, 0xa0, int (*)(int64_t *, LPCWSTR))(
                    local_2c8, lpFileName);
                if (*local_298 != L'\0') {
                ...
                if (local_2c0 != '\0') {
                    ...
                    if ((0 < (int64_t)uVar13) &&
                        ((local_2a8[0] != 0 ||
                          (uVar14 = FUN_14001a0f4(pWVar12), (int32_t)uVar14 == 0)))) {
                        pWVar12 = FUN_14001C270(pWVar12, (WCHAR **)&local_res18);
                    }
                    VT_CALL(local_2c8, 0x88, int (*)(int64_t *, LPCWSTR, int))(
                        local_2c8, pWVar12, local_2a8[0]);
                    FUN_14005B104((WCHAR **)&local_res18);
                }
                if (*local_2b0 != L'\0') {
...
label_022598:
                    VT_CALL(local_2c8, 0x48, int (*)(int64_t *, LPCWSTR))(
                        local_2c8, pWVar12);
                }
                if ((int32_t)uVar19 > 0) {
                    VT_CALL(local_2c8, 0x68, int (*)(int64_t *, uint16_t))(
                        local_2c8, uVar19 & 0xffff);
                }
                FUN_14001e19c(local_res10);
                iVar8 = VT_CALL((int64_t *)(uintptr_t)local_2b8, 0x30,
                                int (*)(int64_t *, LPCWSTR, int))(
                    (int64_t *)(uintptr_t)local_2b8, pWVar3, 0);
            } else {
                VT_CALL((int64_t *)(uintptr_t)local_2b8, 0x28,
                        int (*)(int64_t *, LPCWSTR, int))(
                    (int64_t *)(uintptr_t)local_2b8, local_288, 0);
                FUN_140063694((WCHAR **)&local_res20, 0x4ed);
                if (*lpFileName != L'\0') {
                    VT_CALL(local_2c8, 0x18,
                            int (*)(int64_t *, LPCWSTR, int, int, uint64_t))(
                        local_2c8, (LPCWSTR)(uintptr_t)local_res20, 0x4ec, 0,
                        ((uint64_t)uVar21 << 32) | 2);
                    FUN_1400629B8((void *)script, lpFileName,
                                 (LPCWSTR)(uintptr_t)local_res20);
                }
                if (*local_298 != L'\0') {
                    *(WCHAR *)(uintptr_t)local_res20 = L'\0';
                    VT_CALL(local_2c8, 0x50,
                            int (*)(int64_t *, LPCWSTR, int))(
                        local_2c8, (LPCWSTR)(uintptr_t)local_res20, 0x4ec);
                    FUN_1400629B8((void *)script, local_298,
                                 (LPCWSTR)(uintptr_t)local_res20);
                }
                if (*local_2b0 != L'\0') {
                    *(WCHAR *)(uintptr_t)local_res20 = L'\0';
                    VT_CALL(local_2c8, 0x30,
                            int (*)(int64_t *, LPCWSTR, int))(
                        local_2c8, (LPCWSTR)(uintptr_t)local_res20, 0x4ec);
                    FUN_1400629B8((void *)script, local_2b0,
                                 (LPCWSTR)(uintptr_t)local_res20);
                }
                if (*pWVar12 != L'\0') {
                    *(WCHAR *)(uintptr_t)local_res20 = L'\0';
                    local_res18 &= 0xffffffff00000000ULL;
                    VT_CALL(local_2c8, 0x80,
                            int (*)(int64_t *, LPCWSTR, int, uint64_t *))(
                        local_2c8, (LPCWSTR)(uintptr_t)local_res20, 0x4ba,
                        &local_res18);
                    iVar10 = lstrlenW((LPCWSTR)(uintptr_t)local_res20);
                    local_2d8 = (LPCWSTR)((uintptr_t)local_res20 +
                                          (int64_t)iVar10 * 2);
                    if (pWVar11 != NULL) {
                        local_2d8 = local_2d8 + 1;
                    }
                    ...
                    FUN_1400629B8((void *)script, pWVar12,
                                 (LPCWSTR)(uintptr_t)local_res20);
                ...
                if (*local_2a0 != L'\0') {
                    ...
                    VT_CALL(local_2c8, 0x60,
                            int (*)(int64_t *, uint64_t *))(
                        local_2c8, &local_res18);
                    PECMD_VarSetUInt((void *)script, local_res18 & 0xffff,
                                  local_2a0);
                }
                if (*local_290 != L'\0') {
                    local_res18 &= 0xffffffff00000000ULL;
                    VT_CALL(local_2c8, 0x70,
                            int (*)(int64_t *, uint64_t *))(
                        local_2c8, &local_res18);
                    PECMD_VarSetUInt((void *)script, local_res18 & 0xffffffff,
                                  local_290);
                }
                              ...
                              HDC hdc, HWND wnd)
{
    ...
    if (msg < 0x111) {
        if (msg == 0x110) {
            ...
            FUN_140063694((WCHAR **)&local_238, 0x516);
            ...
            *(WCHAR *)((uintptr_t)local_238 + (0x208 + 1) * 2) = L'\0';
            ...
            pWVar10 = (LPWSTR)FUN_14005B6AC(
                g_hInstance, 0x271e,
                (LPWSTR)(uintptr_t)((WCHAR *)(uintptr_t)local_238 + 0x208 + 1),
                0x104);
            _snwprintf((WCHAR *)(uintptr_t)pHVar13, 0x30c,
                       (WCHAR *)(uintptr_t)local_238,
            ...
            *local_250 = L'\0';
            ...
            plVar11 = FUN_1400702F0(&local_180, ".help", (uint64_t)-1);
            FUN_14006375C((WCHAR **)&local_250, (LPCWSTR)(uintptr_t)*plVar11);
            FUN_14005B104((WCHAR **)&local_180);
            iVar26 = FUN_14001f0f4(local_250, (int64_t *)(app + 0x1a));
            if (iVar26 < 1) {
                local_250[iVar8] = L'\0';
                FUN_14006375C((WCHAR **)&local_250, g_pLocale);
                plVar11 = FUN_1400702F0(&local_158, ".lang", (uint64_t)-1);
                FUN_14006375C((WCHAR **)&local_250, (LPCWSTR)(uintptr_t)*plVar11);
                FUN_14005B104((WCHAR **)&local_158);
                iVar26 = FUN_14001f0f4(local_250, (int64_t *)(app + 0x1a));
                if (iVar26 < 1) {
                    local_250[iVar8] = L'\0';
                    plVar11 = FUN_1400702F0(&local_170, "help", (uint64_t)-1);
                    FUN_14006375C((WCHAR **)&local_250, (LPCWSTR)(uintptr_t)*plVar11);
                    FUN_14005B104((WCHAR **)&local_170);
                    iVar26 = FUN_14001f0f4(local_250, (int64_t *)(app + 0x1a));
                    if (iVar26 < 1) {
                        local_250[iVar8] = L'\0';
                        plVar11 = FUN_1400702F0(&local_150, "lang", (uint64_t)-1);
                        FUN_14006375C((WCHAR **)&local_250, (LPCWSTR)(uintptr_t)*plVar11);
                ...
                do {
                    if ((char)app[0x44] == '\0') {
                        if (*(int64_t *)(app + 0x1c) < 1000) {
                            FUN_14001EA18(pHVar28,
                                          (LPCWSTR)(uintptr_t)g_SysCodePage,
                                          WSTR("HELP"),
                                          (int64_t *)(app + 0x1a), NULL);
                        }
                        if (((char)app[0x44] == '\0') &&
                            (*(int64_t *)(app + 0x1c) < 1000)) {
                            FUN_14001EA18(pHVar28,
                                          (LPCWSTR)(uintptr_t)g_SysCodePage,
                                          WSTR("LANG"),
                                          (int64_t *)(app + 0x1a), NULL);
                    ...
                    if (*(int64_t *)(app + 0x1c) < 100) {
                        FUN_14001EA18(pHVar28, *(LPCWSTR *)(app + 0x42),
                                      (LPCWSTR)(uintptr_t)10,
                                      (int64_t *)(app + 0x1a), NULL);
                    }
                } while ((pHVar28 != g_hInstance) &&
                         (pHVar28 = g_hInstance,
                          *(int64_t *)(app + 0x1c) < 100));
            ...
            *(WCHAR **)(app + 0x20) = psVar12;
            ...
            app[0x24] = (int)((*(int64_t *)(app + 0x20) -
                                    *(int64_t *)(app + 0x22)) >> 1) + 1;
            for (psVar12 = (WCHAR *)(*(int64_t *)(app + 0x20) + 0x1a);
                 (*(WCHAR **)(app + 0x20) = psVar12,
                  *psVar12 == 10 || (*psVar12 == 0xd));
                 psVar12 = psVar12 + 1) {
            }
label_029032:
            ...
            *(HWND *)(app + 0x28) = pHVar13;
            ...
            SetDlgItemTextW(hwnd, (uint32_t)*(uint16_t *)((uint8_t *)app + 0x112),
                            pWVar10);
            local_1a8.x = 0;
            local_1a8.y = 0;
            ClientToScreen(hwnd, &local_1a8);
            GetWindowRect(hwnd, &local_230);
            uVar14 = FUN_140009844(hwnd);
            ...
            *(HWND *)(app + 0x2a) = pHVar13;
            ...
            if ((char)local_res18[0] != '\0') {
                ...
                SetWindowPos(*(HWND *)(app + 0x28), (HWND)0, 0, 0,
                             local_1d0.right - local_1d0.left,
                             local_1d0.bottom - local_1d0.top, 6);
                SetWindowPos(*(HWND *)(app + 0x26), (HWND)0, 0, 0,
                             local_248.right - local_248.left,
                ...
                SetWindowPos(*(HWND *)(app + 0x2a), (HWND)0,
                             ...
                             local_1f8.right - local_1f8.left,
                             local_1f8.bottom - local_1f8.top, 4);
                SetWindowPos(local_1d8, (HWND)0,
                             (local_218.left - app[0xe]) - local_230.left,
                             (local_218.top - app[0xf]) - local_230.top,
                             local_218.right - local_218.left,
                             local_218.bottom - local_218.top, 4);
                SetWindowPos(local_1b8, (HWND)0,
                             (local_1e8.left - app[0xe]) - local_230.left,
                             (local_1e8.top - app[0xf]) - local_230.top,
                             local_1e8.right - local_1e8.left,
                             local_1e8.bottom - local_1e8.top, 4);
                SetWindowPos(local_1c0, (HWND)0,
                             (local_190.left - app[0xe]) - local_230.left,
                             (local_190.top - app[0xf]) - local_230.top,
                             local_190.right - local_1e8.left,
                             local_190.bottom - local_1e8.top, 4);
            }
            local_1c0 = (local_1c0 & 0xffffffff00000000ULL) |
                        (uint32_t)(local_230.bottom - local_230.top);
            ...
            *(uint16_t *)(app + 0x32) = 0;
            while ((LPCWSTR)(uintptr_t)local_1d8 > pWVar10) {
                for (; ((WVar2 = *pWVar10, WVar2 != L'\0' && (WVar2 != L'\r')) &&
                        (WVar2 != L'\n'));
                     pWVar10 = pWVar10 + 1) {
                }
            ...
            if ((LPCWSTR)(uintptr_t)local_1d8 > pWVar10) {
                do {
                    if ((int)(int16_t)*(uint16_t *)(app + 0x32) <=
                        (int)(intptr_t)pHVar18) {
                        break;
                    }
                    pWVar25 = (LPWSTR)pWVar10;
                    if ((intptr_t)local_1a0 > 0) {
                        uVar24 = FUN_14001f164(pWVar10, *(LPCWSTR *)(app + 0x2e));
                        if ((int)local_res18[0] < (int)(uint32_t)uVar24) {
                            local_200 = pHVar13;
                            local_res18[0] = (uint32_t)uVar24;
                        }
                    }
                    for (; ((WVar2 = *pWVar25, WVar2 != L'\0' &&
                            (((uint16_t)WVar2 < 9 || (0xd < (uint16_t)WVar2)))) &&
                            (WVar2 != L' '));
                         pWVar25 = pWVar25 + 1) {
                    }
...
label_0298c9:
                    ...
                    *(LPCWSTR *)(uintptr_t)local_1b0 = pWVar10;
                    ...
                    SendMessageW(*(HWND *)(app + 0x26), 0x180, 0,
                                 (LPARAM)(uintptr_t)local_208);
            ...
            SetWindowPos(*(HWND *)(app + 0x26), (HWND)0,
                         local_220[0] - (local_230.right - local_248.left),
                         app[8], local_248.right - local_248.left,
                         ((int)local_1c0 - app[1]) + 3, 4);
            if ((int)local_200 < 0) {
                ...
                SendMessageW(*(HWND *)(app + 0x26), 0x186,
                             (WPARAM)(intptr_t)(int)local_200, 0);
                app[0x13] = 0;
            ...
            *(LONG_PTR *)(app + 0x3a) = LVar20;
            ...
            FUN_14005B104((WCHAR **)&local_208);
            FUN_14005B104((WCHAR **)&local_250);
        ...
        if (msg != 5) {
            if (msg == 0x10) {
                PECMD_ReleaseGdiObject(*(int64_t **)(app + 0x3c),
                              *(uint64_t *)(app + 0x3e),
                              *(HGDIOBJ *)(app + 0x40));
                app[0x3e] = 0;
                app[0x3f] = 0;
...
label_028a83:
            ...
            if ((uVar5 != 0x757a) && (uVar5 != 1)) {
                ...
                if (uVar5 == 0x757e) {
                    ...
                    pHVar18 = PECMD_ReplaceWithEditBox(
                        *(HWND *)(app + 0x2a), DVar27,
                        (uint64_t)(((-(uint32_t)(*(int64_t *)(app + 0x2c) != 0) &
                                    0xffffffc0u) | 0x7960u)));
                ...
                if (uVar5 == 0x7577) {
                    ...
                    if ((char)app[0x25] != '\0') {
                        local_148 = (local_148 & 0xffffffff00000000ULL) |
                                    (0x2551u << 16) | (uint16_t)local_148;
                    }
                    ...
                    psVar12 = *(WCHAR **)(*(int64_t *)(app + 0x30) +
                                          (int64_t)extraout_EAX * 8);
                    if (*psVar12 == 0) {
...
label_02a480:
                ...
                app[0x12] = iVar8 + 100;
                if ((((local_248.bottom - app[0xf]) - app[8]) -
                     local_248.top) + 100 <= iVar8 + 100) {
                    app[0x12] = 0;
                }
            }
            ...
            do {
                ...
                if (pWVar15 == NULL) {
                    ...
                    if (*pWVar10 != L'\0') {
                        ...
                        uVar24 = 1;
                        do {
                            uVar16 = FUN_14001f164(pWVar10, (LPCWSTR)(uintptr_t)local_208);
                            iVar26 = (int)uVar16;
                            if (((int)uVar24 <= iVar26) &&
                                (uVar24 = uVar16 & 0xffffffffu,
                                 pWVar15 = (LPWSTR)pWVar10, iVar6 <= iVar26)) {
                                break;
                            }
                            iVar26 = (int)uVar24;
                            pWVar10 = pWVar10 + 1;
...
label_029c5c:
                    app[0x13] = (int)(((intptr_t)pWVar15 -
                                           *(intptr_t *)(app + 0x20)) >> 1) + 1;
            ...
            if (pWVar15 != NULL) {
                ...
                LVar19 = SendMessageW(*(HWND *)(app + 0x28), 0xc9,
                                      (WPARAM)(intptr_t)(((intptr_t)pWVar15 -
                                                          (intptr_t)pWVar3) >> 1),
                                      0);
                ...
                PostMessageW(pHVar18, 0xb6, 0,
                             (LPARAM)(intptr_t)((int)LVar19 - iVar6));
    ...
    SetWindowPos(local_1a0, (HWND)0, iVar26 - app[6], app[8], app[4],
                 (iVar8 - app[1]) + 3, 4);
    SetWindowPos(local_200, (HWND)0, 0, app[8], iVar26 - iVar6,
                 (iVar8 - iVar29) - app[1], 6);
    ...
    SetWindowPos(*(HWND *)(app + 0x2a), (HWND)0, app[10], iVar29,
                 local_res18[0], iVar30, 4);
    iVar26 = iVar26 - app[0x10];
    iVar8 = iVar8 - app[0x11];
    SetWindowPos(local_1d8, (HWND)0, iVar26, iVar8, 0, 0, 5);
    SetWindowPos(local_1b0, (HWND)0, iVar26 + app[0x14], iVar8 + app[0x15],
                 0, 0, 5);
    SetWindowPos(local_208, (HWND)0, iVar26 + app[0x16], iVar8 + app[0x15],
                 0, 0, 5);
    SetWindowPos(local_1b8, (HWND)0, iVar26 + app[0x16], iVar8 + app[0x17],
                 0, 0, 5);
...
extern void FUN_1400E6D68(WCHAR *dst, uint64_t a2);
extern void FUN_1400066e4(void);
...
extern int FUN_14001a488(LPCWSTR s, DWORD pid, uint32_t case_sens);
extern void PECMD_TerminateProcessById(DWORD pid, UINT hwnd, void *msg);
extern void FUN_140006770(DWORD pid, WCHAR *path);
...
extern uint64_t FUN_14001e240(LPCWSTR path, int64_t *pp);
...
extern void FUN_1400668EC(int64_t *ps, HANDLE h, LPCWSTR a3, LPCWSTR fmt);
...
extern int64_t FUN_14007A224(int64_t *a1, WCHAR *s, ULARGE_INTEGER *out,
                             int a4, uint8_t a5);
extern WCHAR *FUN_140028484(int64_t *a1, LPCWSTR s, ULARGE_INTEGER *out);
...
extern void FUN_140082448(int64_t *pp, double *out);
...
extern uint64_t FUN_14001e870(int mode);
...
extern ULARGE_INTEGER FUN_140018bf0(WCHAR *s, int a2, int a3);
...
LAB_14002d791:
    {
        ...
        DWORD DVar4 = 0;
        FUN_140063694((WCHAR **)&local_3c0, 0x48f3);
        local_400 = local_3c0;
        ...
        *local_3e0 = L'\0';
        ...
        if (out != NULL) {
            ...
            FUN_1400E6D68(local_400, *(uint64_t *)local_2c8);
            FUN_1400E6D68(local_3f8, *(uint64_t *)(local_374 + 4));
        }
        DWORD DVar15 = 0;
        if (((mode & 1) == 0) && (*filter == L'\0')) {
            ...
            }
            {
                ...
                FUN_1400E6D68(local_348, (uint64_t)g_QPFreq);
                FUN_14006375C((WCHAR **)out, local_348);
                {
                                    ...
                                    if (lVar16 == 0) {
                                        if ((int)local_440 == 0) {
                                            ...
                                            if (iVar9 == 0) goto LAB_14002dfb4;
                                             ...
                                             PECMD_CmpStrN(pe32.szExeFile, filter,
                                                           (int)local_440, uVar8)) {
                                        goto LAB_14002dfb4;
                                    }
                                    goto LAB_14002e2de;
...
LAB_14002dfb4:
                                if ((((out == NULL) && (local_3d0 != 0)) &&
                                    ...
                                    ((local_438 != NULL) &&
                                     (FUN_14001a488(local_438, pe32.th32ProcessID, uVar8) == 0))) {
                                    goto LAB_14002e2de;
                                }
                                if (out == NULL) {
                                    uVar11 = local_428;
                                    ...
                                    if (iVar3 != 0 || local_420 != 0) {
                                        ...
                                        if (iVar3 != 0) {
                                            PECMD_TerminateProcessById(pe32.th32ProcessID, local_410, NULL);
                                        }
                                        DVar14 = DVar5 + 1;
                                        goto LAB_14002e2de;
                                    }
...
LAB_14002dcd5:
                            ...
                            if ((out != NULL) || (lVar17 != 0)) {
                                if ((out != NULL) && (hProcess = OpenProcess(0x400, 0, pe32.th32ProcessID)) != (HANDLE)0) {
                                    ...
                                    BOOL BVar10 = GetProcessTimes(hProcess, &ftCreate[0],
                                ...
                                FUN_140006770(pe32.th32ProcessID, local_430 + 0x656);
...
LAB_14002e1cd:
                                    ...
                                    FUN_1400E6D68(local_430, (uint64_t)lVar16);
...
LAB_14002e2de:
        ...
        FUN_14005B104((WCHAR **)&local_3c0);
        FUN_14005B104((WCHAR **)&local_418);
        return DVar15;
    }
}
                        ...
                        }
                        {
                            ...
                            if (*(int16_t *)local_b8 != 0) {
                                *(uint16_t *)local_b8 = 0;
                                ...
                                if ((*(int16_t *)local_b8 != 0) &&
                                    (local_78 = local_b8,
                                     FUN_1400F429C(&local_b8, (WCHAR)sVar18),
                                     *(int16_t *)local_b8 != 0)) {
                                    *(uint16_t *)local_b8 = 0;
                                    local_b8 = local_b8 + 1;
                                }
...
LAB_14002f66a:
...

    {
        ...
        FUN_140063694(&local_a0, (int64_t)(iVar5 + 0x3a9));
        local_98 = 0;
        ...
        if (iVar8 == 0) {
            ...
            if ((int)uVar10 != 0) {
                FUN_1400703E4((WCHAR **)&local_res18, local_res10);
            ...
            if (iVar21 == 0) {
                ...
                local_68 = NULL;
                {
                    ...
                    if ((pWVar12 == NULL) || (*pWVar12 != L'#')) {
                        local_50[0] = pWVar12;
                        uVar16 = FUN_14001e240(local_res10, (int64_t *)&local_90);
                    } else {
                        pWVar13 = NULL;
                        HMODULE pHVar14;
                        HMODULE pHVar15;
                                        ...
                                        do {
                                            if (0 < iVar8) {
                                                ...
                                                *pWVar12 = L'\"';
                                                ...
                                                if (pWVar9 == NULL) {
                                                    FUN_14001d744(pWVar12, pWVar13, iVar8 * 2);
...
LAB_14002fbdf:
        if (local_60 != NULL) {
            FUN_1400668EC(fontList, local_98, local_60, WSTR("0x%I64X"));
        }
        if (local_78 != NULL) {
...
LAB_140032f6a:
    ...
    if (bVar43) {
        ...
        for (puVar24 = (uint16_t *)(UVar15.QuadPart + (int64_t)(iVar6 + -1) * 2);
             ((8 < *puVar24 && (*puVar24 < 0xe)) || (*puVar24 == 0x20));
             puVar24 = puVar24 - 1) {
            *puVar24 = 0;
        }
        if (*puVar24 == 0x5d) {
...
LAB_140033715:
            ...
            while (WVar29 != WVar2) {
                if ((((WVar29 == L'>') || (WVar29 == L'<')) || (WVar29 == L'=')) ||
                    ...
                    FUN_1400703E4((WCHAR **)&local_130.QuadPart, (LPCWSTR)UVar19.QuadPart);
                    local_160 = local_130;
        ...
        if ((WVar29 == L'\"') || (WVar29 == L'\'')) {
            ...
            local_150 = local_170;
                   ...
                   (local_150.QuadPart = local_res10.QuadPart + 2,
                    9 < (uint16_t)(WVar29 + 0xfff0))) {
            DVar9 = DVar8;
        }
        UVar27 = local_res10;
        UVar19 = local_1a0;
                ...
                if (((WVar29 == L'>') || (WVar29 == L'<')) ||
                    ...
                    if (((((pWVar32 == (WCHAR *)(uintptr_t)UVar30.QuadPart) ||
                        ...
                        ((((WVar29 = *(WCHAR *)(local_150.QuadPart - 2),
                          ...
                          ((((uint16_t)WVar29 < 9 || (0xd < (uint16_t)WVar29)) &&
                            (WVar29 != L' ')))))) {
                        if (cVar31 <= (char)bVar16) goto LAB_1400332df;
                        break;
                    }
...
LAB_1400333d1:
                if (pWVar41 == (WCHAR *)(uintptr_t)UVar30.QuadPart) goto LAB_140033464;
                local_150 = UVar19;
                PECMD_SkipLeadingControls((WCHAR **)&local_150.QuadPart);
                local_170 = local_150;
                ...
                if ((*(WCHAR *)UVar27.QuadPart == L'\'') || (uVar3 = 1, *(WCHAR *)UVar27.QuadPart == L'*')) {
                    uVar3 = DVar8;
                }
                if ((DVar9 & uVar3) != 0) goto LAB_1400333d1;
LAB_140033464:
                local_170.QuadPart = FUN_140024C48((int64_t *)&local_1a0.QuadPart, NULL, 0xc1);
                UVar27 = local_res10;
            }
LAB_140033486:
            if (bVar1 == bVar16) goto LAB_1400336c4;
...
LAB_14003378b:
            if ((*(uint8_t *)((char *)script + 0xd) == bVar16) &&
                ...
                FUN_1400703E4((WCHAR **)&local_190.QuadPart, pWVar18);
            }
            goto LAB_140033812;
        }
        ...
        if (UVar15.QuadPart != UVar30.QuadPart) {
            ...
            local_160 = UVar15;
            FUN_14005B104((WCHAR **)&local_b0.QuadPart);
        }
        FUN_14005B104((WCHAR **)&local_a8.QuadPart);
    } else {
        if (uVar26 != DVar8) goto LAB_14003378b;
        FUN_14007BF44(script, (WCHAR *)UVar27.QuadPart, &local_190, 0, 1);
LAB_140033812:
        if (UVar15.QuadPart != UVar30.QuadPart) {
            iVar7 = lstrlenW((LPCWSTR)local_190.QuadPart);
            ...
            if (uVar26 == DVar8) {
                ...
                for (UVar19 = local_160;
                     (((*(int16_t *)UVar19.QuadPart == 0x3e) ||
                ...
                if (((*(uint8_t *)((char *)script + 0xd) != bVar16) ||
                    ...
                    (pWVar11 = FUN_140028484(script, (LPCWSTR)UVar19.QuadPart, &local_1a0),
                     pWVar11 != (WCHAR *)(uintptr_t)UVar30.QuadPart)) {
                    pWVar41 = pWVar11;
                }
                iVar7 = lstrlenW(pWVar41);
                PECMD_AllocString(&local_190.QuadPart, (int64_t)(uintptr_t)pWVar32 + lVar13 + iVar7);
                if (pWVar32 != (WCHAR *)(uintptr_t)UVar30.QuadPart) {
                    FUN_14001d78c((void *)(local_190.QuadPart + lVar13 * 2),
                                  (const void *)UVar15.QuadPart, (int)(uintptr_t)pWVar32 * 2);
                }
                FUN_14001d78c((void *)(local_190.QuadPart + ((uintptr_t)pWVar32 + lVar13) * 2),
                              (const void *)pWVar41, (iVar7 + 1) * 2);
                FUN_14005B104((WCHAR **)&local_1a0.QuadPart);
                uVar37 = local_188.LowPart;
            }
    ...
    if (UVar15.QuadPart != UVar30.QuadPart) {
        for (; (((uint16_t)*(WCHAR *)UVar19.QuadPart < 9 ||
                ...
                ((*(WCHAR *)UVar19.QuadPart != L' ') &&
                 (UVar19.QuadPart < UVar15.QuadPart)));
             UVar19.QuadPart = UVar19.QuadPart + 2) {
        }
    }
...
LAB_1400343b2:
            local_res10.QuadPart = (uint64_t)(uintptr_t)FUN_14001BE14((WCHAR *)(uintptr_t)UVar27.QuadPart);
...
LAB_140034486:
                    ...
                    DVar10 = DVar38;
                    if (DVar38 != DVar8) goto LAB_140034486;
                }
            }
                ...
                if ((int64_t)UVar30.QuadPart <= lVar13) {
                    do {
                        if ((*(WCHAR *)(local_res10.QuadPart + lVar13 * 2) != L'\\') &&
                            (*(WCHAR *)(local_res10.QuadPart + lVar13 * 2) != L'/')) break;
    ...
    local_188 = UVar15;
    if ((((bVar1 == 1) && (local_188.QuadPart = UVar15.QuadPart + 2,
    ...
    if (local_168 != uVar37) {
        if (local_1a4 == uVar37) {
            ...
            FUN_140082448((int64_t *)&local_res10.QuadPart, (double *)&local_1a0);
            FUN_140082448((int64_t *)&local_188.QuadPart, (double *)&local_150);
            local_140 = local_1a0;
            local_178 = local_150;
        ...
        if (iVar7 < 3) {
            if (pWVar41 == (WCHAR *)(uintptr_t)UVar30.QuadPart) {
                FUN_14005B104((WCHAR **)&local_130.QuadPart);
                FUN_14005B104((WCHAR **)&local_138.QuadPart);
                FUN_14005B104((WCHAR **)&local_190.QuadPart);
        ...
        if (((uint32_t)(iVar7 - 3) < 3) &&
            (DVar9 = StrCmpNIW((LPCWSTR)local_1a0.QuadPart, WSTR("MEM"), 3),
             DVar9 == DVar8)) {
            bVar20 = bVar21;
            if (iVar7 == 3) {
LAB_140033e74:
                ...
                bVar20 = 1;
LAB_140033e77:
                local_140.QuadPart = FUN_14001e870((int)(char)bVar21);
                UVar27 = local_140;
                if (bVar20 != bVar16) {
...
LAB_140033ed9:
                ...
                if (iVar7 == 4) {
                    if (uVar28 != (uint16_t)((int16_t)lVar40 + 0x3dU)) {
                        if (uVar28 == 0x42) goto LAB_140033e77;
                        if (uVar28 != 0x55) goto LAB_140033f6b;
                        bVar20 = 1;
                    }
                    goto LAB_140033e74;
                }
                if (iVar7 != 5) goto LAB_140033f47;
                if (uVar28 == 0x42) {
                    if (uVar17 == 0x55) {
                        bVar21 = 1;
                    } else {
                        bVar21 = bVar16;
                        if (uVar17 != 0x41) goto LAB_140033f6b;
                    }
                    goto LAB_140033e77;
                }
LAB_140033f6b:
                ...
                local_ea = WVar2;
                UVar27 = FUN_140018bf0((WCHAR *)(uintptr_t)UVar27.QuadPart,
...
LAB_140033f47:
        if ((iVar7 != 3) || (DVar9 = StrCmpNIW((LPCWSTR)local_1a0.QuadPart, WSTR("KEY"), 3),
                             DVar9 != DVar8)) {
            goto LAB_140033f6b;
        }
LAB_14003401f:
...
LAB_14003427e:
        UVar19.LowPart = (UVar19.LowPart & 0xffffff00u) |
                         (uint8_t)(local_140.QuadPart != UVar27.QuadPart);
        goto LAB_14003450f;
    }
    if (*(WCHAR *)UVar15.QuadPart == L'=') {
        UVar19.LowPart = (UVar19.LowPart & 0xffffff00u) |
                         (uint8_t)(local_140.QuadPart == local_178.QuadPart);
        goto LAB_14003450f;
    }
...
LAB_14003450f:
        ...
        if (*(WCHAR *)UVar15.QuadPart == L'<') {
            if (*(WCHAR *)(UVar15.QuadPart + 2) != L'=') {
                if (*(WCHAR *)(UVar15.QuadPart + 2) == L'>') goto LAB_14003427e;
                goto LAB_1400342e6;
            }
LAB_1400342cc:
            UVar19.LowPart = (UVar19.LowPart & 0xffffff00u) |
...
LAB_1400342e6:
        if (*(WCHAR *)UVar15.QuadPart == L'!') {
            if (*(WCHAR *)(UVar15.QuadPart + 2) == L'=') goto LAB_14003427e;
            if (*(WCHAR *)(UVar15.QuadPart + 2) == L'>') goto LAB_1400342cc;
            if (*(WCHAR *)(UVar15.QuadPart + 2) == L'<') goto LAB_1400342af;
        }
        if (*(WCHAR *)UVar15.QuadPart == L'>') {
            UVar19.LowPart = (UVar19.LowPart & 0xffffff00u) |
                             (uint8_t)((int64_t)local_178.QuadPart < (int64_t)local_140.QuadPart);
        ...
        if (*(WCHAR *)UVar15.QuadPart != L'@') goto LAB_140034640;
    ...
    UVar27.QuadPart = (UVar27.QuadPart & 0xffULL) |
                      (UVar30.QuadPart & 0xffffffffffffff00ULL);
    if (local_104 == uVar3) {
        bVar44 = uVar26 != uVar3;
    } else {
        bVar44 = uVar26 == uVar3;
    ...
    *local_110 = (WCHAR)((uint16_t)UVar19.LowPart + L'0');
    ...
    UVar15 = UVar19;
    local_110 = pWVar41;
    if (bVar43 == (bool)(char)UVar30.LowPart) goto LAB_1400346eb;
    WVar2 = *(WCHAR *)local_170.QuadPart;
    ...
    if (WVar2 != WVar29) {
        do {
            ...
            if ((((((WVar2 == L'[') || (WVar2 == L']')) || (WVar2 == L'(')) ||
                  ((WVar2 == L')') || (WVar2 == L'&'))) ||
                ((WVar2 == L'|' &&
                  (((8 < (uint16_t)*(WCHAR *)(local_170.QuadPart + 2) &&
                ...
                *pWVar41 = WVar2;
                pWVar41 = pWVar41 + 1;
                local_110 = pWVar41;
            } else if ((((uint16_t)WVar2 < 9) || (0xd < (uint16_t)WVar2)) &&
                       (WVar2 != L' ')) {
                goto code_r0x00014003460d;
            }
            local_170.QuadPart = local_170.QuadPart + 2;
            WVar2 = *(WCHAR *)local_170.QuadPart;
            if (WVar2 == WVar29) break;
        } while (1);
    }
LAB_1400346b2:
    local_b8[-3] = L'#';
...
LAB_1400346eb:
    if (local_100 != uVar3) {
        ...
        UVar15.QuadPart = (UVar15.QuadPart & 0xffULL) |
                          (UVar27.QuadPart & 0xffffffffffffff00ULL);
...
code_r0x00014003460d:
    if (*(WCHAR *)local_170.QuadPart == WVar29) goto LAB_1400346b2;
    FUN_14005B104((WCHAR **)&local_130.QuadPart);
    FUN_14005B104((WCHAR **)&local_138.QuadPart);
    FUN_14005B104((WCHAR **)&local_190.QuadPart);
    goto LAB_1400330ae;
...
extern void PECMD_SetThreeSlots(uint64_t *a1, uint64_t a2, uint64_t a3,
                          uint64_t text);
...
uint64_t FUN_1400369D0(int argc, int64_t *argv, int64_t *out)
{
    ...
    union {
        MEMORYSTATUS ms;
        uint64_t raw[64]; /* TODO(verify): 反编译以 dwAvailPageFile/dwTotalVirtual 偏移兼作 64 位表 */
    } local_178;
    ...
    if (argc == 2) {
        ...
        if (iVar8 == 0) {
            ...
            wsprintfW((LPWSTR)(uintptr_t)*out,
                      WSTR("*%X.%02X  %X.%X %s"),
                      (int)(int16_t)((uint64_t)local_198 >> 8),
                      (uint64_t)local_198 & 0xff);
            FUN_14005B104(&local_190);
            return 0;
        }
        goto parse_loop;
    } else {
                                ...
                                if (uVar1 < 0x75) {
                                    if (uVar1 == 0x74) {
                                        ...
                                        if (iVar8 == 0) {
                                            ...
                                            iVar8 = wcscmp((WCHAR *)(uintptr_t)*plVar15, WSTR("vm"));
                                            if (iVar8 == 0) {
                                                uVar20 = uVar20 | 0x200;
                                            } else {
                                                iVar8 = wcscmp((WCHAR *)(uintptr_t)*plVar15, WSTR("proxy"));
                                                if (iVar8 != 0) {
                                                    return 0;
                                                }
                                                uVar20 = uVar20 | 0x300;
                                        ...
                                        if (uVar1 == 0x6f) {
                                            ...
                                            pwVar16 = wcstok((WCHAR *)(uintptr_t)argv[2], WSTR(","));
                                                    ...
                                                    if (iVar8 == 0) {
                                                        ...
                                                        if (iVar8 == 0) {
                                                            ...
                                                            if (iVar8 == 0) {
                                                                ...
                                                                iVar8 = wcscmp(pwVar16, WSTR("saved"));
                                                                if (iVar8 == 0) {
                                                                    if (iVar11 != 4) {
                                                                        return 0;
                                                                    }
                                                                    ...
                                                                    iVar8 = wcscmp(pwVar16, WSTR("ip"));
                                                                    if (iVar8 == 0) {
                                                                        if ((uVar20 & 0xf000) != 0 || (uVar20 & 0xf00) != 0x300) {
                                                                            return 0;
                                                                        }
                                                                        local_1b8 = 1;
                                                                        uVar20 = uVar20 | 0x2000;
                                                                    } else {
                                                                        iVar8 = wcscmp(pwVar16, WSTR("comm"));
                                                                        if (iVar8 == 0) {
                                                                            if ((uVar20 & 0xf000) != 0 || (uVar20 & 0xf00) != 0x300) {
                                                                                return 0;
                                                                            }
                                                                            ...
                                                                            iVar8 = wcscmp(pwVar16, WSTR("shm"));
                                                                            if (iVar8 == 0) {
                                                                                if ((uVar20 & 0xf000) != 0 || (uVar20 & 0xf00) != 0x300) {
                                                                                    return 0;
                                                                                }
                                                                                uVar20 = uVar20 | 0x3000;
                                                                            } else {
                                                                                iVar8 = wcscmp(pwVar16, WSTR("awe"));
                                                                                if (iVar8 == 0) {
                                                                                    if (((uVar20 & 0xf00) != 0x100 && (uVar20 & 0xf00) != 0)
                                                                                        || (uVar20 & 0xf000) != 0) {
                                                                                        return 0;
                                                                                    }
                                                                                    uVar20 = uVar20 | 0x1100;
                                                                                } else {
                                                                                    iVar8 = wcscmp(pwVar16, WSTR("par"));
                                                                                    if (iVar8 == 0) {
                                                                                        if (((uVar20 & 0xf00) != 0x100 && (uVar20 & 0xf00) != 0)
                                                                                            || (uVar20 & 0xf000) != 0) {
                                                                                            return 0;
                                                                                        }
                                                                                        uVar20 = uVar20 | 0x2100;
                                                                                    } else {
                                                                                        iVar8 = wcscmp(pwVar16, WSTR("shared"));
                                                                                        if (iVar8 == 0) {
                                                                                            uVar20 = uVar20 | 0x20000;
                                                                                        } else {
                                                                                            if ((uVar20 & 0xf0) != 0) {
                                                                                                return 0;
                                                                                            }
                                                                                            iVar8 = wcscmp(pwVar16, WSTR("hd"));
                                                                                            if (iVar8 == 0) {
                                                                                                uVar20 = uVar20 | 0x10;
                                                                                            } else {
                                                                                                iVar8 = wcscmp(pwVar16, WSTR("fd"));
                                                                                                if (iVar8 == 0) {
                                                                                                    uVar20 = uVar20 | 0x20;
                                                                                                } else {
                                                                                                    iVar8 = wcscmp(pwVar16, WSTR("cd"));
                                                                                                    if (iVar8 != 0) {
                                                                                                        return 0;
                                                                                                    }
                                                                                                    uVar20 = uVar20 | 0x30;
                                        ...
                                        if (((iVar11 != 4 && iVar11 != 1) || local_1d0[0] != 0) || iVar18 < 2) {
                                            return 0;
                                        }
...
LAB_140037084:
                                                ...
                                                if (99 < (int64_t)local_1d0[0] || (int64_t)local_1d0[0] < 1) {
                                                    return 0;
                                                }
                                                GlobalMemoryStatus(&local_178.ms);
                                                {
                                                    __uint128_t product =
                                                        (__uint128_t)local_178.ms.dwAvailPhys * local_1d0[0];
...
LAB_1400370f5:
                                ...
                                local_1d8[0] = (uint32_t)wcstoul((WCHAR *)(uintptr_t)argv[2], NULL, 0);
                                uVar17 = local_1d8[0];
                            } else if (uVar1 == 0x76) {
                        ...
                        if (uVar1 == 0x6d) {
                            if ((((uVar17 != 0xffffffff && iVar11 != 4) && iVar11 != 1) || _Str1 != NULL)
                                || iVar18 < 2) {
                                return 0;
                            }
    ...
    if (iVar11 == 1) {
        ...
        if ((char)local_res20 == '\0') {
            ...
            iVar11 = ((int (*)(LPCWSTR, uint32_t, uint64_t *, int64_t *))g_pImDiskGetPartInfo)(
                pWVar5, local_1bc, &local_1e0, local_138);
            if ((iVar11 == 0) ||
                (local_178.raw[4 + uVar12 * 4] == 0 ||
                 local_178.raw[5 + uVar12 * 4] == 0)) {
                return 0xc;
            }
...
LAB_140037a4d:
    ...
    if ((WVar7 != L'\0') && (local_1a0 == 0)) {
        FUN_1400702F0((int64_t *)&local_1a8, "*X:", (uint64_t)-1);
    ...
    *(uint16_t *)(uintptr_t)*out = 0x2a;
    ...
    wsprintfW((LPWSTR)(uintptr_t)(*out + 2), pwVar16,
              (uint64_t)uVar10, (uint64_t)(uint16_t)WVar7);
    return uVar19;
}
                          ...
                          HDC hdcIn, uint8_t *p5)
{
    ...
    if (msg == 0x21) {
        ...
        FUN_140063694(&local_100, 0x19000);
        *local_100 = L'\0';
        ...
        DVar10 = FUN_14005C4E0((HKEY)0xffffffff80000002, WSTR("SOFTWARE\\PELOGON"),
                                WSTR("Text.Paramd"), local_e8, (BYTE *)local_100,
                                local_res18);
        if (DVar10 != 0) {
            *local_100 = L'\0';
        }
    ...
    if (((g_WM_TaskbarRestart != 0) && (g_WM_TaskbarRestart == msg) &&
         (g_hTooltipParent != (HWND)0)) && (pHVar12 != (HWND)0)) {
        g_hTooltipParent = pHVar12;
        SetParent(local_res10, pHVar12);
    }
    if (((msg != 0x110) && (msg != 0x44f)) &&
        ((pHVar12 != (HWND)0 && (g_hTooltipParent != (HWND)0 &&
                                 (g_hTooltipParent != pHVar12))))) {
        g_hTooltipParent = pHVar12;
        SetParent(local_res10, pHVar12);
    }
                ...
                if ((g_flagA249 < 0) && ((g_bitFlags & 2) == 0)) {
                    ...
                    do {
                        ...
                        if (0 < (int)(iVar6 - DVar11)) {
                            SetLayeredWindowAttributes(local_res10, 0,
...
LAB_14003858a:
        EnterCriticalSection(&g_csInit);
        if (msg == 0x450) {
            FUN_140063694(&local_f8, 0x20a);
            *local_f8 = L'\0';
            local_e8[2] = 0;
            local_e8[1] = 0x412;
            DVar10 = FUN_14005C4E0((HKEY)0xffffffff80000002, WSTR("SOFTWARE\\PELOGON"),
                                    WSTR("LogoFile"), local_e8 + 2, (BYTE *)local_f8,
                                    local_e8 + 1);
            local_f8[0x208] = L'\0';
            if ((DVar10 == 0) && (*local_f8 != L'\0')) {
                FUN_1400703E4(&g_pwszD220, local_f8);
            }
    ...
    if (msg == 0x110) {
        ...
        if (g_flagCF86 != '\0') {
            ...
            SetWindowPos(local_res10, (HWND)0, g_intA238, g_intA23C,
                         iVar8, iVar5, 0x14);
        }
...
LAB_140038086:
    ...
    PECMD_DrawTooltipText(script, hDC, local_res10);
    if (hdc != hDC) {
        BitBlt(hdc, local_res18[0], iVar6, cx, iVar5, hDC,
               local_res18[0], iVar6, 0xcc0020);
    }
...
typedef struct {
    ...
    DWORD dmFields;
    union {
        struct { POINT dmPosition; DWORD dmDisplayOrientation; DWORD dmDisplayFixedOutput; } field1;
    } field6_0x4c;
    WORD dmColor;
    WORD dmDuplex;
    WORD dmYResolution;
    ...
    if (cVar36 == (char)*local_a40) {
      ...
      if (bVar8) {
        ...
        if ((uint32_t)(int)cVar36 == uVar13) {
          do {
            while ((uVar11 = (uint16_t)uVar13, uVar11 != 0 &&
        ...
        FUN_140063694(&local_res18,0x28);
        ...
        FUN_14001d78c((uint8_t *)local_9b0,PTR_DAT_14013a250,(iVar14 + 1) * 2);
        for (local_a40 = (WCHAR *)local_9b0; *local_a40 != L'\0'; local_a40 = local_a40 + 1) {
          if ((char)*local_a40 == '\\') {
        ...
        pWVar7 = local_9b0;
        local_9b0 = pWVar5;
        plVar21 = FUN_1400702F0((int64_t *)local_res20,"**mem",0xffffffffffffffff);
        uVar19 = FUN_1400B638C(script,pWVar7,(LPCWSTR)(uint64_t)(local_res18)
                               ,(LPCWSTR)*plVar21,(uint32_t)uVar11 << 0x10 | 0x40,(LPCWSTR)0x0,
                               (int64_t *)0x0);
        FUN_14005B104((int64_t *)local_res20);
        FUN_14005B104((int64_t *)&local_9b0);
        goto LAB_140038e01;
      }
      if (cVar36 == (char)*local_a40) {
...
joined_r0x00014003919a:
  if (WVar2 == L'\0') goto LAB_140039657;
  if (((WVar2 == L'-') && (local_res10[1] == L'-')) &&
     (((WVar3 = local_res10[2], WVar3 == L'\0' || ((8 < (uint16_t)WVar3 && ((uint16_t)WVar3 < 0xe)))) ||
      (WVar3 == L' ')))) goto LAB_140039630;
  if (cVar36 != WVar2) goto LAB_140039645;
  local_res10 = local_res10 + 1;
...
LAB_1400395a9:
        ...
        if ((char)uVar19 == '\0') {
          ...
          if ((char)uVar19 == '\0') {
            for (; (WVar2 = *local_res10, WVar2 != L'\0' &&
        ...
        local_998 = dVar6;
        if (cVar9 < '\x01') {
          FUN_140067d54((int64_t *)&local_res10,&local_998);
        }
        else {
          PECMD_SkipLeadingControls(&local_res10);
        ...
        if (cVar9 < '\x01') {
          ...
          if (*local_res10 == L'\0') goto LAB_1400396a0;
          FUN_14005B104((int64_t *)&local_9c0);
          if (hDC != (HDC)0x0) {
...
LAB_140039701:
          ...
          lVar28 = (uint64_t)((__uint128_t)0x56ac0156ac0156adULL * (uint64_t)B2F_LO64(auVar4));
...
LAB_140039657:
  ...
  if (*local_res10 == L'=') {
    ...
    WVar2 = *local_res10;
    while (((WVar2 != L'\0' && (((uint16_t)WVar2 < 9 || (0xd < (uint16_t)WVar2)))) && (WVar2 != L' ')))
    {
      local_res10 = local_res10 + 1;
      WVar2 = *local_res10;
    }
...
LAB_14003989b:
    ...
    local_9f8 = 0;
    local_a58 = (LPWSTR)FUN_14001fcd0((uint16_t *)local_res10,0x53);
    ...
    local_a58 = (LPWSTR)FUN_14001fcd0((uint16_t *)local_res10,0x50);
    iVar34 = 0x84;
    if (((local_a58 != (LPWSTR)0x0) && (pWVar29 != (WCHAR *)0x0)) &&
       ((local_a48[0] == 0x84 && (uVar13 = uVar13 | 0x100, pWVar20 < local_a58)))) {
      pWVar20 = local_a58;
    }
    local_a58 = (LPWSTR)FUN_14001fcd0((uint16_t *)local_res10,0x40);
    lVar28 = 0;
    if ((local_a58 != (LPWSTR)0x0) && ((local_a48[0] == iVar34 || (local_a48[0] < 1)))) {
      ...
      do {
        ...
        if ((int)(uint64_t)(uint8_t)bVar10 < 1) break;
        local_a58 = local_a58 + 1;
    ...
    if ((bVar8) || (cVar9 != '\0')) {
      uVar19 = PECMD_EnumDisplayModes(&local_9f0,1000,((local_a00 & 0xffffu) | local_a24 | local_a28),pWVar29);
...
LAB_140039c58:
            wsprintfW(local_4e8,pwVar25,(uint64_t)pDVar37->dmPelsWidth,pDVar37->dmPelsHeight);
          }
          else {
            ...
            wsprintfW(local_4e8,WSTR("%d\t%d\t%d"),(uint64_t)pDVar37->dmPelsWidth,pDVar37->dmPelsHeight)
            ;
            uVar18 = local_a28;
          }
          ...
          if (uVar22 * local_a08 * local_a10 <
              (uint64_t)pDVar37->dmBitsPerPel * (uint64_t)pDVar37->dmDisplayFrequency * uVar26) {
      ...
      FUN_14005B104(&local_9f0);
      FUN_14005B104(&local_9d8);
      uVar19 = 1;
    }
    else {
...
LAB_14003a7b7:
        ...
        if ((char)uVar13 != '\0') {
          bVar10 = bVar8;
          if (((uint32_t)uVar22 == local_8a8.dmPelsWidth) && (uVar18 == local_8a8.dmPelsHeight)) {
            bVar10 = true;
          }
...
LAB_14003a144:
            ...
            uVar18 = 0x400000;
            if ((uint32_t)local_a10 < 2) goto LAB_14003a144;
          }
          local_988.dmFields =
               uVar18 | (uVar13 & 0x10) * 8 | (uVar13 & 4) << 0x10 | (uVar13 & 2) * 0x80000 |
               (uVar13 & 1) * 0x80000;
          ...
          if ((uVar13 & 0x10) != 0) {
            if ((((uVar39 & 1) != (local_8a8.field6_0x4c.field1.dmDisplayOrientation & 1)) &&
                ((uVar13 & 1) == 0)) && ((uVar13 & 2) == 0)) {
          ...
          uVar39 = local_9b8 | 1;
          LVar17 = ChangeDisplaySettingsExW(local_9e8,&local_988,(HWND)0x0,uVar39,(LPVOID)0x0);
          if (LVar17 == 0) {
...
LAB_14003a352:
            ...
            if ((!bVar10) || (bVar40)) {
              ...
              local_a38 = ChangeDisplaySettingsExW(pWVar29,&local_988,(HWND)0x0,uVar39,(LPVOID)0x0);
              if (local_a38 != 0) goto LAB_14003a2b4;
...
LAB_14003a2b4:
              if (!bVar10) {
                ...
                local_988.dmPelsWidth = uVar18;
                local_a38 = ChangeDisplaySettingsExW
                                      (pWVar29,&local_988,(HWND)0x0,uVar39,(LPVOID)0x0);
                if (local_a38 != 0) goto LAB_14003a370;
                memcpy(&local_8a8,&local_988,0xdc);
                if (!bVar40) goto LAB_14003a3f0;
                if (bVar8) goto LAB_14003a370;
LAB_14003a349:
                uVar19 = (uint64_t)(uint32_t)local_res18;
                goto LAB_14003a352;
              }
LAB_14003a370:
              if (bVar40) {
                ...
                local_a24 = ChangeDisplaySettingsExW
                                      (pWVar29,&local_988,(HWND)0x0,uVar39,(LPVOID)0x0);
                if ((local_a24 == 0) && (memcpy(&local_8a8,&local_988,0xdc), !bVar8))
                goto LAB_14003a349;
              }
            }
LAB_14003a3f0:
            if ((bVar8) || (uVar18 = (uint32_t)local_a10, uVar18 < 2)) {
              ...
              uVar18 = ChangeDisplaySettingsExW(pWVar29,&local_988,(HWND)0x0,uVar39,(LPVOID)0x0);
              uVar19 = (uint64_t)uVar18;
              if (uVar18 == 0) goto LAB_14003a352;
            }
            local_8a8.dmFields = ((-(uint32_t)(1 < local_8a8.dmDisplayFrequency) & 0x400000u) | 0x1c0000u);
            uVar22 = local_a30;
            iVar15 = local_a14;
            cVar9 = local_a4c;
            if (local_9d0 != 0) {
              ChangeDisplaySettingsExW(pWVar29,&local_8a8,(HWND)0x0,uVar39,(LPVOID)0x0);
              uVar22 = local_a30;
              iVar15 = local_a14;
              cVar9 = local_a4c;
            }
        ...
        if (((uVar13 & 0xf00) != 0) && ((local_a48[0] == 0x84 || (0 < iVar15)))) {
          ...
          if ((0 < iVar15) && (((int)(intptr_t)local_a18 < iVar15 && (-1 < (int)(intptr_t)local_a18)))) {
          ...
          if ((local_a48[0] == 0x84) || (0 < iVar15)) {
            ...
            if (0 < (int64_t)iVar14) {
              do {
                ...
                if (BVar16 != 0) {
                  if ((int64_t)iVar15 < 1) {
                    if (DVar32 == local_a18) goto LAB_14003a704;
                  }
                  else {
                    if (iVar15 <= lVar35) break;
                    local_7c8.field6_0x4c.field1.dmPosition.x = *(LONG *)(lVar28 + lVar35 * 8);
                    local_7c8.field6_0x4c.field1.dmPosition.y = *(LONG *)(lVar28 + 4 + lVar35 * 8);
                  }
                  ChangeDisplaySettingsExW(local_3a8.DeviceName,&local_7c8,(HWND)0x0,9,(LPVOID)0x0);
                  if (local_a48[0] == 0x84) {
                    local_5c8.dmPelsWidth = 0;
                    EnumDisplaySettingsW(pWVar29,0xffffffff,&local_5c8);
                    local_7c8.field6_0x4c.field1.dmPosition.x = local_5c8.dmPelsWidth;
                  }
                }
LAB_14003a704:
                lVar35 = lVar35 + 1;
          ...
          ChangeDisplaySettingsExW((LPCWSTR)0x0,(DEVMODEW *)0x0,(HWND)0x0,0,(LPVOID)0x0);
          cVar9 = '\x02';
        }
        if ('\0' < cVar9) {
...
LAB_14003a7d7:
  FUN_14005B104((int64_t *)&local_9e0);
  ppWVar23 = &local_9c8;
LAB_14003a7ec:
  FUN_14005B104((int64_t *)ppWVar23);
...
LAB_14003b5c1:
  ...
  if (*path == L'\\') {
    ...
    lVar8 = local_2b8 * 2;
    FUN_14001d78c((uint8_t *)local_290,(uint8_t *)path,(int)lVar8);
    ...
    if ((int)(intptr_t)local_2f0 == 0) {
      if ((mode & 0xf) == 0) {
        FUN_14001d78c((uint8_t *)local_2e0,(uint8_t *)WSTR("\\INF\\*.INF"),0x16);
        ...
        *local_2e0 = L'\\';
        if (name == (LPCWSTR)0x0) {
          FUN_14001d78c((uint8_t *)(lVar8 + (int64_t)local_290),
                        (uint8_t *)WSTR("!!!!!!!![allinf-file]"),0x2c);
          name = local_290;
        }
        local_2c8 = (HANDLE)0x0;
        PECMD_OpenFileHandle(&local_2c8,name,0x80000000,7,(LPSECURITY_ATTRIBUTES)0x0,3,0,(HANDLE)0x0);
        pvVar12 = local_2c8;
        if (local_2c8 != (HANDLE)0x0) {
          FUN_140063694(&local_300,0x2800);
          _snwprintf(local_300,0x27ff,WSTR("Found Index<%s>"),name);
          FUN_140025f10(size + 8,local_300,0,(WCHAR *)(void *)0x11,(WCHAR *)0x0,
                        (int64_t *)0x0);
          FUN_14005B104((int64_t *)&local_300);
          uVar2 = 0;
          ...
          if (local_2a8 != (WCHAR *)0x0) {
            ...
            local_288 = (((int64_t)
                         (uVar9 + 3 + (uint64_t)((uint32_t)((int64_t)(uVar9 + 3) >> 0x3f) & 3)) >> 2)
                        + 0xffffU) & 0xffffffffffff0000ULL;
            pwVar14 = local_2a8;
...
LAB_14003b8f2:
            while (((uint8_t)*pwVar14 == 0x23 && (pwVar14 < pwVar16))) {
              do {
                if (((uint8_t)*pwVar14 == 10) || ((uint8_t)*pwVar14 == 0xd)) goto LAB_14003b8ed;
                pwVar14 = (WCHAR *)((int64_t)pwVar14 + 1);
              } while (pwVar14 < pwVar16);
            }
            local_298 = (WCHAR *)0x0;
            FUN_1400633A8(&local_2b0,0x30);
            FUN_14005B0B8((uint64_t *)local_2b0);
            uVar9 = local_2b8;
            ...
            if (((bVar4 < 9) || (0xd < bVar4)) &&
               ((bVar4 != 0x20 && (pwVar16 = local_2e0, *(uint8_t *)local_2e0 != 0x23)))) {
              for (; pwVar14 < pwVar16; pwVar16 = (WCHAR *)((int64_t)pwVar16 + -1)) {
                if (((uint8_t)*pwVar16 == 10) || ((uint8_t)*pwVar16 == 0xd)) {
                  ...
                  if ((*(uint8_t *)pwVar1 == 0x23) &&
                     (*(uint8_t *)pwVar16 = 0, local_300 = pwVar1, local_2e0 = pwVar16,
                     pwVar1 != (WCHAR *)0x0)) goto LAB_14003b9c8;
                  break;
                }
              }
...
LAB_14003b9c8:
            ...
            do {
              ...
              if (pwVar14 < local_2e0) {
                ...
                if ((local_300 == (WCHAR *)0x0) || ((uint8_t)*local_300 == 0x23)) {
                  if (0 < (int64_t)local_2f8) {
                    do {
                      WaitForSingleObject(*(HANDLE *)(*(int64_t *)(pWVar3 + uVar15 * 4) + 0x10),
                                          0xffffffff);
                      if (*(int64_t *)(*(int64_t *)(pWVar3 + uVar15 * 4) + 0x20) != 0) {
                        uVar2 = *(uint32_t *)(*(int64_t *)(pWVar3 + uVar15 * 4) + 0x20);
                      }
                      uVar15 = uVar15 + 1;
                  ...
                  for (lVar8 = (int64_t)(local_res20 + -1); -1 < lVar8; lVar8 = lVar8 + -1) {
                    ...
                    pWVar11[2] = L'\0';
                    pWVar11[3] = L'\0';
                    FUN_14005B104((int64_t *)&local_2a0);
                  }
                  if (local_318 != '\0') {
                    uVar2 = (int)local_318;
                  }
                  *(uint64_t *)(size + 0x1a8) = (uint64_t)uVar2;
                  FUN_14005B104((int64_t *)&local_2b0);
                  FUN_14005B104((int64_t *)&local_298);
              ...
              *local_2f0 = size;
              ...
              pwVar14 = local_308;
              FUN_14005B104((int64_t *)&local_2f0);
            } while( true );
          }
          if (pvVar12 != (HANDLE)0xffffffffffffffff) {
            CloseHandle(pvVar12);
        ...
        FUN_14001d78c((uint8_t *)local_2e0,(uint8_t *)WSTR("\\*.INF"),0x16);
        local_2c8 = (HANDLE)0x0;
        uVar9 = local_2b8;
      }
    }
    ...
    if (local_310 != (HANDLE)0x0) {
      do {
        ...
        FUN_14005B0B8((uint64_t *)local_308);
        *(uint64_t *)local_308 = size;
        local_2d0 = local_308;
        *(WCHAR **)(local_308 + 0x14) = local_308 + 0x18;
        pwVar14 = local_308;
        FUN_14001d78c((uint8_t *)(local_308 + 0x18),(uint8_t *)pWVar13,((int)uVar9 + 0x17) * 2
                     );
        *(WCHAR **)(pwVar14 + 0x10) = local_2a8;
        *(short *)(*(uint64_t *)(pwVar14 + 0x14) + 2 + (int64_t)local_2a8 * 2) = (short)iVar5;
        FUN_14001d78c((uint8_t *)(*(uint64_t *)(pwVar14 + 0x14) + 0x4e + uVar9 * 2),
        ...
        if (local_2c0 != (HANDLE)0x0) {
          local_308 = (WCHAR *)0x0;
          EnterCriticalSection((LPCRITICAL_SECTION)&g_csInit);
          *(int *)(*(uint64_t *)local_2d0 + 0x1a4) = *(int *)(*(uint64_t *)local_2d0 + 0x1a4) + 1;
          LeaveCriticalSection((LPCRITICAL_SECTION)&g_csInit);
        ...
        FUN_14005B104((int64_t *)&local_308);
          ...
          if (((local_278.dwFileAttributes & 0x10) != 0) &&
             ((local_278.cFileName[0] != L'.' ||
              ((local_278.cFileName[1] != L'\0' &&
               ((local_278.cFileName[1] != L'.' || (local_278.cFileName[2] != L'\0')))))))) {
            iVar5 = lstrlenW(local_278.cFileName);
            FUN_14001d78c((uint8_t *)(pWVar13 + local_2b8),(uint8_t *)local_278.cFileName,
                          (iVar5 + 1) * 2);
...
LAB_14003c048:
  FUN_14005B104((int64_t *)&local_290);
  return uVar15;
LAB_14003b8ed:
...

{
      ...
      if (cVar7 == '\0') {
        ...
        if (cVar7 == '\0') {
          ...
          if (cVar7 == '\0') {
            ...
            flags = 3;
            if ((cVar7 == '\0') &&
               (cVar7 = FUN_1400660AC("-force",&local_res10.QuadPart,6), flags = 1, cVar7 == '\0')
               ) {
              ...
              if (cVar7 == '\0') {
                ...
                if (cVar7 == '\0') {
                  ...
                  if (cVar7 == '\0') {
                    ...
                    if (cVar7 == '\0') {
                      cVar7 = FUN_1400660AC("-delay",&local_res10.QuadPart,6);
                      if (cVar7 == '\0') {
  ...
  if (bVar2) {
    ...
    FUN_14005B104((WCHAR **)&local_res20.QuadPart);
  ...
  FUN_140063694(&local_78,(int64_t)((iVar9 + 1) * 2 + 4));
  lVar13 = (int64_t)(iVar9 + 1) * 2;
  FUN_14001d78c((uint8_t *)local_78,(uint8_t *)(uintptr_t)local_res10.QuadPart,(int)lVar13);
  ...
  *(short *)(local_58.QuadPart + local_50 * 2) = 0;
  ...
  if ((uVar10 != 0) && (local_b0.wFunc == 3)) {
    if (((uVar10 & 2) == 0) ||
       (iVar18 = SHFileOperationW(&local_b0), LVar22.QuadPart = LVar23.QuadPart, iVar18 != 0)) {
      LVar22.QuadPart = PECMD_DeleteDirectoryTree((LPCWSTR)local_70.QuadPart, (uint32_t)(uint8_t)local_c5);
    }
    goto LAB_14003c9a2;
  }
  if (bVar4) {
    if ((local_b0.pTo == (LPCWSTR)0x0) || (LVar22.QuadPart = (int64_t)(uintptr_t)local_b0.pTo, *local_b0.pTo == 0)
       ) {
...
LAB_14003c906:
      ...
      *(WCHAR *)(uintptr_t)LVar22.QuadPart = L'\0';
      ...
      LVar22 = LVar23;
LAB_14003c8ca:
      FUN_14005B104(&pLVar16->QuadPart);
      goto LAB_14003c9a2;
    }
    if (bVar5) {
      ...
      if (bVar6) {
        ...
        lVar13 = PECMD_OpenFileHandle((HANDLE *)&local_res20.QuadPart,local_b0.pFrom,0x80000000,7,(LPSECURITY_ATTRIBUTES)0x0,3
        ...
        if (lVar13 == 0) {
          ...
          local_res20.QuadPart = 0;
          lVar13 = PECMD_OpenFileHandle((HANDLE *)&local_res20.QuadPart,local_b0.pFrom,0x80000000,7,(LPSECURITY_ATTRIBUTES)0x0
                                 ,3,0x6000080,(HANDLE)0x0);
          DVar11 = GetLastError();
...
LAB_14003c9a2:
  FUN_14005B104(&local_58.QuadPart);
  FUN_14005B104(&local_70.QuadPart);
...

{
  ...
  if (WVar15 == *(WCHAR *)&local_98->DebugInfo) {
    do {
      ...
      if (local_res10 == (LPCRITICAL_SECTION)0x0) break;
      ...
      if (cVar4 == '\0') {
        ...
        if ((char)uVar7 != '\0') {
          ...
          LeaveCriticalSection((LPCRITICAL_SECTION)&g_csInit);
          FUN_14005B104((int64_t *)&local_98);
          ...
          if (cVar4 == '\0') {
            ...
            if (cVar4 == '\0') {
              ...
              if (cVar4 == '\0') {
                ...
                if (cVar4 == '\0') {
                  local_res10 = (LPCRITICAL_SECTION)((int64_t)&local_res10[-1].SpinCount + 6);
                  break;
                }
                local_ac = 1;
              }
...
LAB_14003d1cb:
        ...
        do {
          ...
          DVar6 = FUN_14002D708((LPCWSTR)p_Var16,uVar17 | 0x10 | (int)(char)bVar19,
                                (int64_t *)(uint64_t)(-(uint32_t)((short)uVar17 != 0) & UVar14),0,
                                DVar18);
          ...
          do {
            if ((short)uVar17 != 0) {
              local_a0 = (LPCRITICAL_SECTION)(uint64_t)(p_Var11 == (LPCRITICAL_SECTION)0x0);
              if ((p_Var16 != (LPCRITICAL_SECTION)0x0) && (p_Var11 != (LPCRITICAL_SECTION)0x0))
              goto LAB_14003d3a6;
LAB_14003d40f:
...
LAB_14003d388:
              if (p_Var11 != (LPCRITICAL_SECTION)0x0) {
                PECMD_TerminateProcessById((DWORD)(uintptr_t)p_Var11,UVar14,&local_a0);
                p_Var11 = local_b8;
                p_Var16 = local_res10;
              }
            }
LAB_14003d3a6:
            if ((((short)local_ac != 0) || (p_Var16 == (LPCRITICAL_SECTION)0x0)) ||
               (p_Var11 == (LPCRITICAL_SECTION)0x0)) goto LAB_14003d40f;
            if (local_70 == p_Var11) {
...
LAB_14003d128:
    ...
    if (*(WCHAR *)&local_res10->DebugInfo != L'\0') {
      ...
      if (*(WCHAR *)&local_90->DebugInfo == L'\0') goto LAB_14003d2f8;
      uVar17 = 0x181;
      goto LAB_14003d2f8;
    }
  }
  ...
  if (bVar36 == bVar28) {
    do {
      ...
      if (((((((uint16_t)*pWVar1 < 0x41) || (*pWVar1 == L'*')) ||
            ((0x2f < (uint16_t)*pWVar1 && ((uint16_t)*pWVar1 < 0x3a)))) || (*pWVar1 == L'(')) ||
              ...
              if (cVar8 == '\0') {
                ...
                if (cVar8 == '\0') {
                  ...
                  if (cVar8 == '\0') {
                    ...
                    if ((char)uVar16 == '\0') {
                      cVar8 = FUN_1400660AC("scanall",(int64_t *)&local_res10,7);
                      if (cVar8 == '\0') {
                        cVar8 = FUN_1400660AC("ncd",(int64_t *)&local_res10,3);
                        if (cVar8 == '\0') {
                          cVar8 = FUN_1400660AC("freemem",(int64_t *)&local_res10,7);
                          if (cVar8 == '\0') {
                            cVar8 = FUN_1400660AC("thread",(int64_t *)&local_res10,6);
                            if (cVar8 == '\0') {
                              uVar16 = FUN_14005C788("cur:",(uint16_t *)local_res10,4);
                              if ((char)uVar16 != '\0') {
                              ...
                              WVar35 = *local_res10;
                              while (((WVar35 != L'\0' &&
                                      (((uint16_t)WVar35 < 9 || (0xd < (uint16_t)WVar35)))) &&
                                     (WVar35 != L' '))) {
                                local_res10 = local_res10 + 1;
                                WVar35 = *local_res10;
                              }
                      ...
                      puVar24 = local_4298;
LAB_14003efd6:
                      PECMD_ParseUIntValue((int64_t *)&local_res10,(int *)puVar24);
                    }
                  }
                  else {
  ...
  if ((((uint8_t)*local_res10 == 0x2d) && ((uint8_t)local_res10[1] == 0x2d)) &&
     ((WVar2 = local_res10[2], WVar2 == L'\0' ||
      (((8 < (uint16_t)WVar2 && ((uint16_t)WVar2 < 0xe)) || (WVar35 = L'-', WVar2 == L' ')))))) {
    for (; (WVar35 = *local_res10, WVar35 != L'\0' &&
  ...
  if (bVar27 != 0) {
    ...
    if (hWnd == (HWND)0x0) {
      hWnd = (HWND)FUN_1400235b0(script,bVar27 & 0x40);
    }
    if (hWnd != (HWND)0x0) {
      iVar11 = lstrlenW(local_res10);
      FUN_140063694(&local_4270,(int64_t)iVar11 + 0x75);
      *local_4270 = L'\0';
      if ((bVar27 & 0x10) == 0) {
      ...
      (*g_pSHSetValueW)(0xffffffff80000002,WSTR("SOFTWARE\\PELOGON\\RAMDATA\\HOTKEY"),WSTR("HOTKEY9000000"),1,
                       local_4270,iVar11 * 2);
      LVar17 = SendMessageW(hWnd,0x312,9000000,0);
      iVar11 = (int)LVar17;
      (*g_pSHDeleteValueW)(0xffffffff80000002,WSTR("SOFTWARE\\PELOGON\\RAMDATA\\HOTKEY"),WSTR("HOTKEY9000000"));
      FUN_14005B104((int64_t *)&local_4270);
    }
  ...
  (void)local_365a;
    ...
    FUN_14005B104((int64_t *)&local_4228);
    goto LAB_140040046;
  }
  uVar13 = 0x80000000;
  DVar30 = 0xfffffc18;
  ...
  if ((uint16_t)(*local_res10 + L'￐') < 10) {
    ...
    for (; (local_res10 < local_4200 &&
           ((((uint16_t)*local_res10 < 9 || (0xd < (uint16_t)*local_res10)) && (*local_res10 != L' '))))
        ; local_res10 = local_res10 + 1) {
    }
    ...
    uVar21 = FUN_140067d54((int64_t *)&local_res10,&local_41f0);
  ...
  (void)local_41c6;
    ...
    if (bVar28 == 0) {
      if (local_res18 == '\0') {
        if (uVar13 != 0) goto LAB_14003f819;
        if ((int)DVar30 < 1) goto LAB_14003f729;
LAB_14003f84e:
        DVar14 = DVar10;
        if (0 < (int)DVar30) {
          DVar14 = DVar30;
...
LAB_14003f729:
        ...
        if (0 < iVar11) {
          if (((iVar11 < 0x41) || (0x5a < iVar11)) && (9 < (uint16_t)((short)uVar21 - 0x30U))) {
...
LAB_14003f819:
      if (-1 < (int)uVar13) {
        if (bVar28 == 0) goto LAB_14003f84e;
        local_4290 = 0;
        Sleep(uVar13);
        if (*local_res10 == L'\0') {
          FUN_14005B104((int64_t *)&local_4258);
          return 0;
        }
      }
    }
...
LAB_14003f965:
      ...
      bVar5 = bVar4;
      if ((0 < iVar11) && (!bVar4)) {
        DVar10 = FUN_14001ba84((DWORD)local_4288,iVar11);
...
LAB_14003fa3d:
    ...
    if ((pvVar18 != (HANDLE)0x0) && (!bVar5)) goto LAB_14003fa47;
  }
  else {
    DVar10 = 0;
...
LAB_14003fa47:
  ...
  FUN_140063694(&local_4278,0x209);
  *local_4278 = L'\0';
...
joined_r0x00014003fb14:
  if ((WVar35 == L'\0') || (g_flagA24F < '\x01')) goto LAB_14003fd2f;
...
LAB_14003fd2f:
        ...
        if ((*ppvVar40 != (HANDLE)0x0) && ('\0' < g_flagA24F)) {
          do {
            ...
            iVar11 = 100;
            while (((('\0' < g_flagA24F &&
                     (BVar15 = PeekMessageW(&local_4188,(HWND)0x0,0,0,1), BVar15 != 0)) &&
                    (iVar11 = iVar11 + -1, iVar11 != 0)) && (local_4188.message != 0x12))) {
        ...
        if ((0 < local_4230) && ('\0' < g_flagA24F)) {
          ...
          if (0 < local_4230) {
            do {
              if ((g_flagA24F < '\x01') || ((int)local_4230 < 1)) break;
        ...
        FUN_14005B104(&local_4240);
        FUN_14005B104((int64_t *)&local_4250);
        FUN_14005B104((int64_t *)&local_4278);
