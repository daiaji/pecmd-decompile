...
uint64_t PECMD_ParseMsgDispatch(int64_t *param_1, uint16_t *param_2, WPARAM param_3, uint64_t param_4)
{
    ...
    *puVar7 = (uint16_t)uVar4;
    ...
    if (*local_res10 == 0x2c) {
        ...
        PECMD_ParseLtwhParams(plVar2, (uint32_t *)&local_88, &local_84, local_res18, local_res8);
        if (*local_res10 == 0x2c) {
            local_res10 = local_res10 + 1;
            plVar2 = FUN_14007f6e4((WCHAR **)&local_50, (WCHAR **)&local_res10, 0x2c, 1);
                                            ...
                                            if ((char)uVar10 == '\0') {
                                                ...
                                                if (cVar4 == '\0') {
                                                    if ((WCHAR)(*local_1a8 | 0x20U) == 0x68) {
                                                        ...
                                                        if (*pWVar23 == L'?') {
                                                            local_1a8 = pWVar23 + 1;
                                                            local_78 = (LPCWSTR)PECMD_ParseFirstWordToken(param_1,
                                                                        (int64_t *)&local_1a8,
                                                                        (uint64_t *)&local_f8);
                                                        ...
                                                        if ((WCHAR)(*local_1a8 | 0x20U) == 0x65) {
                                                            ...
                                                            if (*pWVar23 == L'?') {
                                                                local_1a8 = pWVar23 + 1;
                                                                local_68 = (LPCWSTR)PECMD_ParseFirstWordToken(param_1,
                                                                            (int64_t *)&local_1a8,
                                                                            (uint64_t *)&local_108);
