...
extern WCHAR    *FUN_140063694(WCHAR **ps, int64_t count);       /* @0x140063694 分配串槽 */
...
extern void      FUN_1400702b0(WCHAR **ps, const WCHAR *src);     /* @0x1400702b0 赋值串 */
extern WCHAR    *FUN_14007034c(WCHAR **ps, const WCHAR *src);     /* @0x14007034c 追加串 */
extern WCHAR    *FUN_1400703e4(int64_t *out, const WCHAR *src);   /* @0x1400703e4 拷贝串 */
extern WCHAR    *FUN_1400f429c(WCHAR **pp, uint16_t ch);          /* 定位分隔符 (thunk) */
...
extern int64_t   FUN_14005c788(const char *s, const WCHAR *w, int n); /* 前缀比较 */
extern int32_t   FUN_14005c7c4(const char *a, const WCHAR *w);        /* 后缀比较 */
extern char      FUN_1400660ac(const char *tok, WCHAR **pp, int n);   /* token 消费 */
extern int64_t   FUN_14005b1a8(uint16_t *a, WCHAR **pp, int n);       /* 前缀匹配 */
extern LPCWSTR   PECMD_StripTrailingSpaces(LPCWSTR s);                            /* 尾部剥离 */
extern WCHAR    *FUN_14001be14(WCHAR *s);                             /* 串标签/前缀查找 */

/* ---- 脚本/变量 ---- */
extern void      FUN_140003a20(void *script, WCHAR **str, int mode);  /* 变量展开 */
...
extern void      FUN_1400675b8(int64_t *src, int64_t *dst, short c);  /* 按字符切分 */
extern void      FUN_1400676e4(int64_t *, int64_t *, int);            /* 数值转串 */
extern void      PECMD_CopyUpToChar(int64_t *, int64_t *, uint32_t);       /* 字节转串 */
extern void      FUN_1400677b0(int64_t *, int64_t);                   /* 数值写 */
...
extern uint16_t *FUN_140024c48(int64_t *a, int64_t *b, uint32_t c);   /* 路径扩展 */
extern void      FUN_14001dd04(const WCHAR *, char);                  /* 清空串 */
extern void      FUN_140068034(WCHAR *, int64_t *);                   /* 变量到串 */
...
extern void      FUN_140063ff0(WPARAM, int64_t, int64_t *, int, int, int, int,
                               int64_t *, int64_t *, uint32_t);
...
extern uint32_t  FUN_140065efc(LPCWSTR p, HANDLE h);        /* 文件系统类型 */
extern WCHAR    *FUN_14005ff30(int param_1, LPWSTR param_2, int param_3); /* 卷信息串 */
...
extern void      FUN_14006ace4(int64_t *param_1, int64_t *param_2, int param_3);
...
extern void      FUN_14006849c(int64_t *stream);                   /* 关闭流 */
extern bool      FUN_14005f1b0(int64_t *stream, uint8_t *buf,
                               int64_t n, DWORD *read);            /* 流读 */
extern int64_t   FUN_14005f158(int64_t *stream, uint8_t *buf);     /* 流写 */
...
extern uint64_t  FUN_140085844(int64_t *a, int64_t *b, uint64_t *c); /* 取单词 */
...
uint64_t PECMD_MsgCommand(int64_t *param_1, WCHAR *param_2, WPARAM param_3, uint64_t param_4)
{
        ...
        do {
            ...
            if ((char)lVar3 == '\0') {
                ...
                if ((char)lVar3 == '\0') {
                    ...
                    if ((char)lVar3 == '\0') {
                        uVar4 = (uint64_t)FUN_14005c788("-vcenter:", (const WCHAR *)pWVar14,
                                                        iVar7 + -0x23);
                        if ((char)uVar4 == '\0') {
    ...
    *local_90 = WVar1;
    ...
    FUN_140063620(&local_c8);
    FUN_1400702b0((WCHAR **)&local_80, g_szEmpty);
    uVar4 = 0;
    ...
    if (*local_res10 == L'\0') {
        ...
        plVar5 = FUN_14007f6e4((WCHAR **)&local_68, (WCHAR **)&local_res10, 0x2c, 1);
        FUN_1400744d4(plVar5, (uint32_t *)&local_90, local_b8, local_res8, (uint32_t *)&local_res18);
        if (*local_res10 == L',') {
            local_res10 = local_res10 + 1;
            plVar5 = FUN_14007f6e4((WCHAR **)&local_68, (WCHAR **)&local_res10, 0x2c, 1);
            FUN_1400676e4(plVar5, (int64_t *)&local_c0, 0);
        }
        if (*local_res10 != L'\0') {
            local_res10 = local_res10 + 1;
            FUN_1400545f8(param_1, (WCHAR **)&local_res10, (WCHAR **)&local_80, L',', 0);
            if (*local_res10 != L'\0') {
                puVar6 = (uint32_t *)FUN_14007f6e4((WCHAR **)&local_68, (WCHAR **)&local_res10,
                                                   0x2c, 1);
                uVar11 = PECMD_ParseSignedNumber((short *)*puVar6);
            }
        }
        ...
        if (*local_res10 == L',') {
            local_res10 = local_res10 + 1;
            plVar5 = FUN_14007f6e4((WCHAR **)&local_68, (WCHAR **)&local_res10, 0x2c, 1);
            FUN_1400677b0(plVar5, (int64_t)local_b0);
            if (*local_res10 == L',') {
                local_res10 = local_res10 + 1;
                plVar5 = FUN_14007f6e4((WCHAR **)&local_68, (WCHAR **)&local_res10, 0x2c, 1);
                FUN_1400675b8(plVar5, (int64_t *)&local_c8, 0x2c);
            }
        }
        local_a4 = 0x80000000;
        local_a8 = 0x80000000;
        if (!bVar2) {
            FUN_14001dd04(local_c0, '\0');
            uVar8 = uVar8 | 0x1000000;
        }
        if ((*local_c0 == L'\0') && (*local_80 != L'\0')) {
            FUN_140068034((WCHAR *)local_80, (int64_t *)&local_c0);
        }
        *((WCHAR *)local_80) = L'\0';
        ...
        FUN_140063d7c(param_3, (int64_t)param_1, (WCHAR **)&local_a0, (int)(uintptr_t)local_90,
...
uint64_t PECMD_ParseMsgDispatch(int64_t *param_1, uint16_t *param_2, WPARAM param_3, uint64_t param_4)
{
    ...
    *puVar7 = (uint16_t)uVar4;
    ...
    FUN_1400702b0((WCHAR **)&local_68, g_szEmpty);
    uVar9 = 0;
    local_88 = 0;
    local_84 = 0;
    local_res18[0] = 0;
    ...
    FUN_1400675b8((int64_t *)&local_res10, &local_80, 0x2c);
    FUN_140003a20(param_1, (WCHAR **)&local_80, 1);
    if (*local_res10 == 0x2c) {
        local_res10 = local_res10 + 1;
        plVar2 = FUN_14007f6e4((WCHAR **)&local_50, (WCHAR **)&local_res10, 0x2c, 1);
        FUN_1400744d4(plVar2, (uint32_t *)&local_88, &local_84, local_res18, local_res8);
        if (*local_res10 == 0x2c) {
            local_res10 = local_res10 + 1;
            plVar2 = FUN_14007f6e4((WCHAR **)&local_50, (WCHAR **)&local_res10, 0x2c, 1);
            FUN_1400675b8(plVar2, &local_78, 0);
            if (*local_res10 == 0x2c) {
                local_res10 = local_res10 + 1;
                PECMD_CopyUpToChar((int64_t *)&local_res10, &local_68, 0x2c);
                if (*local_res10 == 0x2c) {
                    local_res10 = local_res10 + 1;
                    puVar7 = (uint16_t *)FUN_14007f6e4((WCHAR **)&local_50, (WCHAR **)&local_res10,
                                                      0x2c, 1);
                    uVar4 = PECMD_ParseSignedNumber((short *)*puVar7);
 ...
 * MSG 参数解析: 同族写控件分发, 通过 FUN_140063ff0。
 * ================================================================== */
uint64_t PECMD_MsgDispatch(int64_t *param_1, uint16_t *param_2, WPARAM param_3, uint64_t param_4)
{
    ...
    *puVar7 = (uint16_t)uVar4;
    ...
    if (*local_res10 == 0x2c) {
        ...
        FUN_140063ff0(param_3, (int64_t)param_1, &local_80, local_88, local_84, local_res18[0],
                      local_res8[0], &local_78, &local_68, uVar9);
        FUN_14005b104((void *)&local_68);
        FUN_14005b104((void *)&local_70);
        FUN_14005b104((void *)&local_78);
...
uint64_t FUN_1400858c4(int64_t *param_1, int64_t param_2)
{
    ...
    *local_138 = L'\0';
    ...
    if (local_1a8 < pWVar20) {
        pWVar13 = pWVar24;
        do {
            uVar26 = (uint32_t)pWVar13;
            if ((int)cVar21 != (uint32_t)(uint16_t)*local_1a8) break;
                                ...
                                if (cVar4 == '\0') {
                                    ...
                                    if (cVar4 == '\0') {
                                        if ((WCHAR)(*local_1a8 | 0x20U) == 0x78) {
                                            ...
                                            FUN_1400c1194((WCHAR **)&local_1a8, &local_160);
                                        }
                                        else {
                                            pWVar23 = local_1a8;
                                            uVar10 = (uint64_t)FUN_14005c788("[",
                                            ...
                                            if ((char)uVar10 == '\0') {
                                                ...
                                                if (cVar4 == '\0') {
                                                    if ((WCHAR)(*local_1a8 | 0x20U) == 0x68) {
                                                        ...
                                                        if (*pWVar23 == L'?') {
                                                            local_1a8 = pWVar23 + 1;
                                                            local_78 = (LPCWSTR)FUN_140085844(param_1,
                                                                        (int64_t *)&local_1a8,
                                                                        (uint64_t *)&local_f8);
                                                        ...
                                                        if ((WCHAR)(*local_1a8 | 0x20U) == 0x65) {
                                                            ...
                                                            if (*pWVar23 == L'?') {
                                                                local_1a8 = pWVar23 + 1;
                                                                local_68 = (LPCWSTR)FUN_140085844(param_1,
                                                                            (int64_t *)&local_1a8,
                                                                            (uint64_t *)&local_108);
...
LAB_140085e5d:
                                                ...
                                                FUN_14005b154((WCHAR **)&local_1a8);
                                                local_1a8[-1] = L'\0';
                                                FUN_14007a224(param_1, pWVar22, (WCHAR **)&local_178,
                                                              0, 1);
                                                local_1a0 = local_178;
                                                ...
                                                FUN_1400745c8((WCHAR **)&local_1a0,
                                                              (uint64_t *)&local_158);
                                                FUN_1400745c8((WCHAR **)&local_1a0, &local_110);
...
LAB_140085eeb:
        ...
        pWVar20 = local_178;
        local_1a8 = (LPCWSTR)pWVar13;
        if (lVar17 < 1) {
            FUN_140003a20(param_1, (WCHAR **)&local_178, 0);
        }
        else {
            local_178 = (WCHAR *)0x0;
            local_140 = pWVar20;
            FUN_14007a224(param_1, pWVar20, (WCHAR **)&local_178, 0, 1);
        ...
        sVar15 = 0x2c;
        local_1a8 = (LPCWSTR)pWVar20;
        local_190 = pWVar20;
        local_188 = pWVar20;
        local_180 = pWVar20;
        FUN_1400f429c(&local_180, 0x2c);
        if (*local_180 != L'\0') {
            *local_180 = L'\0';
            local_180 = local_180 + 1;
        }
        local_190 = local_180;
        FUN_1400f429c(&local_190, sVar15);
        if (*local_190 != L'\0') {
            *local_190 = L'\0';
            local_190 = local_190 + 1;
        }
        local_188 = local_190;
        FUN_1400f429c(&local_188, sVar15);
        if (*local_188 != L'\0') {
            *local_188 = L'\0';
        ...
        uVar11 = FUN_1400745c8((WCHAR **)&local_168, &local_a8);
        ...
        uVar11 = FUN_1400745c8((WCHAR **)&local_168, &local_a0);
        ...
        if (*psVar12 == 0) {
LAB_1400861bf:
            FUN_14007a224(param_1, local_180, (WCHAR **)&local_148, 0, 1);
            local_180 = local_148;
        }
        else {
            bVar28 = false;
        ...
        if (!bVar28) {
            FUN_14007a224(param_1, local_190, (WCHAR **)&local_130, 0, 1);
            local_190 = local_130;
        }
        if (!bVar29) {
            FUN_14007a224(param_1, local_188, (WCHAR **)&local_150, 0, 1);
            local_188 = local_150;
        }
        iVar7 = lstrlenW(local_180);
        FUN_140063694(&local_128, (int64_t)(iVar7 + 0x11));
        pWVar13 = local_128;
        ...
        FUN_140063694((WCHAR **)&local_120, (int64_t)(iVar7 + 0x11));
        pWVar23 = (LPCWSTR)local_120;
        FUN_14001d78c((void *)local_120, (const void *)local_190, (iVar7 + 1) * 2);
        memset((uint64_t *)(pWVar23 + (iVar7 + 1)), 0, 0x20);
        local_1a8 = (LPCWSTR)pWVar23;
        ...
        if ((0 < (int)uVar26) || ((int64_t)local_160 < 1)) {
            ...
            if (local_198 >= 1) {
                ...
                do {
                    ...
                    local_180 = pWVar16;
                    FUN_14001d78c((void *)pWVar16, (const void *)local_c8, (int)pWVar25 * 2);
                    local_190 = pWVar16 + (int)pWVar25;
                    FUN_14001d78c((void *)local_190, (const void *)local_b8, (int)pWVar27 * 2);
                    local_e0 = pWVar13;
                    FUN_14005eefc(pWVar13, local_d0);
                    pWVar3 = local_e8;
                    local_188 = pWVar19;
...
LAB_1400865ae:
                    ...
                    pWVar14 = FUN_14005182c((int64_t *)&local_a8, local_180, local_190, local_188,
                                            local_e0, param_1);
                } while (0 < local_198);
            }
...
uint64_t FUN_140086944(int64_t *param_1, WCHAR *param_2)
{
    ...
    FUN_1400702b0((WCHAR **)&local_d598, g_szEmpty);
    FUN_1400702b0((WCHAR **)&local_d590, g_szEmpty);
    local_d5a4 = '\0';
    local_res20[0] = 0;
    local_d5a2 = '\0';
            ...
            if (cVar2 == '\0') {
                ...
                if (cVar2 == '\0') {
                    ...
                    if (cVar3 == '\0') {
                        ...
                        if (cVar2 == '\0') {
                            pWVar26 = local_res10;
                            uVar23 = FUN_14005c788("-u:", (const WCHAR *)local_res10, 3);
                            if ((char)uVar23 == '\0') {
                                cVar2 = FUN_1400660ac("-bin", (WCHAR **)&local_res10, 4);
                                if (cVar2 == '\0') {
                                    pWVar26 = local_res10;
                                    uVar23 = FUN_14005c788("-src", (const WCHAR *)local_res10, 4);
                                    if ((char)uVar23 == '\0') {
...
LAB_140086cae:
    if (*local_d4c8 == L'\"') {
        ...
        FUN_1400675b8((int64_t *)&local_res10, (int64_t *)&local_d598, 0x2c);
        if (*local_res10 == L',') {
            local_res10 = local_res10 + 1;
            FUN_1400675b8((int64_t *)&local_res10, (int64_t *)&local_d590, 0x2c);
            pWVar9 = FUN_14001be14((WCHAR *)local_d590);
            lpString2 = local_d598;
        }
        else {
            local_d580 = 0;
            local_d588 = (LPCWSTR)FUN_140024c48((int64_t *)&local_d4c8, &local_d580, 1);
            PECMD_StrCopyW((WCHAR **)&local_d598, local_d4c8, local_d580);
            FUN_140024c48((int64_t *)&local_d588, &local_d580, 0);
        ...
        if (cVar28 == '\x10') {
            ...
            if (local_d4f8[0] != (HANDLE)0x0) {
                ...
                do {
                    ...
                    FUN_14005f1b0((int64_t *)local_d4f8, local_res20, 1, &local_d5a8);
                    lVar21 = lVar21 + -1;
                } while (lVar21 != 0);
                do {
                    local_d4cc = local_d4cc + 1;
                    local_res20[0] = 0;
                    local_d5a8 = 0;
                    bVar24 = FUN_14005f1b0((int64_t *)local_d4f8, local_res20, 1, &local_d5a8);
                ...
                if ((local_d5a0 == 0) &&
                    ...
                    do {
                        local_d4cc = local_d4cc + 1;
                        pbVar20 = local_res20;
                        FUN_14005f1b0((int64_t *)local_d4f8, pbVar20, 1, &local_d5a8);
                        lVar27 = lVar27 + -1;
                    } while (lVar27 != 0);
                    FUN_14005c260((int64_t)local_d488, (uint64_t)pbVar20);
                    FlushFileBuffers(local_d4b8[0]);
                    local_d4c0 = (int64_t *)&PTR_FUN_140126560;
                    FUN_14006849c((int64_t *)local_d4b8);
                    local_d500 = (int64_t *)&PTR_FUN_140126560;
                    ppvVar14 = local_d4f8;
                    goto LAB_140087639;
                }
...
LAB_1400871d8:
            ...
            do {
                ...
                FUN_14005f158((int64_t *)local_d530, local_res20);
                pbVar20 = pbVar20 + 1;
                lVar27 = lVar27 + -1;
            } while (lVar27 != 0);
            local_d504 = local_d504 + 1;
            ...
            local_c48e[3] = 0;
            {
                ...
                do {
                    local_res20[0] = 0;
                    local_d5a8 = 0;
                    bVar24 = FUN_14005f1b0((int64_t *)&local_d568, local_res20, 1, &local_d5a8);
                    GetLastError();
                    if ((!bVar24) || (local_d5a8 == 0)) {
                        uVar16 = 0xffffffff;
                    }
            ...
            do {
                ...
                local_d504 = local_d504 + 1;
                pbVar18 = local_res20;
                FUN_14005f158((int64_t *)local_d530, pbVar18);
                pbVar20 = pbVar20 + 1;
                lVar11 = lVar11 + -1;
            } while (lVar11 != 0);
            local_d504 = 0x10;
            ...
            local_d538 = (int64_t *)&PTR_FUN_140126540;
            FUN_14006849c((int64_t *)local_d530);
            local_d570 = (int64_t *)&PTR_FUN_140126540;
            ppvVar14 = &local_d568;
LAB_140087639:
...
LPCWSTR PECMD_GetDiskFreeSpace(int64_t *param_1, WCHAR *param_2)
{
    ...
    FUN_14005b154((WCHAR **)&local_res10);
    FUN_140063694((WCHAR **)&local_128, 5);
    FUN_140063694((WCHAR **)&local_130, 0x14);
    ...
    FUN_1400675b8((int64_t *)&local_res10, (int64_t *)&local_130, 0x3d);
    FUN_140003a20(param_1, (WCHAR **)&local_130, 0);
    if (*local_res10 == L'=') {
        local_res10 = local_res10 + 1;
        FUN_1400675b8((int64_t *)&local_res10, (int64_t *)&local_128, 0x2c);
    }
    local_res10 = local_128;
    local_128 = (LPCWSTR)0x0;
    pWVar8 = FUN_14001be14((WCHAR *)local_res10);
    FUN_14007034c((WCHAR **)&local_128, pWVar8);
    FUN_14005b104((void *)&local_res10);
    for (pWVar8 = local_130; *pWVar8 != L'\0'; pWVar8 = pWVar8 + 1) {
        if (*pWVar8 == L',') {
            *pWVar8 = L'\0';
            local_res10 = pWVar8 + 1;
            FUN_1400675b8((int64_t *)&local_res10, (int64_t *)&local_120, 0x2c);
            break;
        }
    }
    FUN_140003a20(param_1, (WCHAR **)&local_120, 0);
    PECMD_StripTrailingSpaces(local_130);
    if (((*local_130 == L'\0') && (*local_120 == L'\0')) || (*local_128 == L'\0')) goto LAB_140094bba;
    pWVar8 = local_128;
    uVar9 = (uint64_t)FUN_14005c7c4("*", (const WCHAR *)local_128);
    pWVar12 = pWVar10;
    if ((char)uVar9 != '\0') {
        PECMD_AllocString((WCHAR **)&local_120, 0xca);
        *local_120 = L'\0';
        PECMD_ListDrives((int64_t *)&local_128, L'|', 1, 0, 0, (LPCWSTR)0x0);
        FUN_1400629b8(param_1, local_130, local_128);
        goto LAB_140094bba;
    }
    ...
    if (cVar11 < '\0') {
        ...
        FUN_1400702b0((WCHAR **)&local_118, WSTR("\\\\.\\C:***"));
        local_118[4] = *pWVar8;
        local_118[7] = L'\0';
        iVar5 = -1;
        UVar7 = 0xffffffff;
        local_118[6] = L'\0';
        iVar13 = 0x800;
        uVar9 = FUN_14005c788("\\\\.\\", (const WCHAR *)pWVar8, 4);
        pWVar14 = pWVar8;
        if (((char)uVar9 == '\0') &&
            (uVar9 = FUN_14005c788("\\Device\\", (const WCHAR *)pWVar8, 8), (char)uVar9 == '\0')) {
            pWVar8[1] = L':';
            pWVar8[2] = L'\\';
            pWVar8[3] = L'\0';
            if (bVar2) {
            ...
            if ((*local_120 != L'\0') || ((!bVar3 && (((UVar7 == 2 || (UVar7 == 3)) ||
                                                       (UVar7 == 5)))))) {
                iVar5 = FUN_140065efc(local_118, (HANDLE)0x0);
            }
            iVar13 = -1;
            if (!bVar3) {
                iVar13 = iVar5;
            }
            pWVar10 = FUN_14005ff30(UVar7, local_f8, iVar13);
        }
        else {
LAB_1400949c9:
            ...
            if (*local_120 != L'\0') {
                ...
                FUN_140065efc((LPCWSTR)0x0, (HANDLE)pWVar10);
            }
        ...
        if (*local_130 != L'\0') {
            FUN_1400629b8(param_1, local_130, pWVar10);
        }
        if (*local_120 != L'\0') {
            wsprintfW(local_f8, WSTR("%d"));
            FUN_1400629b8(param_1, local_120, local_f8);
        }
        if (*pWVar10 == L'\0') {
...
LAB_140094864:
    ...
    if (BVar6 != 0) {
        FUN_1400e6d74((LPCWSTR)&local_b8, local_110[cVar11].QuadPart);
    }
    FUN_1400629b8(param_1, local_130, (LPCWSTR)&local_b8);
...
uint64_t PECMD_NormalizePath(int64_t *param_1, LPCWSTR param_2)
{
    ...
    FUN_14005b154((WCHAR **)local_res10);
    FUN_140063694((WCHAR **)&local_50, 5);
    FUN_140063694((WCHAR **)local_48, 0x14);
    cVar14 = '\x01';
    bVar3 = false;
    bVar2 = false;
    bVar6 = false;
                ...
                if (cVar8 == '\0') {
                    ...
                    if (cVar8 == '\0') {
                        ...
                        if (cVar8 == '\0') {
                            cVar8 = FUN_1400660ac("--long+", (WCHAR **)local_res10, -1);
                            if (cVar8 == '\0') {
                                uVar11 = FUN_14005b1a8((uint16_t *)WSTR("--volume"),
                                                       (WCHAR **)local_res10, 8);
                                if ((int)uVar11 == 0) {
                                    uVar11 = FUN_14005b1a8((uint16_t *)WSTR("--volumepart"),
                                                           (WCHAR **)local_res10, 0xc);
                                    if ((int)uVar11 == 0) {
                                        uVar11 = FUN_14005b1a8((uint16_t *)WSTR("--part"),
                                                               (WCHAR **)local_res10, 6);
                                        if ((int)uVar11 == 0) {
                                            uVar11 = FUN_14005b1a8(g_u16127d30,
                                                                   (WCHAR **)local_res10, 3);
                                            if ((int)uVar11 == 0) {
    ...
    FUN_1400702b0((WCHAR **)&local_58, pWVar12);
    PECMD_AllocString((WCHAR **)&local_58, (int64_t)(iVar9 * 8 + 0x105));
    lpszLongPath = local_58;
    local_res20 = (LPWSTR)0x0;
    FUN_14006459c(pWVar12, iVar9 * 8 + 0x104, local_58, &local_res20);
    if (local_res20 != (LPWSTR)0x0) {
        local_res20 = local_res20 + -1;
    }
    if (bVar6) {
        FUN_140063694((WCHAR **)&local_60, 0x2000);
        pWVar12 = local_60;
        *local_60 = L'\0';
...
LAB_140094f98:
    ...
    FUN_140063694((WCHAR **)&local_60, 0x1000);
    lpString = local_60;
    *local_60 = L'\0';
...
LAB_1400950ce:
    ...
    if ((bVar5) && (*pWVar12 != L'\"')) {
        FUN_14006ace4((int64_t *)local_res10, (int64_t *)&local_60, -1);
    }
    FUN_1400629b8(param_1, local_50, local_res10[0]);
    FUN_14005b104((void *)&local_60);
