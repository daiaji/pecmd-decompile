...
uint64_t PECMD_QueryDevice(HANDLE param_1, uint64_t param_2, uint16_t *param_3, int64_t param_4)
{
    ...
    *param_3 = 0x22;
    ...
    if (*(uint32_t *)(buf + 0x410) != 0) {
        PECMD_AsciiTrimToWide((void **)&run,
                      (char *)(lpOutBuffer + *(uint32_t *)(buf + 0x410)),
    ...
    *run = 0x22;
    ...
    if (param_4 == 0) {
        if (iVar9 == 0x11) goto L140077696;
        if (iVar9 == 7) goto L1400777ea;
        cVar14 = local_res20;
        if (iVar9 == 5) goto L1400777ea;
L1400779bd:
        do {
            bVar6 = 1;
...
L140077696:
            do {
                ...
                *(uint32_t *)(buf + 0x1c) = 0x1000;
                uVar8 = DeviceIoControl(param_1, 0x2d1400, buf, 0x1030, buf, 0x1030,
                                        &local_54[0], 0);
                uVar13 = uVar8;
                psVar2 = (int16_t *)(buf + 8 + (uint32_t)*(uint64_t *)(buf + 0x18));
                if (((uVar8 < 1) || (*(int32_t *)(buf + 0) != 0x30)) ||
                    (*(int32_t *)(buf + 4) != 0x30 ||
                     ((uint32_t)*(uint64_t *)(buf + 0x18) < 0x28 ||
                      (*(uint32_t *)(buf + 0x1c) < 0x1000))) ||
                    (*psVar2 == 0) ||
                    ((bVar5 = 1), *(int32_t *)(psVar2 + 0x102) == 0)) {
                    bVar5 = 0;
                }
                if (g_u8CCB1 != 0) {
                    GetLastError();
...
L1400777ea:
                    ...
                    *(uint8_t *)(buf + 0x28) = 200;
                    uVar8 = DeviceIoControl(param_1, 0x4d014, buf, 0x38, buf, 0x100,
                                            &local_54[0], 0);
                    bVar3 = *(uint8_t *)(buf + 2);
                    ...
                    *(uint8_t *)(buf + 0x28) = 200;
                    uVar10 = DeviceIoControl(param_1, 0x4d014, buf, 0x38, buf, 0x100,
                                             &local_54[1], 0);
                    uVar13 = uVar10;
                    if (uVar8 == 0) {
                        *(uint8_t *)(buf + 0x410) = 0;
 ...
 * ==================================================================== */
uint64_t *PECMD_ShowShutdownUI(int param_1, LPCWSTR param_2, LPCWSTR param_3,
                        uint32_t param_4, int param_5, uint8_t param_6)
{
    int64_t lVar1;
    int iVar2;
    int iVar3;
    ...
    if (local_50 == (HANDLE)0) {
        ...
        *(uint32_t *)((char *)lpParameter + 0x34) = 1;
        ...
        do {
            iVar2 = iVar2 - 1;
            if ((iVar2 < 0) ||
                (hWnd = FindWindowW(pwVar8, lpWindowName_00), hWnd != (HWND)0) ||
                (lpWindowName != (LPCWSTR)0 &&
...
L14007c326:
        ...
        if (hWnd == (HWND)0) {
            while (1) {
                ...
                lpParameter = local_48;
                if (hWnd != (HWND)0) break;
                if ((lpWindowName != (LPCWSTR)0 &&
                     (hWnd = FindWindowW(pwVar8, lpWindowName), lpParameter = local_48,
                      hWnd != (HWND)0)) ||
...
L14007d57c:
            lpFileName = param_2;
            if (lpStart != (wchar_t *)0) goto L14007d581;
        }
    } else {
...
L14007d646:
    ...
    uVar5 = (uint32_t)(((iVar2 + ((iVar2 >> 31) & 0x1fU)) >> 5) * (int)bm.bmHeight * 4 + (int)pHVar7);
