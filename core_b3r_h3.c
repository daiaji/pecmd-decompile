              ...
              if ((char)lVar9 == '\0') {
                ...
                if ((char)lVar9 == '\0') {
                  ...
                  if ((*(uint16_t *)(uintptr_t)pp == 0x2d) &&
                    ...
                    local_res10 = _Var24;
                    LVar10.QuadPart = PECMD_WideStrToInt64((const WCHAR *)(uintptr_t)_Var24);
                    pp = _Var24;
                  }
                }
                else {
          ...
          if (-1 < LVar23.QuadPart) {
            if ((uint32_t)local_c8 != 0) {
              ...
              if ((int64_t)uVar22 < 0x1000001) {
                ...
                uVar7 = PECMD_MultiByteConvert((LPCWSTR)(uintptr_t)local_80, uVar22);
                DVar31 = (DWORD)uVar7;
              }
            }
            cVar4 = (char)(uint8_t)local_res20;
...
LAB_14009efbe:
          ...
          while (1) {
            ...
            *(WCHAR *)(uintptr_t)local_e0 = L'\0';
            if (iVar13 == 0) break;
            PECMD_AppendWideStr((WCHAR **)&local_d8.QuadPart, (LPCWSTR)(uintptr_t)local_a0);
            _Var27 = local_88;
          }
                            ...
                            if ((char)lVar17 == '\0') {
                                ...
                                if ((char)lVar17 == '\0') {
                                    if (((int16_t)*(const int16_t *)(uintptr_t)param_2.QuadPart == 0x2d) &&
                                        ...
                                        lVar17 = PECMD_WideStrToInt64((const WCHAR *)(uintptr_t)param_2.QuadPart);
            ...
            if (cVar7 == '\0') {
                ...
                if (cVar7 == '\0') {
                    ...
                    if (cVar7 == '\0') {
                        ...
                        if (cVar7 == '\0') {
                            cVar7 = PECMD_MatchTokenAdvance("*sparse", (WCHAR **)&local_res10.QuadPart, 7);
                            if (cVar7 == '\0') {
                                cVar7 = PECMD_MatchTokenAdvance("*nobom", (WCHAR **)&local_res10.QuadPart, 6);
                                if (cVar7 == '\0') {
