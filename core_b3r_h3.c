 ...
 *   - thunk_FUN_1400f429c 是 FUN_1400f429c 的 thunk, 统一调用 FUN_1400f429c。
...
extern int32_t FUN_14005c7c4(const char *a, const WCHAR *w);          /* 后缀/封装比较 */
extern uint64_t FUN_14005c788(const char *a, const uint16_t *w, int n); /* 固定长度比较 */
...
extern void    FUN_1400702b0(WCHAR **ps, const WCHAR *src);          /* 串赋值 */
...
extern void    FUN_1400678f0(void *pp, void *out, int16_t sep);       /* 数值解析 */
...
extern WCHAR  *FUN_1400637dc(WCHAR **ps, LPCWSTR src, int64_t a, int64_t b);
extern int64_t PECMD_VarLookup(void *script, LPCWSTR name, void *scope,
                             int64_t len, uint64_t *extra);
extern void    FUN_140063694(WCHAR **ps, int64_t count);              /* 分配 */
...
extern char    PECMD_ReadFileLine(void *a, int64_t *b, DWORD c, uint8_t d,
                             uint32_t *e);                            /* 读一行字符 */
extern LPCWSTR FUN_14006ca94(void *a, DWORD b);                      /* 取串槽内容 */
...
extern int64_t FUN_1400177d0(void *a);                               /* UTF8 长度 */
extern uint32_t FUN_140006a4c(LPCWSTR param_1);                      /* 路径/句柄检查 */
extern int64_t FUN_14001d810(uint64_t param_1, uint64_t param_2, uint64_t param_3);
...
extern uint32_t FUN_1400e693c(HANDLE hFile);                         /* GetFileSize */
...
extern int64_t FUN_14001e69c(int64_t *param_1, LPCWSTR param_2, int64_t *param_3,
                             int param_4);                            /* 变量插值 */
extern void    FUN_14006f884(LPCWSTR a, void *b);                     /* 输出/插值 */
extern int64_t *FUN_14007034c(int64_t *param_1, LPCWSTR param_2);
extern void    FUN_14007bf44(int64_t *param_1, LPCWSTR param_2, int64_t *param_3,
                             int param_4, int param_5);
extern void    FUN_14006cc70(int64_t *list, int64_t pos);             /* 记录命中位置 */
extern void    FUN_1400669c4(int64_t *a, uint64_t b, LPCWSTR c);     /* SetVarD */
extern void    FUN_140079c80(int64_t *ctx, int64_t *pp, int64_t *out);
...
extern int64_t FUN_140060a94(int64_t a);                              /* __chkstk/刷新 */
...
extern uint64_t FUN_14006cba8(const WCHAR *p);                        /* 数解析 */
                       ...
                       LPCWSTR param_4, LPCWSTR param_5, void **param_6)
{
    ...
    local_res18 = param_3;
    if (FUN_14005b2c0(param_1, param_4, pHVar1) != 0) {
        lpCriticalSection = (LPCRITICAL_SECTION)*param_6;
        if (lpCriticalSection != NULL) {
            *param_6 = 0;
            LeaveCriticalSection(lpCriticalSection);
        }
        uVar4 = FUN_140057b80((void *)(uintptr_t)param_1[7], param_4, (WPARAM)param_5, hWnd,
        ...
        if ((int)uVar4 == 0) {
            if ((param_4 != NULL) && (iVar3 = lstrcmpiW(param_4, WSTR("Check")), iVar3 == 0)) {
                ...
                FUN_14007d0ac((int64_t *)param_1[10], param_5, param_3);
                return 0;
            }
            if (*param_4 == L'\0') {
...
uint64_t PECMD_WriteVarEncoded(int64_t *param_1, LPCWSTR param_2)
{
    ...
    FUN_1400702b0((WCHAR **)&local_res20, g_szEmpty);
    FUN_14005b154((WCHAR **)&local_res10);
...
LAB_0a058a:
        ...
        if (cVar3 == '\0') {
            FUN_140079c80(param_1, (int64_t *)&local_res10, (int64_t *)&local_a8);
...
LAB_0a050d:
    ...
    FUN_1400629b8(param_1, local_res20, local_98);
...
uint64_t PECMD_WriteVarTruncated(int64_t *param_1, LPCWSTR param_2)
{
    ...
    FUN_14005b154((WCHAR **)local_res10);
    FUN_1400702b0((WCHAR **)&local_38, g_szEmpty);
    FUN_14005b154((WCHAR **)local_res10);
    cVar1 = FUN_1400660ac("*", (WCHAR **)local_res10, 1);
    uVar6 = 0;
    ...
    if (*local_38 != L'\0') {
        if (*local_res10[0] == L'=') {
            ...
            FUN_1400f429c((WCHAR **)local_res10, 0x2c);
            if (*local_res10[0] == WVar5) {
                ((LPWSTR)local_res10[0])[0] = L'\0';
                local_res10[0] = local_res10[0] + 1;
                local_28 = (LPCWSTR)0;
                if (cVar1 != '\0') {
                    FUN_140079c80(param_1, (int64_t *)local_res10, (int64_t *)&local_28);
                ...
                if (*local_20 != L'(') {
                    ...
                    uVar3 = FUN_14006cba8(pWVar4);
                    if (((int)uVar3 == 0) &&
                        (uVar3 = FUN_14006cba8(local_res10[0]), pWVar4 = local_res10[0],
                         (int)uVar3 != 0)) {
                ...
                FUN_1400629b8(param_1, local_38, local_res10[0]);
...
LPCWSTR *FUN_1400a0d38(int64_t *param_1, WCHAR *param_2, uint64_t param_3, uint8_t param_4)
{
    ...
    local_a8 = g_szEmpty;
    FUN_1400702b0((WCHAR **)&local_b0, g_szEmpty);
    ppWVar20 = ppWVar14;
    if (*local_res10 == L'-') {
        do {
            ...
            if (cVar5 == '\0') {
                ...
                if (cVar5 == '\0') {
                    pWVar17 = local_res10;
                    uVar12 = FUN_14005c788("-delims:", (uint16_t *)local_res10, 8);
                    if ((char)uVar12 != '\0') {
...
LAB_0a0f9b:
    ...
    local_a0 = local_b0;
    local_78 = local_b0;
    FUN_1400f429c((WCHAR **)&local_78, 0x2c);
    if (*local_78 != L'\0') {
        *((LPWSTR)local_78) = L'\0';
        pWVar16 = local_78 + 1;
        local_a8 = pWVar16;
    ...
    *local_res10 = L'\0';
    ...
    if (cVar4 != '\0') {
        local_f0 = local_c0;
        local_c0 = (LPCWSTR)0;
        FUN_140079c80(param_1, (int64_t *)&local_e8, (int64_t *)&local_c0);
        local_e8 = local_c0;
...
LAB_0a13ff:
                        ...
                        if ((WVar1 == WVar18) ||
                            ...
                            if (local_80 != 0) {
                                iVar7 = (int)FUN_140060b5c((uint64_t *)pWVar16,
                                                          ...
                                                          iVar7);
                                FUN_14006cc70((int64_t *)&local_70, (int64_t)iVar7);
                            }
                            pWVar13 = local_f0;
                            pWVar19 = local_f0;
                            uVar6 = local_d0;
                    ...
                    while (pWVar19 = local_f0, WVar1 != L'\0') {
                        ...
                        if (((*local_res10 == WVar18) ||
                            ...
                            if (local_80 != 0) {
                                ...
                                FUN_14006cc70((int64_t *)&local_70, (int64_t)iVar9);
                            }
                            pWVar13 = local_f0;
                            pWVar19 = local_f0;
                            if (bVar2) {
                            ...
                            if (iVar15 == 0) {
                                ...
                                if (local_80 != 0) {
                                    iVar15 = (int)FUN_140060b5c((uint64_t *)pWVar16,
                                                               (int)ppWVar21,
                                                               (void *)(intptr_t)local_e0, iVar9);
                                    FUN_14006cc70((int64_t *)&local_70, (int64_t)iVar15);
                                }
                                if (bVar2) {
                                    break;
                                }
                        ...
                        if ((iVar10 == 0) && (iVar15 = iVar15 + -1, iVar15 < 1)) {
                            ...
                            if (local_80 != 0) {
                                iVar10 = (int)FUN_140060b5c((uint64_t *)pWVar16, (int)ppWVar21,
                                                            (void *)(intptr_t)local_e0, iVar9);
                                FUN_14006cc70((int64_t *)&local_70, (int64_t)iVar10);
                            }
                            if (bVar2) {
                                break;
                            }
    ...
    if (*local_70 == L'\0') {
        ...
        FUN_1400629b8(param_1, local_a8, local_70);
    }
    if (*local_58 == L'\0') {
        ...
        FUN_1400629b8(param_1, local_a0, local_58);
    }
...
LARGE_INTEGER FUN_14009da54(int64_t *param_1, FILETIME param_2)
{
  ...
  FUN_1400702b0((WCHAR **)&local_90, g_szEmpty);
  FUN_1400702b0((WCHAR **)&local_b8, WSTR("READLINE"));
  local_e0 = 1;
  local_88 = 1;
  local_98.QuadPart = 1;
  local_d8.QuadPart = 1;
  ...
  uVar7 = FUN_14005c7c4("-*?", (const WCHAR *)local_90);
  if ((char)uVar7 != '\0') {
    bVar16 = 9;
    local_d0 = 1;
    local_res20 = (local_res20 & 0xffffffffffffff00ULL) | (uint8_t)9;
  }
  uVar7 = FUN_14005c7c4("-*", (const WCHAR *)pWVar17);
  if ((char)uVar7 == '\0') {
    if ((*pWVar17 == L'\0') ||
        (uVar7 = FUN_14005c7c4("-", (const WCHAR *)pWVar17),
         (char)uVar7 != '\0'))
...
LAB_14009dd92:
  ...
  uVar7 = 0;
  FUN_14007a224(param_1, (WCHAR *)(uintptr_t)local_res10, (WCHAR **)&local_60, 0, 1);
  ...
  if (*(WCHAR *)(uintptr_t)local_60 == L',') {
    ...
    if ((char)uVar8 == '\0') {
      uVar8 = FUN_14005c7c4("**1", (const WCHAR *)(uintptr_t)LVar10.QuadPart);
      if ((char)uVar8 == '\0') {
        uVar8 = FUN_14005c7c4("**", (const WCHAR *)(uintptr_t)LVar10.QuadPart);
        if ((char)uVar8 == '\0') {
          uVar8 = FUN_14005c7c4("*", (const WCHAR *)(uintptr_t)LVar10.QuadPart);
          if ((char)uVar8 == '\0') {
  ...
  FUN_140003a20(param_1, (void *)&local_b8, 0);
  ...
  if (-1 < (int)DVar31) {
    ...
    if (((*local_90 == L'u') && (local_90[1] == L'd')) &&
      ...
      *(WCHAR *)(uintptr_t)local_res10 = L'\0';
      ...
      local_res20 = _Var24;
      FUN_1400f429c((WCHAR **)&local_res20, 0x3a);
      ...
      if (DVar31 == 0x4b1) {
        ...
        FUN_1400637dc((WCHAR **)&local_80, (LPCWSTR)pCVar21, (int64_t)iVar13,
                      (int64_t)(int)DVar31);
...
LAB_14009e301:
      ...
      if (local_d0 != 0) {
        ...
        if ((sVar3 != 0) &&
          ...
          if (((int)uVar33 < 1) && (DVar31 != 0x4b0)) {
            FUN_1400637dc((WCHAR **)&local_e0, pWVar17, uVar22, (int64_t)(int)DVar31);
          }
          else {
      ...
      if (local_e8 == '\x03') {
LAB_14009e4a3:
        FUN_1400629b8(param_1, local_b8, (LPCWSTR)(uintptr_t)_Var24);
      }
      else {
        if (local_e8 == '\0') {
          if ((int64_t)_Var27 < 0) {
            ...
            FUN_140063694((WCHAR **)&local_res20, 0x20);
...
LAB_14009e52d:
        ...
        FUN_1400629b8(param_1, local_b8, (LPCWSTR)(uintptr_t)local_res20);
      ...
      *(int16_t *)(uintptr_t)LVar10.QuadPart = 0;
      ...
      if (cVar4 != '\x02') {
        ...
        if (iVar13 == 0) {
          ...
          local_b0.QuadPart = FUN_14001d810((uint64_t)(uintptr_t)local_90, 0x80000000, 7);
        }
        hObject = local_b0;
...
LAB_14009e945:
          ...
          if (-1 < LVar23.QuadPart) {
            if ((uint32_t)local_c8 != 0) {
              DVar32 = FUN_1400e693c((HANDLE)*(int64_t *)(uintptr_t)_Var27);
              uVar22 = DVar32;
...
LAB_14009ea18:
      ...
      if (local_58 == (HANDLE)0) {
        ...
        if (local_e8 == '\x03') {
          ...
          pWVar17 = FUN_14006ca94((void *)&local_c8, DVar31);
          FUN_1400629b8(param_1, local_b8, pWVar17);
            ...
            if (local_98.QuadPart != 1) {
              ...
              while (1) {
                ...
                *(WCHAR *)(uintptr_t)local_e0 = L'\0';
                ...
                if (bVar5 == 0) break;
                pWVar17 = FUN_14006ca94((void *)&local_e0, DVar31);
                local_c8 = local_c8 & 0xffffffff00000000ULL;
...
LAB_14009efc9:
        ...
        LVar10.QuadPart = (int64_t)(uintptr_t)FUN_14006ca94((void *)&local_d8.QuadPart, DVar31);
      }
      if ((hObject.QuadPart != 0) && (hObject.QuadPart != -1)) {
        CloseHandle((HANDLE)hObject.QuadPart);
      }
...
LAB_14009f00c:
  FUN_1400629b8(param_1, local_b8, (LPCWSTR)(uintptr_t)LVar10.QuadPart);
...
LAB_14009f25f:
    ...
    FUN_1400702b0((WCHAR **)&local_90, (LPCWSTR)(uintptr_t)g_szEmpty);
...
LAB_14009f52b:
    ...
    if ((uint16_t)((uint16_t)*(const uint16_t *)(uintptr_t)local_res10.QuadPart - 0x30) < 10) {
        FUN_1400678f0((void **)&local_res10, (void *)&local_a8.QuadPart, (short)uVar27);
...
LAB_14009f5ef:
        ...
        if (bVar1) {
            if ((*pWVar20 == L'&') || ((*(uint8_t *)((int64_t)local_res8 + 0xd) & 0xf) != 0)) {
                EnterCriticalSection((LPCRITICAL_SECTION)&g_csInit);
                puVar18 = (uint64_t *)FUN_14001e69c(plVar14, pWVar20, (int64_t *)0, -1);
            ...
            FUN_14007034c(&local_b8.QuadPart, pWVar20);
        } else {
        ...
        bWriteMode = 0;
        local_c0.QuadPart = 0;
        uVar16 = (uint64_t)(int64_t)FUN_14005c7c4("--", pWVar15);
        if ((char)uVar16 == '\0') {
            uVar16 = (uint64_t)(int64_t)FUN_14005c7c4("-", pWVar15);
...
LAB_14009fa02:
            ...
            if (uVar11 != 0x4b0) {
                if (uVar11 == 0x4b1) {
                    ...
                    lVar17 = FUN_1400177d0((void *)&local_b8.QuadPart);
                } else {
                    local_80 = local_b8;
                    local_b8.QuadPart = 0;
                    FUN_14006355c(&local_b8.QuadPart, (LPCWSTR)(uintptr_t)LVar6.QuadPart, -1,
            ...
            if (bWriteMode == 0) {
                ...
                if (bVar3) {
                    ...
                    if ((*local_78 == L'&') || ((*(uint8_t *)((int64_t)local_res8 + 0xd) & 0xf) != 0)) {
                        EnterCriticalSection((LPCRITICAL_SECTION)&g_csInit);
                        puVar18 = (uint64_t *)FUN_14001e69c(local_res8, pWVar20, (int64_t *)0, -1);
                        if (puVar18 != (uint64_t *)0) {
...
LAB_14009fe41:
                    ...
                    FUN_1400629b8(local_res8, local_78, (LPCWSTR)*(WCHAR **)(void *)&local_res20);
                    FUN_14005b104((void *)&local_res20);
                } else {
                    if (LVar25.QuadPart == 0) {
                        if (local_c8 == '+') {
...
LAB_1400a0253:
                            ...
                            LVar31 = PECMD_SetFilePointer((HANDLE)LVar21.QuadPart, (LARGE_INTEGER){ .QuadPart = 0 }, 1);
                            DVar12 = FUN_1400e693c((HANDLE)LVar21.QuadPart);
...
LAB_1400a0366:
                        ...
                        if (LVar25.QuadPart != 0) {
                            ...
                            PECMD_ReadFileLine((void *)&local_c0, (int64_t *)local_a0, uVar11, bVar33, (uint32_t *)0);
                            LVar25 = PECMD_SetFilePointer((HANDLE)LVar21.QuadPart, (LARGE_INTEGER){ .QuadPart = 0 }, 1);
                            DVar13 = FUN_1400e693c((HANDLE)LVar21.QuadPart);
            ...
            uVar16 = (uint64_t)(int64_t)FUN_14005c7c4("CONOUT$", local_78);
            if ((char)uVar16 == '\0') {
                if (bVar8) {
                    FUN_14006caf0(pWVar20);
                }
            } else {
                FUN_140060a94(0x100);
                cVar7 = '\0';
            ...
            if ((((iVar10 == 0) ||
                  (local_c0.QuadPart = FUN_14001d810((uint64_t)(uintptr_t)pWVar20, 0xffffffffc0000000, 7),
                   local_c0.QuadPart == 0)) &&
