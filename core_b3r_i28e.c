...
extern uint     FUN_14007e15c(uint8_t *, uint64_t, LPCWSTR, HICON, LPCWSTR,
...
uint64_t PECMD_ParseWindowPosition(int64_t *param_1, WCHAR *param_2, WPARAM param_3)
{
    ...
    *puVar2 = uVar1;   /* 恢复被截断的逗号/分隔字符 (uVar1) */
    ...
    FUN_1400702b0(&local_40, g_szEmpty);
    ...
    uVar8 = 0;
    {
        ...
        FUN_1400675b8((void *)&local_res10, &local_78, 0x2c);
        ...
        if (*local_res10 == 0x2c) {
            ...
            if (*local_res10 == 0x2c) {
                local_res10 = local_res10 + 1;
                FUN_1400676e4((void *)&local_res10, &local_68, 0x2c);
                if (*local_res10 == 0x2c) {
                    local_res10 = local_res10 + 1;
                    ...
                    if (*local_res10 == 0x2c) {
                        ...
                        if (*local_res10 == 0x2c) {
                            local_res10 = local_res10 + 1;
                            FUN_1400675b8((void *)&local_res10, &local_70, 0x2c);
                        }
                    }
                }
            }
...
HICON FUN_1400ba35c(int64_t *param_1, LPCWSTR param_2, int64_t param_3)
{
    ...
    FUN_1400702b0(&local_98, g_szEmpty);
    WVar15 = *param_2;
    local_50 = 10000;
    local_4c[0] = 10000;
    local_70 = 0;
    ...
    if (local_res20 == '\0') {
        ...
        if (iVar4 == 0) {
            ...
            if (iVar4 == 0) {
                ...
                if (*lpStr2 != L'\0') {
                    FUN_1400675b8((void *)&local_res10, &local_a0, 0x2c);
                    ...
                    if (*local_res10 == L',') {
                        ...
                        if (bVar22) {
                            ...
                            FUN_1400676e4((void *)&local_res10, &local_a8, 0x2c);
                            pWVar6 = local_res10;
                        }
...
icon_parse_ba800:
    ...
    if ((*(char *)((char *)param_1 + 0xda) == '\0') &&
        ...
        FUN_14007bda8(param_1, pWVar6, &local_68, 0, 1);
    } else {
        FUN_14007a224(param_1, pWVar6, &local_68, 0, 1);
    }
    if (local_res20 != '\0') {
    ...
    if ((*local_68 == L',') || (*local_68 == L'#')) {
        ...
        FUN_1400679b0(&local_res10, (int *)local_4c, 0x2c);
        local_50 = local_4c[0];
    ...
    local_res10 = local_68 + 1;
    FUN_1400679b0(&local_res10, &local_84, 0x2c);
    if (*local_res10 != L',') {
        goto icon_cleanup_ba6aa;
    }
    ...
    if (*pWVar6 != L'@') {
        ...
        if (cVar21 != '\0') {
            ...
            uVar19 = FUN_14007e15c((uint8_t *)((char *)(uintptr_t)param_3 + 0x690),
                   ...
                   LPCWSTR param_12, HWND param_13, int *param_14)
{
    ...
    if (puVar2 != (uint64_t *)0) {
        ...
        FUN_14005daf8((int64_t)param_1, local_res20, &param_5, &param_6, &param_7);
                                                ...
                                                if ((char)lVar4 != '\0') {
                                                    ...
                                                    if ((char)lVar4 != '\0') {
                                                        ...
                                                        if ((char)lVar4 != '\0') {
                                                            ...
                                                            uVar5 = FUN_14005c788("-b:", puVar15, 3);
                                                            pHVar6 = pHVar19;
                                                            if ((char)uVar5 == '\0') {
                                                                uVar5 = FUN_14005c788("-font:", puVar15, 6);
                                                                if ((char)uVar5 == '\0') {
                                                                    uVar5 = FUN_14005c788("-color:", puVar15, 7);
                                                                    if ((char)uVar5 == '\0') {
                                                                        goto bd_option_done;
                                                                    }
                                                                    /* -color: */
...
bd_option_done:
    ...
    local_60 = param_1;
    FUN_1400702b0(&local_90, g_szEmpty);
    FUN_1400702b0(&local_c8, g_szEmpty);
    ...
    FUN_1400675b8((void *)&local_res10, &local_90, 0x2c);
    FUN_140003a20(param_1, &local_90, 1);
    if (*local_res10 == 0x2c) {
        local_res10 = local_res10 + 1;
        plVar7 = FUN_14007f6e4(&local_68, &local_res10, 0x2c, 1);
        ...
        if (*local_res10 == 0x2c) {
            local_res10 = local_res10 + 1;
            plVar7 = FUN_14007f6e4(&local_68, &local_res10, 0x2c, 1);
            FUN_1400676e4(plVar7, &local_c8, 0);
            if (*local_res10 == 0x2c) {
                local_res10 = local_res10 + 1;
