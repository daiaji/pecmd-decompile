...
extern int64_t FUN_14007A224(void *script, WCHAR *line, WCHAR **out, int mode,
 ...
 * 详细签名/返回码约定见文件头注释。 */
int64_t PECMD_SrParsePrefix(void *script, WCHAR **pp, int *flags, int *flags2, uint8_t *p_m_flag,
                            uint8_t *p_mem_flag, WCHAR **psysinit_name, bool *p_sysinit,
