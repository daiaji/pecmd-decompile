...
extern uint64_t   PECMD_ParseImdiskMountArgs(int argc, int64_t *argv, int64_t *out);     /* @0x1400369d0 */
...
extern LARGE_INTEGER PECMD_ProcessScriptBlock(LARGE_INTEGER p1, LARGE_INTEGER p2,
                                              long long *p3, long long *p4, char *p5);   /* @0x14004c0bc */
...
extern uint64_t   PECMD_ExecCmdDispatch(uint64_t a, uint64_t b, uint64_t c, uint64_t d,
                                        uint64_t e, uint64_t f, uint64_t g, uint64_t h); /* @0x14000e26c */
extern int64_t    PECMD_CreateWindow(int64_t *script, WCHAR *name, int64_t a3,
                                     LPCWSTR a4, int a5);                                /* @0x140081fa0 */
extern void       PECMD_StrBldCopyWide(void *ps, const WCHAR *src);                     /* @0x1400703e4 */
extern void       PECMD_TlsLogWrite(uint64_t ctx, const uint16_t *fmt,
                                    uint64_t a, uint64_t b);                             /* @0x140018d8c */
...
#define RAMD_FREE_ALL() do { \
    PECMD_FreeStrBuf(&local_378); PECMD_FreeStrBuf(&local_350); \
    PECMD_FreeStrBuf(&local_3c8); PECMD_FreeStrBuf(&local_370); \
    PECMD_FreeStrBuf(&local_3d0); PECMD_FreeStrBuf(&local_348); \
    PECMD_FreeStrBuf(&local_380); PECMD_FreeStrBuf(&local_3e0); \
    PECMD_FreeStrBuf(&local_3b0); PECMD_FreeStrBuf(&local_390); \
    PECMD_FreeStrBuf(&local_3a0); PECMD_FreeStrBuf(&local_3f0); \
    PECMD_FreeStrBuf(&local_2f0); PECMD_FreeStrBuf(&local_3c0); \
...
LAB_1400e9774:
    ...
    if ((char)lVar18 != '\0') goto LAB_1400ebcdd;
    ...
    if ((int)DAT_14013a854 < 0) {
        ...
        if (g_pImDiskGetVersion != NULL) {
            ((void (*)(uint64_t *, uint64_t *))g_pImDiskGetVersion)
                (&local_280, &local_248);
            if (local_248 != 0) {
            if (local_280 < 0x202) {
                if (local_280 < 0x184) {
    ...
    if (WVar1 == L'*') {
        ...
        *local_3b8 = L'\0';
        ...
        for (;;) {
            while (((cVar10 = PECMD_MatchAndPad((int64_t)(uintptr_t)"-mem",
                                                (int64_t *)&local_3a8, 4)), cVar10 != '\0') ||
                   ((cVar10 = PECMD_MatchAndPad((int64_t)(uintptr_t)"-m",
                                                (int64_t *)&local_3a8, 2)), cVar10 != '\0')) {
    ...
    uVar17 = local_330;
    bVar9 = 0;
    if ((((((char)lVar18 == '\0') && ((char)lVar19 == '\0')) &&
          ((char)lVar20 == '\0')) && ((char)lVar21 == '\0'))) {
        bVar9 = 1;
    }
    if (((((local_330 != 0) || ((int)DAT_14013a854 < 1)) || ((int)DAT_14013a854 < 2)) &&
         ((bVar9 || (bVar39 != 0)))) || (5 < bVar39)) {
        pWVar29 = (LPWSTR)L"0 ";
        if (local_330 == 0) {
                ...
                if (*local_3e8 != L'\0') {
                    ...
                    if (*local_3e8 != L'\0') {
                        ...
                        if (*local_3e8 != L'\0') {
                            ...
                            if (*local_3e8 != L'\0') {
                                local_3e8 = local_3e8 + 1;
                                PECMD_ParseSignedNumberStr((uint64_t *)&local_3e8,
                                                           &local_228, 0x2c);
                            }
                        }
                    }
...
LAB_1400eaff7:
            ...
            if (*local_3e0 != L'\0') goto LAB_1400eb01d;
            RAMD_FREE_ALL();
            EnterCriticalSection(g_csInit);
        }
        else {
            ...
            if (*local_3e0 == L'\0') goto LAB_1400eaff7;
LAB_1400eb01d:
    ...
    if (*local_3f8 == L'*') {
        ...
        *local_210 = L'\0';
        ...
        local_2c0 = (uint64_t)((long long)(local_2c0 +
                      (((long long)local_2c0 >> 63) & 0x1ffU))) >> 9;
        PECMD_FormatI64Dec(pWVar8, local_2c0);
        local_2b0 = (uint64_t)((long long)(local_2b0 +
                      (((long long)local_2b0 >> 63) & 0x1ffU))) >> 9;
            ...
            if (cVar10 == '\0') {
                if (bVar9) {
                    ...
                    if (cVar10 == '\0') {
                        ...
                        if (cVar10 == '\0') goto LAB_1400ea531;
                        bVar39 = 1;
                    }
                    else {
                        bVar31 = 1;
...
LAB_1400ea531:
        ...
        if (((int)DAT_14013a854 < 8) || ((uVar4 != 0 && (bVar39)))) {
            /* —— proxy/devio 共享内存路径 —— */
            if (uVar6 != 0) {
                pvVar23 = CreateFileW(local_3c8, 0xc0000000u, 7,
                                      (LPSECURITY_ATTRIBUTES)0, 3, 0xa0000080u,
                                      (HANDLE)0);
            ...
            if (*local_3d0 == L'\0') {
                ...
                wsprintfW(pWVar24, (const uint16_t *)L"%s#%s#%s$%u",
                          pWVar32, local_288);
            }
            ...
            *lpString = L'\0';
            local_1c8[0] = L'\0';
            if (((local_318 & 0x30) != 0) ||
                ((uVar7 != 0 && ((local_318 & 0x40) == 0)))) {
                PECMD_MemMoveForward((uint8_t *)lpString, (uint8_t *)(const uintptr_t)L"\"-kill:", 0x10);
            ...
            pWVar26 = local_288;
            PECMD_FormatI64Dec(local_288, (long long)
                ((((long long)local_240 >> 63) & 0x1ffU) + local_240) >> 9);
            pWVar29 = pWVar26 + 0x35;
            PECMD_FormatI64Dec(pWVar29, (long long)
                ((((long long)local_250 >> 63) & 0x1ffU) + local_250) >> 9);
            PECMD_SetVariable(out, (const uint16_t *)L"&&__ImdMapPid",
                              (const uint16_t *)L"0");
            iVar13 = lstrlenW(local_370);
            iVar14 = lstrlenW(local_3c8);
            PECMD_AllocWStringBuffer(&local_2e0,
                (long long)iVar12 + 0x940 + (long long)iVar13 + (long long)iVar14);
            ...
            wsprintfW((LPWSTR)local_2e0,
                      (const uint16_t *)L"EXEC --pid:&__ImdMapPid  --exe:%s#10|INDATA --nfb *%%&MyName0%% %s -w:60000 %s %s %s shm:%s  %s %s %s %s %s",
                      local_2b8, lpString);
            ...
            *pWVar29 = L'\0';
            ...
            wsprintfW(local_3f0,
                      (const uint16_t *)L"imdisk -a -t proxy %s %s %s -o shm -f %s ",
            ...
            (void)PECMD_ProcessScriptBlock(
                ...
                (LARGE_INTEGER){ .QuadPart = (long long)(uintptr_t)local_2e0 },
                (long long *)0, (long long *)0, (char *)0);
            ...
            if (0 < local_2d4) {
                PECMD_WaitHandlesOrMessages((uint64_t)(uintptr_t)out,
                                            (long long)local_2d4, 0, (uint64_t *)0);
            }
            PECMD_FreeStrBuf(&local_2e0);
        }
        else {
            ...
            wsprintfW(local_3f0,
                      (const uint16_t *)L"imdisk -a  %s %s %s  -b %sb -s %sb -f %s ",
                      pwVar37);
            WVar1 = *local_398;
            local_388 = local_398;
            while (WVar1 != L'\0') {
...
LAB_1400eb33b:
    ...
    if ((char)lVar18 == '\0') {
        ...
        while (WVar1 != L'\0') {          /* 原体逗号自赋值为寄存器搬运, 此处语义为空 */
            ...
            if (((cVar10 == '\0') &&
                (cVar10 = PECMD_MatchAndPad((int64_t)(uintptr_t)"--hide",
                                            (int64_t *)&local_308, 6), cVar10 == '\0')) &&
               (cVar10 = PECMD_MatchAndPad((int64_t)(uintptr_t)"-q",
                                           (int64_t *)&local_308, 2), cVar10 == '\0')) {
                WVar1 = *local_308;
                while (((WVar1 != L'\0' &&
                        (((uint16_t)WVar1 < 9 || (0xd < (uint16_t)WVar1)))) &&
                       (WVar1 != L' '))) {
        ...
        do {
            if ((uVar17 == 0) && (iVar12 < 1)) {
                ...
                uVar22 = PECMD_ParseImdiskMountArgs(tk.count, (int64_t *)tk.argv, (int64_t *)&local_368);
                ...
                if (*local_3c0 == L'\0') {
                    ...
                    uVar22 = PECMD_ExecCmdDispatch(
                        ...
                        (uint64_t)(uintptr_t)out, (uint64_t)(uintptr_t)local_310,
                        0, 0, 0, 0);
