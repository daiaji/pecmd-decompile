...
DWORD PECMD_SaveImageToFile(RECT *param_1, LPCWSTR param_2, LPCWSTR param_3, LPCWSTR param_4)
{
    ...
    if (param_1 == (RECT *)0) {
        ...
        local_res8[0] = 0;
        hFile =
            CreateFileW(param_2, 0x40000000, 0, (LPSECURITY_ATTRIBUTES)0, 2, 0x8000080, (HANDLE)0);
        ...
        WriteFile(hFile, g_pImageBuf, (DWORD)g_imgBufLen, local_res8, (void *)0);
        CloseHandle(hFile);
        g_imgBufLen = 0;
        if (g_pImageBuf != (LPCVOID)0) {
            HeapFree(g_hHeap, 0, (LPVOID)((int64_t)(intptr_t)g_pImageBuf - 8));
    ...
    if ((0 < iVar2) && (0 < iVar3)) {
        ...
        if (((int64_t)iVar2 != (uint64_t)local_res8[0]) ||
            ...
            (*g_pGdipDrawImageRectI)((void *)(intptr_t)local_40, (void *)pHVar4, 0, 0,
                                     (int64_t)CONCAT44(uVar5, (uint32_t)iVar2), (int)iVar3);
    ...
    if (bVar17) {
        ...
        if (iVar4 == 0x11) {
            ...
            do {
                ...
                if ((iVar4 < 1) || (((0 < (int)(intptr_t)puVar12) && (*local_res10 != ':')) &&
                                    (*local_res10 != '-'))) {
                    goto LAB_14007f219;
                }
...
LAB_14007f219:
    ...
    local_res10 =
        (char *)((((uint64_t)(uint32_t)((uint64_t)local_res10 >> 32)) << 32) | (uint32_t)iVar4);
    puVar16 = puVar11;
    ...
    LAB_14007f319:
        ...
        PECMD_LoadOle32Apis();
        iVar4 = -3;
        if ((g_pOleInit != (int (*)(int))0) && (iVar4 = (*g_pOleInit)(0), iVar4 != 0) &&
            (iVar4 == 1)) {
            (*g_pOleUninit)();
        }
        ...
        if (local_88 == (int64_t *)0) {
            ((int (*)(void *, int, void **)) * (uint64_t *)(*local_80 + 0x18))(local_80, 0,
                                                                               (void **)&local_88);
        }
        local_98 = (uint32_t *)0;
        puVar12 = puVar11;
        if (local_88 != (int64_t *)0) {
            iVar5 = ((int (*)(void *, int, void **, void *)) *
                     (uint64_t *)(*local_88 + 0x18))(local_88, 1, (void **)&local_78, local_6c);
            if (iVar5 == 0) {
                lVar15 = (int64_t)puVar16 * 0x50;
                do {
                    ((void (*)(void *, void **)) *
                     (uint64_t *)(*local_78 + 0x38))(local_78, (void **)&local_a8);
    ...
    if (0 < (int64_t)puVar16) {
        do {
            ...
            if (cVar9 == '\x04') {
                ...
                uVar6 = (uint64_t)PECMD_AsciiPrefixICmp(
                    local_90, (const WCHAR *)(uintptr_t)*(uint64_t *)((char *)puVar12 + 24), iVar4);
                if ((char)uVar6 != '\0') {
                    goto LAB_14007f55f;
                }
            }
...
LAB_14007f55f:
    ...
    *pCVar8 = '\0';
    ...
    PECMD_StrBldCopyWide(local_res20, (LPCWSTR)(uintptr_t)*(uint64_t *)((char *)local_a8 + 16));
    if (param_8 != (int64_t *)0) {
        PECMD_StrBldCopyWide(param_8, (LPCWSTR)(uintptr_t)*(uint64_t *)((char *)local_a8 + 24));
    }
    if (param_6 != (LPWSTR)0) {
 ...
 * ================================================================ */
uint32_t PECMD_QueryWindowState(int64_t *param_1, HWND param_2, LPCWSTR param_3, short param_4)
{
    LPCWSTR pWVar1;
    int iVar2;
    uint32_t uVar3;
 ...
 * ================================================================ */
uint64_t PECMD_CreateTextControl(int64_t *param_1, WCHAR *param_2, WPARAM param_3, uint64_t param_4)
{
    WCHAR WVar1;
    bool bVar2;
    bool bVar3;
    ...
    *local_68 = (WCHAR)uVar14;
    ...
    if (WVar15 == *local_res10) {
        do {
                        ...
                        if ((char)uVar5 == '\0') {
                            ...
                            if ((char)lVar4 == '\0') {
                                ...
                                if ((char)lVar4 == '\0') {
                                    ...
                                    if ((char)lVar4 == '\0') {
                                        lVar4 =
                                            PECMD_TokPrefixICmp("-u2d", (const WCHAR *)pWVar16, 4);
                                        if ((char)lVar4 != '\0') {
                            ...
                            PECMD_ExpandVarDispatch(param_1, local_res10, (WCHAR **)&local_c0, 0,
                                                    1);
                            local_a0 = local_c0;
            ...
            uVar10 = (uint32_t)uVar8;
            WVar1 = *pWVar16;
            while ((WVar1 != L'\0' && (((uint16_t)WVar1 < (uint16_t)(WCHAR)(iVar9 + -0x23)) ||
                                       (0xd < (uint16_t)WVar1))) &&
                   (WVar1 != L' ')) {
                pWVar16 = pWVar16 + 1;
                local_res10 = pWVar16;
    ...
    *local_90 = WVar1;
    ...
    if (*local_res10 == L'\0') {
        ...
        if (*local_res10 == L',') {
            local_res10 = local_res10 + 1;
            plVar6 =
                PECMD_SplitTokenAssignVar((WCHAR **)&local_60, (WCHAR **)&local_res10, 0x2c, 1);
            ...
            if (*local_res10 == L',') {
                ...
                if (*local_res10 == L',') {
                    local_res10 = local_res10 + 1;
                    puVar7 = (uint64_t *)PECMD_SplitTokenAssignVar((WCHAR **)&local_60,
                                                                   (WCHAR **)&local_res10, 0x2c, 1);
                    uVar8 = PECMD_ParseSignedNumber((short *)(uintptr_t)*puVar7);
                    if (*local_res10 == L',') {
                        local_res10 = local_res10 + 1;
                        plVar6 = PECMD_SplitTokenAssignVar((WCHAR **)&local_60,
                                                           (WCHAR **)&local_res10, 0x2c, 1);
        ...
        PECMD_DispatchCreateControl(
            param_3, (int64_t)param_1, (WCHAR **)&local_a8, (int)(int32_t)(uint64_t)local_90,
            local_b0[0], local_c4, (int)(int32_t)local_res18, (WCHAR **)&local_b8,
            (WCHAR **)&local_88, (uVar12 & 0xffff) | uVar10 | uVar11, local_78, local_c0, local_98);
        PECMD_FreeStrBuf((WCHAR **)&local_88);
        PECMD_FreeStrBuf((WCHAR **)&local_c0);
        PECMD_FreeStrBuf((WCHAR **)&local_a0);
        PECMD_FreeStrBuf((WCHAR **)&local_b8);
