...
extern DWORD PECMD_EnumDevices(LPCWSTR path, LPWSTR buf, uint32_t flags, GUID *guid);
...
extern uint64_t PECMD_ReadDiskSectorScan(uint64_t *param_1, uint64_t *param_2, uint32_t param_3,
                                         DWORD param_4, uint64_t param_5, uint64_t *param_6,
                                         LARGE_INTEGER param_7);
extern uint64_t PECMD_FindPartitionInfo(int64_t a, uint8_t b, uint32_t c, void *d, void *e, DWORD f,
                                        int g, void *h);
extern uint32_t PECMD_GetDiskGeometry(LPCWSTR p, HANDLE h);
extern int PECMD_QueryDiskGeometry(HANDLE param_1, uint64_t *param_2, int param_3, int param_4);
 ...
 * ========================================================================== */
int64_t *PECMD_SetupRoundedRegion(int64_t *param_1, short *param_2, HWND param_3, ulonglong param_4)
{
    uint64_t *puVar1;
    HGDIOBJ ho;
    DWORD DVar2;
    ...
    if (*param_2 == 0) {
        ...
        *(LONG *)((longlong)puVar1 + 0x24) = local_50.bottom;
        pHVar4 = CreateRoundRectRgn(0, 0, local_50.right, local_50.bottom, *(int *)(puVar1 + 5),
        ...
        pHVar4 = CreateRoundRectRgn(local_50.left, local_50.top, local_50.right, local_50.bottom,
                                    *(int *)(puVar1 + 5), *(int *)((longlong)puVar1 + 0x2c));
...
ushort *PECMD_ParseQuotedArg(longlong *param_1, longlong *param_2, longlong *param_3)
{
    ...
    while ((*puVar3 != 0 && (((puVar3 = (ushort *)*param_2, *puVar3 < 9 || (0xd < *puVar3)) &&
                              (*puVar3 != 0x20))))) {
        if (*puVar3 == 0x22) {
            goto LAB_140083b58;
        }
                                ...
                                longlong *param_4)
{
    ...
    if ((((*local_580 != L'\0') && (pBVar21 = pBVar17, cVar5 != '\0')) &&
        ...
        pBVar17 = local_580;
        memmove((void *)(local_580 + 4), (const void *)(local_580 + 2), (iVar6 + 2) * 2);
        pBVar17[3] = L'.';
        pBVar21 = pBVar17;
    }
    ...
    if ((((*(byte *)((longlong)param_1 + 0xd) & 0xf) == 0) && (*local_590 != L'&')) ||
        (lVar8 =
             (longlong)PECMD_VarLookup((void *)param_1, local_590, (void *)0x0, -1, (void **)0x0),
         lVar8 == 0)) {
    ...
    if (local_5a8 != (WCHAR *)0x0) {
        ...
        if (pWVar11 == (LPWSTR)0x0) {
            ...
            pWVar11 = local_5a0;
            lVar8 = (longlong)PECMD_VarLookup((void *)param_1, local_5a0, (void *)0x0, -1,
                                              (void **)0x0);
            if (lVar8 != 0)
                goto LAB_140087be8;
        }
    ...
    LAB_14008822a:
        ...
        if (WVar24 != L'\0') {
            ...
            if (pWVar14 == (LPWSTR)0x0) {
                ...
                pWVar11 = local_5a0;
                memcpy((void *)(local_5a0 + (iVar6 + 1)), (const void *)local_5a0, (iVar6 + 1) * 2);
        ...
        if (*piVar16 == 1) {
            if ((local_4d8 >> 9 & 1) == 0) {
                ...
                pBVar21 = local_588;
                if ((iVar6 < 1) ||
                    (uVar22 = 0x5c, *(short *)(pBVar17 + (longlong)iVar6 + -1) == 0x5c)) {
                    uVar22 = 0;
                }
                ...
                if (*(WCHAR *)local_5a8 == L'\0') {
                    ...
                    do {
                        ...
                        pBVar4 = pBVar17;
                        while (
                            ((WVar2 != L'\0' && (((ushort)WVar2 < 9 || (0xd < (ushort)WVar2)))) &&
                             (WVar2 != L' '))) {
                            local_5a8 = pBVar4 + 1;
                            pBVar4 = local_5a8;
                            WVar2 = *(WCHAR *)local_5a8;
    ...
    *(undefined2 *)((longlong)local_2d8 + 0x10c0da) = 0;
    ...
    do {
        ...
        if ((uVar3 != 0) && (-1 < (int)uVar13)) {
            PECMD_EnumDevices((LPCWSTR)(longlong)iVar11, pWVar2 + 0x65, 0x13, (GUID *)&g_bE870);
        }
        if ((uVar14 != 0) && (-1 < (int)uVar13)) {
            PECMD_EnumDevices((LPCWSTR)(longlong)iVar11, local_2d0 + 1, 0x14, (GUID *)&g_bE870);
        }
        local_2f8 = (HANDLE)0x0;
        if ((local_res20 == 0) || (bVar1 = true, (int)uVar13 < 0)) {
            bVar1 = false;
        }
        PECMD_OpenFileHandle(&local_2f8, pWVar2, (-(uint)bVar1 & 0x40000000) + 0x80000000, 3,
        ...
        LAB_14008aeda:
            if (-1 < (int)uVar13) {
                ...
                if (hObject != (HANDLE)0x0) {
                    ...
                    if (iVar16 == 0) {
                        wsprintfW((LPWSTR)&local_278, WSTR("%08lX"), (int)puVar15[1]);
                    }
                    else if (iVar16 == 1) {
                        PECMD_GuidToString((LPWSTR)&local_278, (uint32_t *)(puVar15 + 1), 0);
                    }
                    local_2a0 = 0;
                    ...
                    uVar5 = PECMD_FindPartitionInfo(
                        (int64_t)(uintptr_t)(puVar15 + 6), (uint8_t)(iVar16 == 1), local_res10[0],
                        (void *)&local_308, (void *)&local_2e8, DVar4, iVar16, (void *)&local_2f8);
                    ...
                    if (local_2e0 != 0) {
                        ...
                        lVar8 = PECMD_FindPartitionStartSector(hObject, (int *)local_res10,
                                                               (longlong *)&local_308);
                        wsprintfW(local_1c8, WSTR(" %I64d %u %I64d"), lVar8, local_res10[0]);
                    }
                    PECMD_FormatI64Dec(local_c8, (uint64_t)local_2a8);
                    PECMD_FormatI64Dec(local_148, CONCAT44(auStack_29c[0], local_2a0));
                    ...
                    uVar10 = wsprintfW((LPWSTR)*param_1, pwVar9, (int)uVar12, local_c8);
                    if (uVar3 != 0) {
