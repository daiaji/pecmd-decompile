...
/* @0x1400734e4                                                               */
/* ========================================================================== */
/* signature: uint __fastcall PECMD_ParseWindowOptions(ushort * param_1, undefined1 * param_2, int *
 * param_3) */
            ...
            if (cVar2 == '\0') {
                ...
                if (cVar2 == '\0') {
                    ...
                    if (cVar2 == '\0') {
                        ...
                        if (cVar2 == '\0') {
                            cVar2 =
                                PECMD_MatchTokenAdvance("-discloseb", (int64_t *)&local_res8, -1);
                            if (cVar2 == '\0') {
                                cVar2 = PECMD_MatchTokenAdvance("-nosysmenu",
                                                                (int64_t *)&local_res8, -1);
                                if (cVar2 == '\0') {
                                    cVar2 = PECMD_MatchTokenAdvance("-nocap",
                                                                    (int64_t *)&local_res8, -1);
                                    if (cVar2 == '\0') {
                                        cVar2 = PECMD_MatchTokenAdvance("-disaltmv",
                                                                        (int64_t *)&local_res8, 9);
                                        if (cVar2 == '\0') {
                                            cVar2 = PECMD_MatchTokenAdvance(
                                                "-altmv", (int64_t *)&local_res8, 6);
                                            if (cVar2 == '\0') {
                                                cVar2 = PECMD_MatchTokenAdvance(
                                                    "-mv", (int64_t *)&local_res8, 3);
                                                if (cVar2 == '\0') {
                                                    cVar2 = PECMD_MatchTokenAdvance(
                                                        "-layer", (int64_t *)&local_res8, 6);
                                                    if (cVar2 == '\0') {
                                                        cVar2 = PECMD_MatchTokenAdvance(
                                                            "-size", (int64_t *)&local_res8, 5);
                                                        if (cVar2 == '\0') {
                                                            cVar2 = PECMD_MatchTokenAdvance(
                                                                "-nfocus", (int64_t *)&local_res8,
                                                                7);
                                                            if (cVar2 == '\0') {
                                                                cVar2 = PECMD_MatchTokenAdvance(
                                                                    "-ntab", (int64_t *)&local_res8,
                                                                    5);
                                                                if (cVar2 == '\0') {
                                                                    cVar2 = PECMD_MatchTokenAdvance(
                                                                        "-trap",
                                                                        (int64_t *)&local_res8, 5);
                                                                    if (cVar2 == '\0') {
                                                                        cVar2 =
                                                                            PECMD_MatchTokenAdvance(
                                                                                "-csize",
                                                                                (int64_t
                                                                                     *)&local_res8,
                                                                                6);
...
int64_t *PECMD_CacheLookupInsert(LPCWSTR param_1, int64_t param_2, uint64_t param_3,
                                 uint64_t **param_4)
{
    int64_t lVar1;
    int64_t lVar2;
    ...
    if ((*(uint32_t *)ppuVar10 >> 8 & 1) == 0) {
        ...
        *plVar6 = (int64_t)local_48;
        ...
        puVar3[0] = 0;
        puVar3[1] = 1;
        memcpy((uint8_t *)(puVar3 + 8), (const uint8_t *)param_1, (int)((int64_t)iVar5 * 2) + 2);
        if (uVar4 == 0) {
    ...
    while (bVar1 = 0, iVar2 != 0) {
        ...
        if (uVar9 != 0) {
            do {
                ...
                if (((*param_2 == L'\0') ||
                     (iVar3 = lstrcmpiW(
                          param_2, (LPCWSTR)((char *)local_b0 + (int64_t)iVar2 * 0x418 + 0x208)),
                      iVar3 != 0)) &&
                    ((*param_3 == L'\0') ||
                     (iVar3 =
                          lstrcmpiW(param_3, (LPCWSTR)((char *)local_b0 + (int64_t)iVar2 * 0x418)),
                      iVar3 != 0))) {
                    if ((*param_2 == L'\0') && (*param_3 == L'\0'))
                        goto LAB_1400759c5;
                }
                else {
                    bVar1 = 1;
        ...
        if ((*puVar10 != 0) ||
            (pvVar8 = (void *)0x0, g_pWIMGetMountedImageCount == (int (*)(void *, uint32_t *))0x0))
            goto LAB_140075ae2;
        *puVar10 = 1;
        local_b8[0] = 0x100000;
