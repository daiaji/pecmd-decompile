...
extern LPCWSTR PECMD_ExtractTokenByIndex(uint64_t a1, int *a2, LPCWSTR a3, int64_t *a4, uint32_t a5,
                                         uint16_t *a6);
    ...
    if (WVar20 == L'\0') {
        ...
        if (WVar1 == L'\0') {
            ...
            if (local_b0[0] < 1) {
                ...
                while (WVar1 != L'\0') {
                    WVar1 = *local_res10;
                    if ((WVar1 == WVar20) || (((!bVar22 && ((ushort)WVar1 < 0x5b)) &&
                                               ((WCHAR)(WVar1 | 0x20U) == WVar20)))) {
                        ppWVar18 =
                            (LPCWSTR *)(((longlong)local_res10 - (longlong)(pWVar13 + -1)) >> 1);
                        if (uVar3 != 0) {
                            ppWVar14 = ppWVar18;
                        ...
                        if (uVar4 != 0) {
                            iVar9 = (int)PECMD_CountNewlines((ulonglong *)pWVar13,
                                                             (int)(uintptr_t)ppWVar18,
                                                             (void *)(longlong)local_d0, iVar7);
                ...
                for (; pWVar13 <= local_res10; local_res10 = local_res10 + -1) {
                    if (((*local_res10 == WVar20) ||
                        ...
                        if (local_70 != 0) {
                            iVar8 = (int)PECMD_CountNewlines((ulonglong *)pWVar13,
                                                             (int)(uintptr_t)ppWVar18,
                                                             (void *)(longlong)local_d0, iVar7);
            ...
            if (local_b0[0] < 1) {
                ...
                if (*pWVar13 != L'\0') {
                    ...
                    do {
                        ...
                        if (iVar8 == 0) {
                            ppWVar18 =
                                (LPCWSTR *)(((longlong)local_res10 - (longlong)(pWVar13 + -1)) >>
                                            1);
                            if (local_88 != 0) {
                                ppWVar14 = ppWVar18;
                                if (((longlong)pWVar15 < 1) && (0 < (longlong)ppWVar18)) {
                ...
                for (local_res10 = pWVar13 + (longlong)iVar7 + -1 + (1 - (longlong)iVar9);
                    ...
                    if ((iVar10 == 0) && (iVar8 = iVar8 + -1, iVar8 < 1)) {
                        ...
                        if (local_70 != 0) {
                            iVar10 = (int)PECMD_CountNewlines((ulonglong *)pWVar13,
                                                              (int)(uintptr_t)ppWVar18,
                                                              (void *)(longlong)local_d0, iVar7);
    ...
    if (*local_68 == L'\0') {
        if (*local_a0 != L'\0') {
            if (0 < (longlong)ppWVar18) {
                uVar11 = PECMD_CountNewlines((ulonglong *)pWVar13, (int)(uintptr_t)ppWVar18,
                                             (void *)(longlong)local_d0, iVar7);
            }
                           ...
                           longlong *param_4, longlong *param_5, longlong *param_6)
{
    ...
    if (*local_res10 == 0x2c) {
        ...
        if (*local_res10 == 0x2c) {
            ...
            if (*local_res10 == 0x2c) {
                local_res10 = local_res10 + 1;
                puVar3 = (undefined8 *)PECMD_SplitTokenAssignVar(&local_40,
                ...
                if (*local_res10 == 0x2c) {
                    local_res10 = local_res10 + 1;
                    plVar2 =
                        PECMD_SplitTokenAssignVar(&local_40, (longlong *)&local_res10, 0x2c, 1);
...
FILETIME PECMD_DirWildcardExpand(longlong *param_1, FILETIME param_2)
{
    ...
    if (*((int16_t *)(uintptr_t)local_res10[0]) == 0x25) {
        do {
            if (((8 < uVar5) && (uVar5 < 0xe)) || (uVar5 == 0x20))
                break;
    ...
    if ((char)uVar2 != '\0') {
        ...
        if (uVar5 == 0x22) {
            ...
            if (uVar5 != 0) {
                ...
                for (; ((uVar5 = *((ushort *)(uintptr_t)local_res10[0]),
                       uVar5 != 0 && ((uVar5 < 9 || (0xd < uVar5)))) &&
                        (uVar5 != 0x20));
                     local_res10[0] = local_res10[0] + 2) {
                }
            }
...
byte *PECMD_CreateMenuItem(longlong *param_1, int16_t *param_2)
{
    ...
    LVar5 = PECMD_LI((intptr_t)operator_new(0x48));
        ...
        if (**(LPCWSTR *)(uintptr_t)(LVar10.QuadPart + 0x18) != L'\0') {
            ...
            if (param_1[3] == 0) {
                ...
                PECMD_SetVariableWithPrefix(
                    param_1,
                    (LPCWSTR)(uintptr_t)(((uint64_t)(uint32_t)uStackX_1c << 32) |
        ...
        *(int *)(pcVar13 + 4) = *(int *)(pcVar13 + 4) + 1;
        if ((cVar1 != '\0') || (cVar2 != '\0')) {
            ...
            if (cVar2 != '\0') {
                ...
                local_50 =
                    PECMD_ParseCommandPath(param_1, *(WCHAR **)(uintptr_t)(LVar10.QuadPart + 0x18),
                ...
                *(undefined1 *)(uintptr_t)LVar10.QuadPart = 0x80;
                if (*(longlong *)(uintptr_t)(LVar10.QuadPart + 0x10) != 0) {
                    HeapFree(
                        g_hHeap, 0,
                        (LPVOID)(uintptr_t)(*(longlong *)(uintptr_t)(LVar10.QuadPart + 0x10) + -8));
                    *(uint64_t *)(uintptr_t)(LVar10.QuadPart + 0x10) = 0;
                }
                *(undefined1 **)(uintptr_t)(LVar10.QuadPart + 0x10) = puVar6;
                LVar7 = PECMD_LI((intptr_t)operator_new(0xf0));
                ...
                *(longlong *)(uintptr_t)(LVar5.QuadPart + 0x40) = lVar9;
                ...
                lVar9 = param_1[8];
                PECMD_BuildPopMenuRecursive((longlong)(intptr_t)puVar6, (ushort *)(lVar9 + 0x218),
                                            pHVar8, *(longlong *)(lVar9 + 0x20),
                                            *(longlong *)(lVar9 + 0x200),
...
LAB_1400a344b:
    ...
    while (local_res10[0] = (WCHAR *)pWVar13, uVar14 == (ushort)WVar6) {
        ...
        if ((char)uVar8 == '\0') {
            ...
            if ((char)uVar8 != '\0') {
                ...
                uVar9 = PECMD_EvalParenStripped((longlong *)local_res10,
                                                (uint64_t *)&local_1908.QuadPart);
                if ((int)uVar9 < 1)
                    goto LAB_1400a34a9;
            ...
            local_res10[0] = (WCHAR *)(pWVar13 + 5);
            uVar9 =
                PECMD_EvalParenStripped((longlong *)local_res10, (uint64_t *)&local_1908.QuadPart);
            if ((int)uVar9 < 1) {
            LAB_1400a34a9:
                iVar16 = -0x7ff8ffa9;
                goto LAB_1400a3ec4;
    ...
    if (WVar6 != L'\0') {
        do {
            if (((8 < (ushort)WVar6) && ((ushort)WVar6 < 0xe)) || (WVar6 == L' '))
                break;
            local_res10[0] = local_res10[0] + 1;
            WVar6 = *local_res10[0];
        } while (WVar6 != L'\0');
        PECMD_StrCopyW(&local_18f8, pWVar13, ((longlong)local_res10[0] - (longlong)pWVar13) >> 1);
    ...
    do {
        ...
        if (bVar2) {
            wsprintfW(
                (LPWSTR)&local_18d8, WSTR(".%04lu"),
                (ulonglong)(local_1900.LowPart + (int)(local_1900.QuadPart / 10000) * -10000));
        }
        if (cVar4 == '\0') {
        ...
        while ((lpString < local_b8 && (*pWVar15 != L'\0'))) {
            ...
            if (cVar5 == '\0') {
                    ...
                    if (cVar5 == '\0') {
                        ...
                        if (cVar5 == '\0') {
                            ...
                            if (cVar5 == '\0') {
                                ...
                                if ((cVar5 == '\0') &&
                                    (cVar5 = PECMD_MatchTokPrefixAdv(WSTR("年"), &local_res20, -1),
                                     cVar5 == '\0')) {
                                    cVar5 = PECMD_MatchTokenAdvance("Mon", &local_res20, -1);
                                    if ((cVar5 != '\0') || (cVar5 = PECMD_MatchTokPrefixAdv(
                                                                WSTR("月"), &local_res20, -1),
                                                            cVar5 != '\0')) {
                                    ...
                                    if ((cVar5 == '\0') && (cVar5 = PECMD_MatchTokPrefixAdv(
                                        ...
                                        if ((cVar5 == '\0') && (cVar5 = PECMD_MatchTokPrefixAdv(
                                                                    WSTR("天"), &local_res20, -1),
                                                                cVar5 == '\0')) {
                                            cVar5 =
                                                PECMD_MatchTokenAdvance("Freq", &local_res20, -1);
                                            lVar12 = g_QPFreq;
                                            if (cVar5 != '\0')
                                                goto LAB_1400a3d8f;
                                            cVar5 = PECMD_MatchTokenAdvance("Counter", &local_res20,
                                                                            -1);
                                            if (cVar5 == '\0') {
                                                WVar6 = *local_res20;
                                                while (
                                                    (WVar6 != L'\0' && ((((ushort)WVar6 < 9 ||
                                                                          (0xd < (ushort)WVar6)) &&
                                                                         (WVar6 != L' '))))) {
                                    ...
                                    LAB_1400a3e3e:
                                        uVar14 =
                                            PECMD_CalcCalendarMonthRows(&local_1918.wYear, iVar7);
                                    }
                ...
                LAB_1400a3dce:
                    ...
                    iVar7 = (int)((ulonglong)((longlong)local_18d8.Bias * (longlong)0x77777777) >>
                                  0x20) -
                            local_18d8.Bias;
                ...
                /* (longlong)(__int128 x * M) == low 64 bits of product == plain 64-bit mul */
                lVar12 = -0x29406b2a1a85bd43LL * local_1908.QuadPart +
                         local_1908.QuadPart;
                PECMD_FormatI64Dec(
                    lpString, (uint64_t)(((lVar12 >> 0x17) + -0x2b6109100) - (lVar12 >> 0x3f)));
    ...
    if (*local_a0 != L'\0') {
        ...
        if (*pWVar6 != L'\0') {
            ...
            do {
                ...
                if (*local_108 != L'\0') {
                    ...
                    if (0 < lVar17) {
                        do {
                            puVar7 = (uint64_t *)PECMD_VectorSlotPtr((int64_t)uVar10, &local_98,
                                                                     &local_90, 8);
                    ...
                    if (local_108 != (WCHAR *)0) {
                        ...
                        if ((char)uVar8 == '\0') {
                            ...
                            if ((char)uVar8 == '\0') {
                                ...
                                if (((char)uVar8 == '\0') &&
                                    (uVar8 = PECMD_AsciiPrefixICmp(".com*", (ushort *)pWVar18, 5),
                                     (char)uVar8 == '\0')) {
                                    local_f8[0] = 0xffffffff;
                                    puVar7 = PECMD_CreateNamedLock(
                                        pWVar18, '\0',
                                        (uint32_t *)(-(ulonglong)((int)local_100 != 0) &
                                                     (ulonglong)local_f8));
                                    if (iVar16 != 0) {
                                        PECMD_AppendLongDecimal(param_1, (ulonglong)local_f8[0],
                                                                local_e0);
                                    }
                                    if (puVar7 != (uint64_t *)0x0) {
                                        *(int *)((longlong)puVar7 + 0x14) = local_res20[0];
                                        local_78 = (WCHAR *)lpString1;
                                        PECMD_VectorAppendGen(&local_98, &local_90, &local_88,
                                                              &local_78, 8, 1);
                                        local_70 = puVar7;
                                        PECMD_VectorAppendGen(&local_d0, &local_c8, &local_c0,
                                                              &local_70, 8, 1);
                                    ...
                                    if ((((*(byte *)((longlong)param_1 + 0x12) & 4) == 0) &&
                                         (*(byte *)((longlong)param_1 + 0x12) =
                                          ...
                                          g_pUiCallback != (code *)0x0)) &&
                                        ((*g_pUiCallback)(0, local_e8), -1 < iVar3)) {
                                        (*g_pOle32Slot828)(0, 0xffffffff, 0, 0, iVar3, iVar14, 0, 0,
                                                           0);
                                    }
                                }
                            }
        ...
        if (0 < lVar17) {
            ...
            if (0 < lVar17) {
                ...
                do {
                    plVar9 =
                        (longlong *)PECMD_VectorSlotPtr((int64_t)uVar10, &local_d0, &local_c8, 8);
                    uVar19 = (int)uVar15 + 1;
            ...
            if ((int)uVar20 != 2) {
                ...
                LAB_1400a4cee:
                    if ('\0' < g_flagA24F) {
                        if (param_3 == 0) {
                            uVar19 =
                                WaitForMultipleObjects(uVar13, (const HANDLE *)(uintptr_t)local_100,
                                                       (uint)(uVar13 != 1), 100);
                        }
                        else {
                        ...
                        do {
                            if ((g_flagA24F < '\x01') ||
                                (BVar5 = PeekMessageW(&local_68, (HWND)0, 0, 0, 1), BVar5 == 0))
                                break;
                    ...
                    DVar4 =
                        WaitForMultipleObjects(uVar13, (const HANDLE *)(uintptr_t)local_100, 1, 0);
                    if (DVar4 < uVar13) {
                    LAB_1400a4d06:
                        uVar10 = 0;
                        uVar20 = uVar11;
                        if (0 < lVar17) {
                            do {
                                plVar9 = (longlong *)PECMD_VectorSlotPtr(uVar11, &local_d0,
                                                                         &local_c8, 8);
                                uVar13 = (int)uVar20 + 1;
