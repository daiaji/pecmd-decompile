...
extern WCHAR *FUN_14005b154(void *pp);
extern char  FUN_1400660ac(const char *tok, void *pp, int n);
extern int64_t FUN_14005c788(const char *a, const void *w, int n);
extern int64_t FUN_14005c72c(const char *a, const void *w, int n);
extern int32_t FUN_14005c7c4(const char *a, const void *w);
extern void  FUN_1400702b0(void *ps, const WCHAR *src);
extern void  FUN_140003a20(void *script, void *str, int mode);
...
extern void  FUN_14007bf44(void *, LPCWSTR, void *, int, int);
...
extern void  FUN_14005b900(void *pc, uint64_t hwnd, LPCWSTR s, void *hicon, uint32_t flag);
...
extern WCHAR *FUN_140024c48(void *param_1, void *param_2, uint32_t param_3);
...
extern WCHAR *FUN_14007034c(void *ps, const WCHAR *src);
...
extern int   FUN_140060ee0(uint16_t *a, int b);
...
extern void  FUN_1400e5120(void *a, uint16_t *b, HMENU c, int64_t d, int64_t e, int64_t *f);
extern void  FUN_1400e4f14(HMENU menu, UINT flags, uintptr_t item, void *data);
extern void *FUN_1400a4460(LPCWSTR s, char c, uint32_t *mode);
...
LAB_1400a1bd9:
  ...
  *local_res10 = L'\0';
  ...
  FUN_14007bf44(param_1, local_d8, &local_b8, 0, 1);
  local_d8 = local_b8;
  if (cVar6 != '\0') {
    local_c8 = local_b8;
    local_b8 = (WCHAR *)0x0;
    FUN_140079c80(param_1, &local_d8, (int64_t *)&local_b8);
    local_d8 = local_b8;
  ...
  if (WVar20 == L'\0') {
    ...
    WVar1 = local_d8[1];
    FUN_14007bf44(param_1, local_res10, &local_90, 0, 1);
    local_res10 = local_90;
    local_b0[0] = 0;
    FUN_1400679b0(&local_res10, local_b0, 0x2c);
    if (*local_res10 != L',') {
    ...
    pWVar13 = local_res10;
    if (cVar5 != '\0') {
      FUN_140079c80(param_1, &local_res10, (int64_t *)&local_80);
      pWVar13 = local_80;
    }
    local_res10 = pWVar13;
      ...
      if (local_b0[0] < 1) {
        ...
        while (WVar1 != L'\0') {
          ...
          if ((WVar1 == WVar20) ||
            ...
            if (uVar3 != 0) {
              ...
              FUN_14006cc70((longlong *)&local_50, (longlong)ppWVar14);
            }
            if (uVar4 != 0) {
              iVar9 = (int)FUN_140060b5c((ulonglong *)pWVar13, (int)ppWVar18, (void *)(longlong)local_d0, iVar7);
              FUN_14006cc70((longlong *)&local_68, iVar9);
            }
            pWVar15 = local_c8;
            if (bVar2) break;
          }
        ...
        for (; pWVar13 <= local_res10; local_res10 = local_res10 + -1) {
          if (((*local_res10 == WVar20) ||
            ...
            if (local_70 != 0) {
              iVar8 = (int)FUN_140060b5c((ulonglong *)pWVar13, (int)ppWVar18, (void *)(longlong)local_d0, iVar7);
              FUN_14006cc70((longlong *)&local_68, iVar8);
            }
            pWVar15 = local_c8;
            if (bVar2) break;
          }
      ...
      if (local_b0[0] < 1) {
        ...
        for (local_res10 = pWVar13 + (longlong)iVar7 + -1 + (1 - (longlong)iVar9);
          ...
          if ((iVar10 == 0) && (iVar8 = iVar8 + -1, iVar8 < 1)) {
            ...
            if (local_70 != 0) {
              iVar10 = (int)FUN_140060b5c((ulonglong *)pWVar13, (int)ppWVar18, (void *)(longlong)local_d0, iVar7);
              FUN_14006cc70((longlong *)&local_68, iVar10);
            }
            if (bVar2) break;
          }
        }
  ...
  if (*local_68 == L'\0') {
    if (*local_a0 != L'\0') {
      if (0 < (longlong)ppWVar18) {
        uVar11 = FUN_140060b5c((ulonglong *)pWVar13, (int)ppWVar18, (void *)(longlong)local_d0, iVar7);
      }
                 ...
                 longlong *param_4, longlong *param_5, longlong *param_6)
{
  ...
  if (*local_res10 == 0x2c) {
    ...
    if (*local_res10 == 0x2c) {
      ...
      if (*local_res10 == 0x2c) {
        local_res10 = local_res10 + 1;
        puVar3 = FUN_14007f6e4(&local_40, (longlong *)&local_res10, 0x2c, 1);
...
FILETIME PECMD_DirWildcardExpand(longlong *param_1, FILETIME param_2)
{
  ...
  if (*((int16_t *)(uintptr_t)local_res10[0]) == 0x25) {
    ...
    FUN_14005b154((longlong *)local_res10);
  }
  _Var4 = local_res10[0];
  uVar2 = FUN_14005c788("--wd:", (ushort *)(uintptr_t)local_res10[0], 5);
  if ((char)uVar2 != '\0') {
  ...
  if (uVar5 == 0) {
    ...
    if (*((int16_t *)(uintptr_t)local_res10[0]) != 0) {
      FUN_1400702b0(local_res10, WSTR("*- "));
...
byte *PECMD_CreateMenuItem(longlong *param_1, int16_t *param_2)
{
  ...
  *(uint32_t *)(uintptr_t)(LVar10.QuadPart + 0x28) = *(uint32_t *)(pcVar13 + 4);
  FUN_14007034c((void *)(uintptr_t)(LVar10.QuadPart + 0x10), local_70);
  FUN_14007034c((void *)(uintptr_t)(LVar10.QuadPart + 8), local_res20);
  FUN_14007034c((void *)(uintptr_t)(LVar10.QuadPart + 0x30), local_78);
  if ((int)uVar4 < 0) {
    uVar4 = -uVar4 | 1;
  }
    ...
    *(int *)(pcVar13 + 4) = *(int *)(pcVar13 + 4) + 1;
    if ((cVar1 != '\0') || (cVar2 != '\0')) {
      ...
      if (cVar2 != '\0') {
        ...
        local_50 = FUN_14002fd88(param_1, *(WCHAR **)(uintptr_t)(LVar10.QuadPart + 0x18),
        ...
        *(undefined1 **)(uintptr_t)(LVar10.QuadPart + 0x10) = puVar6;
        ...
        if ((undefined8 *)(uintptr_t)LVar7.QuadPart != (undefined8 *)0x0) {
          FUN_140017cdc((uint64_t *)(uintptr_t)LVar7.QuadPart, (uint64_t *)param_1);
          FUN_1400186bc((uint64_t *)(uintptr_t)LVar7.QuadPart, (longlong)param_1);
        ...
        *(longlong *)(uintptr_t)(LVar5.QuadPart + 0x28) = param_1[5];
        FUN_140073ccc((longlong *)(uintptr_t)LVar5.QuadPart, g_szEmpty, 0);
        lVar9 = param_1[8];
        ...
        *(short *)(param_1[8] + 0x218) = *(short *)(param_1[8] + 0x218) + 1;
        FUN_1400e4f14(local_60, 0x10, (uintptr_t)pHVar8, (void *)(uintptr_t)LVar10.QuadPart);
      }
    }
    if ((param_1[3] == 0) && (param_1[8] != 0)) {
      if (*(int *)(pcVar13 + 4) == 1) {
        ...
        if (cVar2 == '\0') {
          FUN_14005b900(pcVar13, *(uint64_t *)(uintptr_t)(param_1[8] + 0x20),
...
LAB_1400a657f:
        if (cVar2 == '\0') {
          lVar9 = param_1[8];
          FUN_1400e5120((void *)(uintptr_t)LVar10.QuadPart, (ushort *)(lVar9 + 0x218), hMenu,
                        *(longlong *)(lVar9 + 0x20), *(longlong *)(lVar9 + 0x200),
                        *(longlong **)(lVar9 + 0x290));
        }
      }
...
longlong PECMD_FormatTimeString(longlong *param_1, WCHAR *param_2)
{
  ...
  FUN_14005b154((longlong *)local_res10);
  FUN_1400702b0(&local_18f8, WSTR("CurDate"));
  FUN_14005b154((longlong *)local_res10);
  iVar16 = 0;
...
LAB_1400a344b:
  ...
  while (local_res10[0] = pWVar13, uVar14 == (ushort)WVar6) {
    uVar8 = FUN_14005c788("utc:", (ushort *)(pWVar13 + 1), 4);
    if ((char)uVar8 == '\0') {
      uVar8 = FUN_14005c788("gmt:", (ushort *)(pWVar13 + 1), 4);
      if ((char)uVar8 != '\0') {
        local_res10[0] = pWVar13 + 5;
        uVar9 = FUN_1400745c8((longlong *)local_res10, (uint64_t *)&local_1908.QuadPart);
        if ((int)uVar9 < 1) goto LAB_1400a34a9;
        local_1908.QuadPart = (local_1908.QuadPart + 0x2b6109100) * 10000000;
        goto LAB_1400a36ff;
      }
      uVar8 = FUN_14005c788("local0:", (ushort *)(pWVar13 + 1), 7);
      if ((char)uVar8 == '\0') {
        uVar8 = FUN_14005c788("local:", (ushort *)(pWVar13 + 1), 6);
        if ((char)uVar8 != '\0') {
          cVar17 = '\0';
          goto LAB_1400a3551;
        }
        uVar8 = FUN_14005c788("sys0:", (ushort *)(pWVar13 + 1), 5);
        if ((char)uVar8 == '\0') {
          uVar8 = FUN_14005c788("sys:", (ushort *)(pWVar13 + 1), 4);
          if ((char)uVar8 != '\0') {
            cVar17 = '\0';
            goto LAB_1400a35e0;
          }
          ...
          cVar17 = '\x01';
LAB_1400a35e0:
          local_res10[0] = pWVar13 + (cVar17 + 5);
        ...
        cVar17 = '\x01';
LAB_1400a3551:
        local_res10[0] = pWVar13 + (cVar17 + 7);
        uVar9 = FUN_140079cf8(local_res10, &local_1918.wYear, cVar17);
        if ((int)uVar9 < 1) goto LAB_1400a34a9;
...
LAB_1400a36ff:
  ...
  if (WVar6 != L'\0') {
    ...
    FUN_140003a20(param_1, &local_18f8, 0);
  }
  FUN_14005b154((longlong *)local_res10);
                  ...
                  if ((cVar5 == '\0') &&
                    ...
                    if ((cVar5 == '\0') &&
                      ...
                      if (cVar5 == '\0') {
                        ...
                        FUN_14005b154((longlong *)&local_res20);
                        goto LAB_1400a3e98;
                      }
                    ...
                    iVar7 = 0;
LAB_1400a3e3e:
                    uVar14 = FUN_140060ee0(&local_1918.wYear, iVar7);
                  }
...
ulonglong PECMD_LoadTasksWait(longlong *param_1, LPCWSTR param_2, longlong param_3)
{
  ...
  FUN_1400702b0(&local_b8, param_2);
  FUN_140003a20(param_1, &local_b8, 0);
  ...
  FUN_1400f429c(&local_f0, 0x2c);
  if (*local_f0 != L'\0') {
    *local_f0 = L'\0';
    local_f0 = local_f0 + 1;
    FUN_14005b154(&local_f0);
  }
  FUN_14007034c(&local_e0, local_f0);
  FUN_1400702b0(&local_b0, pWVar6);
  local_a0 = local_b0;
  FUN_14005b154(&local_a0);
  pWVar6 = local_a0;
  if (*local_a0 != L'\0') {
    ...
    if (*pWVar6 != L'\0') {
      ...
      do {
        ...
        pWVar6 = (LPCWSTR)FUN_140024c48(&local_80, &local_a8, 0xcd);
        WVar1 = *local_80;
        pWVar12 = local_80;
        while (WVar1 != L'\0') {
          WVar1 = *pWVar12;
        ...
        if (*local_80 == L'-') {
          ...
          FUN_1400c11c0(&local_108, local_res20);
          if (*local_108 == L':') {
        ...
        if (*local_108 != L'\0') {
          ...
          if (0 < lVar17) {
            do {
              puVar7 = (uint64_t *)FUN_140063b00((int64_t)uVar10, &local_98, &local_90, 8);
          ...
          if (local_108 != (WCHAR *)0) {
            ...
            if ((char)uVar8 == '\0') {
              ...
              if ((char)uVar8 == '\0') {
                ...
                if (((char)uVar8 == '\0') &&
                   (uVar8 = FUN_14005c788(".com*", (ushort *)pWVar18, 5), (char)uVar8 == '\0')) {
                  local_f8[0] = 0xffffffff;
                  puVar7 = FUN_1400a4460(pWVar18, '\0',
    ...
    if (0 < lVar17) {
      ...
      if (0 < lVar17) {
        ...
        uVar15 = uVar11;
        do {
          plVar9 = (longlong *)FUN_140063b00((int64_t)uVar10, &local_d0, &local_c8, 8);
          uVar19 = (int)uVar15 + 1;
...
LAB_1400a4d06:
            ...
            if (0 < lVar17) {
              do {
                plVar9 = (longlong *)FUN_140063b00(uVar11, &local_d0, &local_c8, 8);
                uVar13 = (int)uVar20 + 1;
