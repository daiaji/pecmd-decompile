...
extern void     *FUN_14006b1e8(LPCWSTR, void *, char);         /* 装载图像 */
extern void     *FUN_140078d8c(byte *, ulonglong *);           /* 装载图像(串) */
extern void      FUN_1400738d0(HMODULE, LPCWSTR, LPWSTR, LONG_PTR); /* 资源名回调 */
...
uint64_t PECMD_ParseControlDef(int64_t *param_1, LPCWSTR param_2, WPARAM param_3)
{
    ...
    FUN_1400675b8(plVar8, &local_88, 0);
    pWVar3 = local_res10;
    ...
    *local_b8 = L'\0';
    ...
    for (;;) {
            ...
            *pWVar5 = WVar2;
            ...
            if (*pWVar3 == L',') {
                ...
                if (*local_res10 == L',') {
                    ...
                    plVar8 = FUN_14007f6e4((WCHAR **)&local_58, &local_res10, 0x2c, 1);
                    FUN_1400675b8(plVar8, &local_80, 0);
                    uVar11 = local_b0;
                    if (*local_res10 == L',') {
                        local_res10 = local_res10 + 1;
                        plVar8 = FUN_14007f6e4((WCHAR **)&local_58, &local_res10, 0x2c, 1);
                        FUN_1400675b8(plVar8, &local_78, 0);
                        uVar11 = local_b0;
                        if (*local_res10 == L',') {
                            local_res10 = local_res10 + 1;
                            FUN_14005b154(&local_res10);
                            ...
                            if (((0x2f < (ushort)*local_res10) && ((ushort)*local_res10 < 0x3a)) ||
                                ...
                                FUN_1400c1194(&local_res10, &local_b0);
        ...
        local_res10 = pWVar13;
        uVar9 = (uint64_t)FUN_14005c788("-font:", (const WCHAR *)pWVar13, 6);
        if ((char)uVar9 == '\0') {
            uVar9 = (uint64_t)FUN_14005c788("-color:", (const WCHAR *)pWVar13, 7);
            if ((char)uVar9 != '\0') {
                /* -color: */
                pWVar13 = pWVar13 + 7;
                local_60 = pWVar13;
        ...
        LAB_1400be241:
            ...
            local_res10 = pWVar13 + 1;
            FUN_1400f429c(&local_res10, 0x22);
            pWVar13 = local_res10;
        } else {
            /* -font: */
            pWVar16 = pWVar13 + 6;
    ...
    *local_110 = L'\0';
    ...
    if (cVar3 == '\0') {
                                            ...
                                            if ((char)lVar18 == '\0') { /* -numicong 未命中 */
                                                ...
                                                if ((char)lVar18 == '\0') { /* -numicon 未命中 */
                                                    ...
                                                    if ((char)lVar18 == '\0') { /* -numbmp 未命中 */
                                                        if ((char)FUN_14005c788("-num:", (const WCHAR *)pWVar20, 5) != '\0') {
        ...
        *pWVar15 = (WCHAR)local_res18[0];
        FUN_1400702b0(&local_168, g_szEmpty);
        FUN_1400702b0(&local_158, g_szEmpty);
        FUN_1400702b0(&local_160, g_szEmpty);
        FUN_1400702b0(&local_150, g_szEmpty);
        ...
        FUN_1400675b8(&local_res10, &local_168, 0x2c);
        FUN_140003a20((int64_t *)param_1, &local_168, 1);
        if (*local_res10 == L',') {
            local_res10 = local_res10 + 1;
            ...
            if (*local_res10 == L',') {
                local_res10 = local_res10 + 1;
                plVar8 = FUN_14007f6e4((WCHAR **)&local_128, &local_res10, 0x2c, 1);
                FUN_1400675b8(plVar8, &local_158, 0);
            }
            ...
            if (*local_res10 == L',') {
                ...
                if (*local_res10 == L',') {
                    local_res10 = local_res10 + 1;
                    plVar8 = FUN_14007f6e4((WCHAR **)&local_128, &local_res10, 0x2c, 1);
                    FUN_1400675b8(plVar8, &local_150, 0);
                    if (*local_res10 == L',') {
                        local_res10 = local_res10 + 1;
                        puVar10 = FUN_14007f6e4((WCHAR **)&local_128, &local_res10, 0x2c, 1);
                        FUN_1400679b0(puVar10, (int *)&local_res8, 0x2c);
                    }
                }
            }
            ...
            FUN_14005b154(&local_res10);
            if (*local_res10 != L'#') {
                FUN_1400c11c0(&local_res10, local_144 + 1);
            }
            FUN_14005b154(&local_res10);
            if (*local_res10 == L'#') {
                local_res10 = local_res10 + 1;
                FUN_1400c11c0(&local_res10, local_144 + 2);
            }
            if (uVar6 == 0) {
                FUN_1400702b0(&local_138, pWVar13);
                if (WVar1 != L'*') {
                ...
                if (hModule != (HMODULE)0) {
                    EnumResourceNamesW(hModule, pWVar15, (void *)FUN_1400738d0,
                                       (LONG_PTR)&local_108);
                    FreeLibrary(hModule);
                }
...
uint64_t PECMD_AttachControlImage(int64_t *param_1, LPCWSTR param_2)
{
    ...
    local_res10 = 0;
    plVar5 = FUN_14007f6e4((WCHAR **)&local_58, &local_res8, 0x2c, 1);
    FUN_1400675b8(plVar5, &local_res20, 0);
    if (*local_res8 == L',') {
        local_res8 = local_res8 + 1;
        FUN_14005b154(&local_res8);
        if (*local_res8 != L'\0') {
            plVar5 = FUN_14007f6e4((WCHAR **)&local_58, &local_res8, 0x2c, 1);
            FUN_1400675b8(plVar5, &local_res18, 0);
        }
        FUN_140003a20(param_1, &local_res18, 0);
    }
    if (bVar2) {
        if (cVar8 == '\0') {
        ...
        puVar6 = (WCHAR *)FUN_14006b1e8((LPCWSTR)local_res20, &local_res10, cVar8);
    }
    if (puVar6 == (WCHAR *)0) {
