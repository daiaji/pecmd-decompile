...
extern uint64_t        *PECMD_InitTimerObject(uint64_t *param_1, uint64_t param_2,
...
extern void             FUN_14005e254(int64_t *param_1, int64_t *param_2,
                                      int64_t *param_3);
extern void             FUN_14007bf78(int64_t *param_1, int64_t *param_2, int param_3);
extern uint64_t         FUN_14005b77c(int64_t param_1);
...
extern void             FUN_14003ed4c(int64_t *param_1, WCHAR *buf);
extern void             FUN_14004eaa8(int64_t script, int mode);
extern void             PECMD_RefCountRelease(WCHAR **ps);
extern void             FUN_14005b0b8(void *p);          /* 对象初始化 */
extern void             FUN_14006a7f4(int64_t *param_1, uint64_t *param_2);
...
extern void             FUN_1400702b0(void *ps, const WCHAR *src);    /* assign */
...
extern DWORD            FUN_1400195f0(uint64_t param_1, int64_t param_2,
                                      int param_3, undefined8 *param_4);
extern void             FUN_14005cc4c(void);
extern uint64_t         PECMD_SetIpConfig(LPCSTR param_1, LPCSTR param_2, LPBYTE param_3,
                                      LPBYTE param_4, LPBYTE param_5, LPBYTE param_6,
                                      short *param_7);
...
extern uint32_t        *PECMD_ResolveMacAddress(int param_1, uint64_t *param_2,
                                      ...
                                      LPWSTR param_7, int64_t *param_8,
                                      LPWSTR param_9);
...
int64_t PECMD_PcipCommand(int64_t *param_1, LPCWSTR param_2)
{
    ...
    lVar14 = 1;
    plVar11 = FUN_14007f6e4(&local_120, (WCHAR **)&local_res10, 0x2c, 1);
    FUN_1400675b8(plVar11, &local_130, 0);
    pWVar24 = local_130;
    uVar23 = 0;
    local_148 = 0;
    local_164 = 0;
    ...
    local_178 = '\0';
    local_177 = 0;
    FUN_1400702b0(&local_a0, WSTR("&&__PECMD.PCIP.DEAULT_CACHE"));
    WVar17 = *pWVar24;
    bVar20 = bVar25;
    pWVar18 = pWVar24;
    while (WVar17 == L'*') {
                                ...
                                if (cVar5 == '\0') {
                                    ...
                                    if (cVar5 == '\0') {
                                        ...
                                        if (cVar5 == '\0') {
                                            WVar17 = *local_180;
                                            while ((WVar17 != L'\0' &&
                                                   ((((ushort)WVar17 < 9 || (0xd < (ushort)WVar17))
                                                     && (WVar17 != L' '))))) {
                                            ...
                                            local_180 = pWVar21;
                                            PECMD_StrCopyW((WCHAR **)&local_a0, pWVar18, lVar22 >> 1);
                                        }
                                        FUN_14005b154((WCHAR **)&local_180);
                                    } else {
                                        local_177 = 0x40;
                                    }
                                } else {
    ...
    for (pWVar18 = pWVar18 + (int)uVar19;
         (((*pWVar18 == L'?' || (*pWVar18 == L'*')) ||
           ((8 < (ushort)*pWVar18 && ((ushort)*pWVar18 < 0xe)))) || (*pWVar18 == L' '));
         pWVar18 = pWVar18 + 1) {
    }
    FUN_14007034c((WCHAR **)&local_e8, pWVar18);
    *pWVar24 = L'\0';
    ...
    if (*local_res10 == L',') {
        ...
        if (*local_res10 == L',') {
            local_res10 = local_res10 + 1;
            plVar11 = FUN_14007f6e4(&local_120, (WCHAR **)&local_res10, 0x2c, 1);
            FUN_1400675b8(plVar11, &local_f0, 0);
            if (*local_res10 == L',') {
                local_res10 = local_res10 + 1;
                plVar11 = FUN_14007f6e4(&local_120, (WCHAR **)&local_res10, 0x2c, 1);
                FUN_1400675b8(plVar11, &local_d8, 0);
            }
        }
    }
    ...
    if (*local_res10 == L',') {
        ...
        local_res10 = local_res10 + 1;
        plVar11 = FUN_14007f6e4(&local_120, (WCHAR **)&local_res10, 0x2c, 1);
        FUN_1400675b8(plVar11, &local_160, 0);
        WVar17 = L'?';
        local_108 = local_160;
        local_128 = local_160;
        pWVar18 = local_160;
        FUN_1400f429c((WCHAR **)&local_128, 0x3f);
        if (WVar17 == *local_128) {
            *local_128 = L'\0';
        ...
        if ((9 < (ushort)(*pWVar18 + 0xff10)) ||
            ...
            if (!bVar6) {
                FUN_1400703e4((int64_t *)&local_170, pWVar18);
            }
            if (iVar8 != 0) {
                FUN_14007034c((WCHAR **)&local_138, local_128);
            }
            FUN_14005b104(&local_160);
            goto LAB_1400af515;
        }
        FUN_1400c11c0(&local_108, local_140);
        bVar6 = 1;
        pWVar18 = local_108;
...
LAB_1400af515:
    if (iVar8 == 0) {
        if (*local_res10 == L',') {
            ...
            if (iVar8 == 0) {
                ...
                puVar13 = FUN_14007f6e4(&local_120, (WCHAR **)&local_res10, 0x2c, 1);
                FUN_1400679b0(puVar13, (int *)&local_158, 0x2c);
        ...
        local_res10 = local_res10 + 1;
        plVar11 = FUN_14007f6e4(&local_120, (WCHAR **)&local_res10, 0x2c, 1);
        FUN_1400675b8(plVar11, &local_c0, 0);
        if (*local_res10 == L',') {
            local_res10 = local_res10 + 1;
            plVar11 = FUN_14007f6e4(&local_120, (WCHAR **)&local_res10, 0x2c, 1);
            FUN_1400675b8(plVar11, &local_f8, 0);
            if (*local_res10 == L',') {
                local_res10 = local_res10 + 1;
                plVar11 = FUN_14007f6e4(&local_120, (WCHAR **)&local_res10, 0x2c, 1);
                FUN_1400675b8(plVar11, &local_c8, 0);
                if (*local_res10 == L',') {
                    local_res10 = local_res10 + 1;
                    plVar11 = FUN_14007f6e4(&local_120, (WCHAR **)&local_res10, 0x2c, 1);
                    FUN_1400675b8(plVar11, &local_b0, 0);
                    if (*local_res10 == L',') {
                        local_res10 = local_res10 + 1;
                        plVar11 = FUN_14007f6e4(&local_120, (WCHAR **)&local_res10, 0x2c, 1);
                        FUN_1400675b8(plVar11, &local_d0, 0);
                        if (*local_res10 == L',') {
                            local_res10 = local_res10 + 1;
                            plVar11 = FUN_14007f6e4(&local_120, (WCHAR **)&local_res10, 0x2c, 1);
                            FUN_1400675b8(plVar11, &local_88, 0);
                            if (*local_res10 == L',') {
                                local_res10 = local_res10 + 1;
                                plVar11 = FUN_14007f6e4(&local_120, (WCHAR **)&local_res10, 0x2c, 1);
                                FUN_1400675b8(plVar11, &local_80, 0);
                                if (*local_res10 == L',') {
                                    local_res10 = local_res10 + 1;
                                    plVar11 = FUN_14007f6e4(&local_120, (WCHAR **)&local_res10, 0x2c, 1);
                                    FUN_1400675b8(plVar11, &local_90, 0);
                                }
                            }
                        }
                    }
    ...
    if ((((-1 < local_140[0]) || (*local_170 != L'\0')) || (*local_c0 != L'\0')) ||
        ...
        if (local_a0 == (LPCWSTR)0x0) {
            ...
            if ((lVar14 == 0) || ((*(ulonglong *)(lVar14 + 0x18) & 0x3fffffffffffffffULL) < 0x10)) {
                FUN_14005cf3c();
                       ...
                       ((lVar14 = (*(longlong **)(lVar14 + 8))[1], lVar14 == 0 ||
                        (lVar14 != g_pCacheBlock)))) {
                local_188 = '\0';
                FUN_14005cf3c();
            } else {
                local_188 = '\x01';
        ...
        /* 简化: 拆出 hex/dec 字符区间判断, 避免深层括号拼写错误 (语义同原) */
        {
            ...
            if ((*local_170 == L'{') && (local_170[iVar8 + -1] == L'}') &&
                (isDigit1 || isHex1) && (isDigit2 || isHex2)) {
                bVar20 = 1;
            }
        }
        local_e0 = (LPCSTR)0x0;
        ...
        *local_70 = L'\0';
        ...
        if (((bVar20 == 0) && ((-1 < local_140[0] || (*local_170 != L'\0')))) ||
            ...
            local_160 = (LPWSTR)(uintptr_t)PECMD_ResolveMacAddress(local_140[0], (uint64_t *)&local_170,
                                                          (uint64_t *)&local_e0, (int64_t *)&local_a8,
                                                          (uint64_t)((local_164 & 0xff) | local_177),
        ...
        if ((int)(uint32_t)local_148 == 0) {
            ...
            if (DAT_14013d4d0 == 0) {
                ...
                if (((int32_t)local_150 < 0) || (bVar25 != 0)) {
                    ...
                    if (*local_b8 == '\0') {
                        DVar26 = 0;
                        if (fresh != 0) goto LAB_1400b00d9;
                        DVar26 = 1;
                    } else {
                        FUN_1400f429c((WCHAR **)&local_d8, ',');
                        cVar5 = ';';
                        FUN_1400f429c((WCHAR **)&local_e8, ';');
                        FUN_1400f429c((WCHAR **)&pWVar24, cVar5);
                        DVar4 = 0;
                        if (bVar25 != 0) {
                            local_158 = 0;
                            ...
                            uVar12 = PECMD_SetIpConfig(local_b8, (LPCSTR)(intptr_t)local_158,
                                                   (LPBYTE)(intptr_t)local_180,
                                                   (LPBYTE)(intptr_t)local_148,
                                                   (BYTE *)(intptr_t)local_160, (LPBYTE)0,
                                                   (short *)0);
                            ...
                            if (((byte)local_164 != '\0') ||
                                ...
                                uVar12 = PECMD_ProcessCommandLine(local_b8, 0, (LPCSTR)(intptr_t)local_158,
                                                       (char *)(intptr_t)local_180, pBVar3,
                                                       (BYTE *)(intptr_t)local_160,
                                                       (int)(char)local_167);
                                uVar9 = (uint)uVar12;
                            }
...
LAB_1400afff3:
            ...
            *(uint8_t *)local_78 = (uint8_t)WVar17;
            ...
            if (*local_e8 != L'\0') {
                FUN_1400637dc((WCHAR **)&local_170, (LPCSTR)(intptr_t)local_158, 0xffffffffffffffffULL,
                              0xffffffffffffffffULL);
                FUN_1400629b8(param_1, local_e8, local_170);
            }
            if (*pWVar24 != L'\0') {
                FUN_1400637dc((WCHAR **)&local_170, (LPCSTR)((intptr_t)local_78 + 0x32a),
                              0xffffffffffffffffULL, 0xffffffffffffffffULL);
                FUN_1400629b8(param_1, pWVar24, local_170);
            }
            if (*local_f0 != L'\0') {
                FUN_1400637dc((WCHAR **)&local_170, (LPCSTR)local_res20, 0xffffffffffffffffULL,
                              0xffffffffffffffffULL);
            ...
            if (*local_d8 != L'\0') {
                FUN_1400637dc((WCHAR **)&local_170, (LPCSTR)pBVar1, 0xffffffffffffffffULL,
                              0xffffffffffffffffULL);
                FUN_1400629b8(param_1, local_d8, local_170);
            }
            if (*local_c8 != L'\0') {
                FUN_1400637dc((WCHAR **)&local_170, (LPCSTR)local_48, 0xffffffffffffffffULL,
                              0xffffffffffffffffULL);
    ...
    if (*local_100 != (WCHAR)(uintptr_t)pWVar12) {
        ...
        if (WVar2 != (WCHAR)(uintptr_t)pWVar12) {
            ...
            if ((((uint32_t)local_f0 == uVar10) || (local_108 == uVar10)) &&
                ((pWVar26 != pWVar12 &&
                  ((bVar28 = *(uint *)((uintptr_t)pWVar26 + 0xe8) != uVar10, uVar10 = 1,
                    bVar28 && ((uVar16 >> 8 & 1) != 0)))))) {
                lVar18 = -0x7ff8ffa9;
            } else {
                ...
                if ((long long *)(uintptr_t)_Memory_00.QuadPart == (long long *)0) {
                    ...
                    FUN_140017cdc((uint64_t *)(uintptr_t)_Memory_00.QuadPart, (uint64_t *)param_1);
                    FUN_1400186bc((uint64_t *)(uintptr_t)_Memory_00.QuadPart, (int64_t)param_1);
                ...
                *(long long *)(uintptr_t)(_Memory_00.QuadPart + 0x80) = lVar18;
                ...
                plVar19 = param_1;
                if (((uint32_t)local_f0 == 0) && (plVar19 = (int64_t *)&g_Script,
                                                  pWVar26 != (WCHAR *)0x0)) {
                ...
                FUN_14005e254((int64_t *)(uintptr_t)_Memory_00.QuadPart, param_1, plVar19);
                uVar21 = (uint32_t)local_e8;
                if ((uint32_t)local_e8 != 0) {
                    FUN_14007bf78((int64_t *)(uintptr_t)_Memory_00.QuadPart, (int64_t *)0, 0);
                }
                LeaveCriticalSection((LPCRITICAL_SECTION)&g_csInit);
                *(uint8_t *)(uintptr_t)(_Memory_00.QuadPart + 0xda) = *(uint8_t *)((intptr_t)param_1 + 0xda);
                *(uint8_t *)(uintptr_t)(_Memory_00.QuadPart + 0xd) = *(uint8_t *)((intptr_t)param_1 + 0xd);
                if (uVar21 != 0) {
                    *(uint8_t *)(uintptr_t)(_Memory_00.QuadPart + 0xd) = 1;
                }
                FUN_1400702b0(&local_f0, pWVar17);
                ...
                local_f4 = 0;
                bVar28 = 0;
                hThread = CreateThread((LPSECURITY_ATTRIBUTES)0, (size_t)local_b0,
                ...
                if (hThread == (HANDLE)0) {
                    ...
                    if (uVar10 == 0) {
                        ...
                        uVar8 = FUN_14005b77c((int64_t)(uintptr_t)pWVar26);
                    }
                    _Memory_00.QuadPart = 0;
                    lpParameter[6] = uVar8;
                    ...
                    EnterCriticalSection((LPCRITICAL_SECTION)&g_csInit);
                    if ((local_res20 == 0) && (g_taskCount = g_taskCount + 1,
                                               local_104 != 0)) {
                ...
                if (((local_108 != 0) && (hThread != (HANDLE)0)) && (local_f4 != 0)) {
                    ...
                    FUN_14003ed4c(param_1, local_88);
                }
                lVar18 = (int64_t)(int)DVar5;
                FUN_14005b104(&local_e8);
                FUN_14005b104(&local_f0);
                if (_Memory_00.QuadPart != 0) {
                    FUN_14004eaa8((int64_t)(uintptr_t)_Memory_00.QuadPart, 0);
 ...
 */
uint64_t PECMD_PcipDispatch(int64_t *param_1, ushort *param_2, WPARAM param_3,
                       uint64_t param_4)
{
    ushort uVar1;
    int iVar2;
    ...
    FUN_1400702b0(&local_68, (const WCHAR *)g_szEmpty);
    local_res18[0] = 0;
    local_res8[0] = 0;
    puVar10 = local_res10;
    local_60 = param_4;
...
LAB_1400b47a6:
        ...
        if (iVar4 != 0) {
            ...
            if (*local_res10 == 0x2c) {
                ...
                FUN_14007034c((WCHAR **)&local_68, (LPCWSTR)(uintptr_t)*plVar6);
            }
            if (uVar1 != 0x2a) {
        ...
        *local_res10 = 0;
        ...
        plVar6 = (WCHAR *)FUN_14007f6e4(&local_58, (WCHAR **)&local_70, 0x2c, 1);
